...
int __thiscall sub_10063FF0(float *this, int a2, int a3, int a4)
{
  ...
  if ( a2 )
  {
    ...
    *v10 = *(_DWORD *)(v9 + 76);
    ...
    sub_1003B050(
      (float *)((char *)&unk_10AF9584 + v8),
      (float *)((char *)&unk_10AF977C + v8),
      (float *)((char *)&unk_10AF971C + v8));
    sub_1003B050((float *)((char *)&unk_10AF9524 + v8), &flt_10AF97DC[3 * a2], (float *)((char *)&unk_10AF971C + v8));
    v11 = a2;
...
LABEL_14:
    ...
    {
      v22 = 0;
      for ( i = sub_1003BA70(this + 12, v23, flt_10AF9794, flt_10AF97F4);
            i;
  ...
  if ( v16 != *(unsigned __int16 *)(v4 + 20) )
    return sub_10063FF0(v7 + 1, v16, v4) | v5;
  v17 = *(_DWORD *)v4;
  if ( !v17 )
  {
    v17 = dword_106C7CB8;
