...
char __cdecl sub_100786E0(int a1)
{
  ...
  if ( (*(_WORD *)v2 & 0xFF00u) > 0x8000 )
  {
    if ( (*(_WORD *)v2 & 0xFF00u) > 0x8200 )
    {
      if ( (*(_WORD *)v2 & 0xFF00u) > 0x8400 )
      {
        if ( (*(_WORD *)v2 & 0xFF00u) > 0x8600 )
        {
          if ( (*(_WORD *)v2 & 0xFF00u) > 0x8800 )
          {
            if ( v3 == 35072 )
            {
              if ( dword_118ABD3C[7 * dword_118ABAD4] > 50 || dword_118ABD3C[7 * dword_118ABD80] <= 50 )
                goto LABEL_68;
            }
            else if ( v3 == 35328 )
            {
              if ( dword_118ABD40[7 * dword_118ABAD4] < -50 || dword_118ABD40[7 * dword_118ABD80] >= -50 )
                goto LABEL_68;
            }
            else if ( v3 != 35584 || dword_118ABD40[7 * dword_118ABAD4] > 50 || dword_118ABD40[7 * dword_118ABD80] <= 50 )
            {
              goto LABEL_68;
            }
          }
          ...
          else if ( v3 != 34560 || dword_118ABD38[7 * dword_118ABAD4] > 50 || dword_118ABD38[7 * dword_118ABD80] <= 50 )
          {
            goto LABEL_68;
          }
        }
        ...
        else if ( v3 != 34048 || dword_118ABAE8[68 * dword_118ABD7C] > 50 || dword_118ABAE8[68 * dword_118ABAB8] <= 50 )
        {
          goto LABEL_68;
        }
      }
      ...
      else if ( v3 != 33536 || dword_118ABAE4[68 * dword_118ABD7C] > 50 || dword_118ABAE4[68 * dword_118ABAB8] <= 50 )
      {
        goto LABEL_68;
      }
    }
    ...
    else if ( v3 != 33024 || dword_118ABAE0[68 * dword_118ABD7C] > 50 || dword_118ABAE0[68 * dword_118ABAB8] <= 50 )
    {
      goto LABEL_68;
    }
LABEL_67:
