...
int __thiscall meth_1005BC10(char *this, char *Source, int a3, int a4, int a5, int a6)
{
  ...
  *(_DWORD *)&this[1080 * *((unsigned __int16 *)this + 54422) + 1108] = 19 * *((unsigned __int16 *)this + 54422)
                                                                      + (__int64)*((float *)this + 8);
  *(_DWORD *)&this[1080 * *((unsigned __int16 *)this + 54422) + 1116] = *(_DWORD *)&this[1080
                                                                                       * *((unsigned __int16 *)this
                                                                                         + 54422)
                                                                                       + 1108]
                                                                      + 18;
  *(float *)&this[1080 * *((unsigned __int16 *)this + 54422) + 1084] = (float)*(int *)a5;
  *(float *)&this[1080 * *((unsigned __int16 *)this + 54422) + 1088] = (float)*(int *)&this[1080
                                                                                          * *((unsigned __int16 *)this
                                                                                            + 54422)
                                                                                          + 1108];
  ...
  *(_DWORD *)&this[1080 * *((unsigned __int16 *)this + 54422) + 1100] = 0;
  if ( (_BYTE)a4 == 3 )
    (*(void (__thiscall **)(char *))(*(_DWORD *)&this[1080 * *((unsigned __int16 *)this + 54422) + 44] + 8))(&this[1080 * *((unsigned __int16 *)this + 54422) + 44]);
  else
    (*(void (__thiscall **)(char *))(*(_DWORD *)&this[1080 * *((unsigned __int16 *)this + 54422) + 44] + 4))(&this[1080 * *((unsigned __int16 *)this + 54422) + 44]);
