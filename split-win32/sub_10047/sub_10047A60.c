...
int __thiscall sub_10047A60(_DWORD *this)
{
  ...
  if ( (v2 & 0x10) == 0 )
  {
    ...
    v4 = **(_DWORD **)&SrcStr[8];
    if ( dword_100AB448 > **(_DWORD **)&SrcStr[8]
      || dword_100AB450 < v4
      || (v5 = *(_DWORD *)(*(_DWORD *)&SrcStr[8] + 4), dword_100AB44C > v5)
      || dword_100AB454 < v5 )
    {
      if ( dword_100AB418 > v4
        || dword_100AB420 < v4
        || (v8 = *(_DWORD *)(*(_DWORD *)&SrcStr[8] + 4), dword_100AB41C > v8)
        || dword_100AB424 < v8 )
      {
        if ( dword_100AB428 > v4
          || dword_100AB430 < v4
          || (v9 = *(_DWORD *)(*(_DWORD *)&SrcStr[8] + 4), dword_100AB42C > v9)
          || dword_100AB434 < v9 )
        {
          v6 = 0;
          v7 = word_10AA286C + dword_100AB44C + 18 * word_10AA286C == word_10AA2870
                                                                    + dword_100AB44C
                                                                    + 18 * word_10AA2870;
        }
        else
    ...
    ++word_10AA2870;
    dword_10AA284C = v6;
    if ( this[20] <= **(_DWORD **)&SrcStr[8]
      && this[22] >= **(_DWORD **)&SrcStr[8]
      ...
      || v7 )
    {
      ...
      if ( (v11 & 0x40000) != 0 )
      {
        if ( *((_DWORD *)dword_10AA2E80 + 11) || *((_DWORD *)dword_10AA2E80 + 12) )
        {
          v11 |= 0x80002u;
LABEL_47:
          this[7] = v11;
  ...
  if ( word_10AA286C == word_10AA2870 )
  {
    ...
    sub_100484F0(*(unsigned __int16 **)(this[2746] + 100));
  }
  ++word_10AA2870;
  return 0;
}
