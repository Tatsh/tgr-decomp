...
int __cdecl sub_1006D660(int a1, float *a2, int a3)
{
  ...
  do
  {
    ...
    if ( v24 )
    {
      if ( *(float *)(a3 + 4 * v23) < (double)*(float *)(v17 + 4 * v23) == *(float *)(a3 + 4 * v23) < (double)*(float *)(v15 + 4 * v23) )
      {
        if ( *(float *)(v15 + 4 * v23) <= (double)*(float *)(a3 + 4 * v23) )
          v19 += v24;
      }
      else if ( (*(float *)(v17 + v14) - *(float *)(v15 + v14))
              * (*(float *)(a3 + 4 * v23) - *(float *)(v15 + 4 * v23))
              * (double)v24 >= (*(float *)(a3 + v14) - *(float *)(v15 + v14))
                             * (*(float *)(v17 + 4 * v23) - *(float *)(v15 + 4 * v23))
                             * (double)v24 )
      {
        v19 += v24;
      }
