...
int __cdecl sub_1006DDC0(int a1)
{
  ...
  if ( *(_DWORD *)(v7 + 436) )
  {
    ...
    v32 = *(float *)(a1 + 488) - *(float *)(a1 + 484) * 0.5;
    sub_100747C0((float *)&v33, v2, &v30);
    v10 = sub_1006C9A0(v3 + 420, *(float *)(v3 + 432), (int)&v33) >= 0.0 ? sub_1006C9A0(
                                                                             v3 + 420,
                                                                             *(float *)(v3 + 432),
                                                                             (int)&v33) : -sub_1006C9A0(
                                                                                             v3 + 420,
                                                                                             *(float *)(v3 + 432),
                                                                                             (int)&v33);
    if ( v36 >= v10 )
  ...
  if ( *(_DWORD *)(v11 + 436) )
  {
    ...
    v32 = *(float *)(a1 + 488) - *(float *)(a1 + 484) * 0.5;
    sub_100747C0((float *)&v33, v2, &v30);
    v14 = sub_1006C9A0(v3 + 420, *(float *)(v3 + 432), (int)&v33) >= 0.0 ? sub_1006C9A0(
                                                                             v3 + 420,
                                                                             *(float *)(v3 + 432),
                                                                             (int)&v33) : -sub_1006C9A0(
                                                                                             v3 + 420,
  ...
  if ( v16 )
  {
    ...
    v32 = *(float *)(a1 + 488) - *(float *)(a1 + 484) * 0.5;
    sub_100747C0((float *)&v33, v2, &v30);
    v19 = sub_1006C9A0(v3 + 420, *(float *)(v3 + 432), (int)&v33) >= 0.0 ? sub_1006C9A0(
                                                                             v3 + 420,
                                                                             *(float *)(v3 + 432),
                                                                             (int)&v33) : -sub_1006C9A0(
                                                                                             v3 + 420,
  ...
  v37 = *(float *)(v3 + 428) * v35 + *(float *)(v3 + 424) * v34 + *(float *)(v3 + 420) * *(float *)&v33;
  debugPrint(v20);
  v23 = v37;
  if ( v24 )
    v23 = -v23;
