...
LABEL_7:
      ...
      if ( dword_106C6624 )
        debugPrint((void *)(65 * dword_106C5708));
      ...
      *v12 = -1241513984;
      ...
      if ( dword_106C6624 )
      {
        sub_10060780(v1, (char *)&unk_104B3DE8 + 0x4000 * dword_106C5708, dword_11829318 << 12, 0);
      ...
      v21 = 0;
      v54 = v20 + v20;
      v58 = (double)g_Height + (double)g_Height;
      if ( dword_104B2550 > 0 )
      {
        v22 = v57 + 4;
        v56 = v57 + 4;
          ...
          if ( !v29 )
          {
            ...
            if ( v31 >= -1.0 && v50 <= 1.0 )
            {
              ...
              if ( v32 >= -1.0 && v47 <= 1.0 && (int)(__int64)(v44 * v51) >= 2 )
              {
                ...
                if ( v33 >= 2 )
                {
                  v34 = (__int64)(v47 * v54) + 4 * (g_Width / 2);
                  v35 = (__int64)(v50 * v58) + 4 * (g_Height / 2);
                  v36 = (int *)dword_106C0680;
                  dword_106C0680 += 8;
                  v37 = ((v35 + v33) >> 2) & 0xFFF | ((((unsigned __int16)v34 + (unsigned __int16)(__int64)(v44 * v51)) & 0x3FFC | 0x38C000) >> 2 << 12);
