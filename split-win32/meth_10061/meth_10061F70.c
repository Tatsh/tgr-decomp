...
void __thiscall meth_10061F70(int this)
{
  ...
  if ( *(__int16 *)g_ConfigJoystickPtr >= 0 && (*((_WORD *)g_ConfigJoystickPtr + 3) & 0x8000) == 0 )
  {
    if ( v2 <= 0.0 )
    {
      v4 = v2 - -0.07;
...
LABEL_124:
  ...
  {
    if ( v21 < *(_DWORD *)(this + 3672)
      && *(float *)(this + 3620) > (double)v62
...
LABEL_161:
  v32 = v26
      + ((*(float *)(this + 3652) * *(float *)(this + 3620) + *(float *)(this + 3656)) * *(float *)(this + 3620)
       + *(float *)(this + 3660))
      * *(float *)(this + 3620)
      + *(float *)(this + 3664);
  if ( !*(_DWORD *)(this + 3680) )
  ...
  *(float *)(this + 3688) = v34 * v32;
  ...
  if ( v36 )
  {
    if ( (LODWORD(v37) & 0x20000) != 0 )
      v38 = *(float *)(this + 3628) * *(float *)(this + 3668) * (*(float *)(this + 1856) * 0.15915494) * -60.0;
    else
      v38 = *(float *)(this + 4 * v36 + 3624) * *(float *)(this + 3668) * (*(float *)(this + 1856) * 0.15915494) * -60.0;
    *(float *)(this + 3620) = v38;
  }
  else
  {
