...
int __cdecl sub_10014A30(int a1)
{
  ...
  int v90; // [esp+4h] [ebp-3Ch]
  float v91; // [esp+4h] [ebp-3Ch]
  int v92; // [esp+4h] [ebp-3Ch]
  ...
  if ( dword_100AA8B4 > 0 )
  {
    while ( 1 )
    {
      ...
      if ( dword_100AA8B4 <= 1 )
      {
        sub_10033CB1((int)dword_106C6490, *((float *)dword_106C6490 + 16), flt_100AA8B0, v93, v101);
        v103 = (float)v7[3];
        v95 = (float)v7[2];
        sub_10033E83((int)dword_106C6490, *((float *)dword_106C6490 + 16), SLODWORD(flt_100AA8B0), v95, v103);
      }
      else
      {
        v89 = flt_100AA8B0 * 0.64999998;
        v87 = *((float *)dword_106C6490 + 16) * 0.69999999;
        sub_10033CB1((int)dword_106C6490, v87, v89, v93, v101);
        v102 = (float)v7[3];
        v94 = (float)v7[2];
        *(float *)&v90 = flt_100AA8B0 * 0.64999998;
        v88 = *((float *)dword_106C6490 + 16) * 0.69999999;
        sub_10033E83((int)dword_106C6490, v88, v90, v94, v102);
      }
      sub_10031866();
      sub_10031DCF();
      debugPrint(v9);
      ...
      sub_1003A990();
      v10 = 0;
      dword_10277EA0 = (dword_106C661C != 0) + 1;
      if ( dword_100B36FC > 0 )
      {
        v11 = (int)v112;
        do
      ...
      if ( dword_106C6490 == (void *)(dword_106C2CF8 + 10180) && dword_100AA8B4 == 1 && dword_100AA888 )
      {
        if ( dword_100AA888 == 1 )
        {
          v33 = v7[2];
        ...
        *(_DWORD *)(dword_106C2CF8 + 10036) = dword_106C2CF8 + 10384;
        v120 = v35;
        dword_106C6490 = *(void **)(dword_106C2CF8 + 10036);
        sub_10032A42(v35, v36, -v34, v34 >> 2, 1);
        sub_100314E3();
        v122 = (float)(v34 >> 2);
        v114 = (float)v34;
        v91 = flt_100AA8B0 * 0.2;
        sub_10033CB1((int)dword_106C6490, *((float *)dword_106C6490 + 16), v91, v114, v122);
        *(float *)&v92 = flt_100AA8B0 * 0.30000001;
...
LABEL_141:
  ...
  else if ( g_GameMode == 4
         && dword_106805B8 == 1
         && (&off_100AA018)[8 * dword_106805C0]
         && *(float *)&dword_106806DC > 0.5 )
  {
    ...
    if ( v81 >= 0 )
    {
      ...
      do
      {
        ...
        {
          sub_100192F0(15);
          sub_10019300((int)&(*(&off_100AA020)[8 * dword_106805C0 + 4 * v81])[1], g_Width1 / 2, v80 + v82 / 2);
        }
        else
        {
          sub_100192F0(20);
          sub_10019300((int)(&off_100AA020)[8 * dword_106805C0 + 4 * v81], g_Width1 / 2, v80 + v82 / 2);
        }
        --v81;
        v82 -= 40;
      }
...
// 106C662C: using guessed type int dword_106C662C;
