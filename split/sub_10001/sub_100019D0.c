//----- (100019D0) --------------------------------------------------------
int __thiscall sub_100019D0(#479 *this)
{
  int v2; // edx
  int v3; // eax
  double v4; // st7
  ...
  *((_DWORD *)this + 2542) = *((_DWORD *)this + 2621);
  ...
  if ( v12 - v13 + *((float *)this + 2622) <= 0.07 )
  {
    ...
    sub_100015D0(this, COERCE_FLOAT((#479 *)((char *)this + 10112)), v41);
  }
  else
  {
    sub_100015D0(this, COERCE_FLOAT((#479 *)((char *)this + 10112)), 0.0);
  }
  sub_10001760(this);
  ...
  *((_DWORD *)this + 2621) = *((_DWORD *)this + 2542);
  if ( !*((_DWORD *)this + 991) )
  {
    sub_100011F0((float *)this, *(float *)&v14, (int)v47);
    if ( dword_100C129C )
    {
      if ( dword_106909E0 )
      {
  ...
  {
    *((float *)this + 2523) = *(float *)(*((_DWORD *)this + 2673) + 32952) * *((float *)this + 8)
                            + *(float *)(*((_DWORD *)this + 2673) + 32944) * *(float *)this
                            + *((float *)this + 12);
    *((float *)this + 2524) = *(float *)(*((_DWORD *)this + 2673) + 32944) * *((float *)this + 1)
                            + *(float *)(*((_DWORD *)this + 2673) + 32952) * *((float *)this + 9)
                            + *((float *)this + 13);
    *((float *)this + 2525) = *(float *)(*((_DWORD *)this + 2673) + 32944) * *((float *)this + 2)
