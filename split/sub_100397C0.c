...
LABEL_30:
        ...
        do
        {
          if ( v16 == 1 || *v33 )
          {
            qmemcpy((void *)(v1 + ((v16 + v34) << 7) + 4384), (const void *)(v1 + ((v16 + v34) << 7) + 4256), 0x80u);
            v29 = v17;
            qmemcpy((void *)(v1 + 24 * (v16 + v34) + 8992), (const void *)(v1 + 24 * (v16 + v34) + 8968), 0x18u);
          ...
          *(float *)(v18 + 4432) = v19;
          ...
          else if ( v16 != 8 )
          {
            ...
            *(float *)(v18 + 4384) = (double)(v40 + ((v32 * v20[4496]) >> 12)) + *(float *)(v18 + 4384);
            *(float *)(v18 + 4388) = (double)(v42 + ((v32 * v20[4497]) >> 12)) + *(float *)(v18 + 4388);
            *(float *)(v18 + 4392) = v35 + *(float *)(v18 + 4392);
            *(float *)(v18 + 4416) = (double)(v40 + ((v32 * v20[4499]) >> 12)) + *(float *)(v18 + 4416);
            *(float *)(v18 + 4420) = (double)(v42 + ((v32 * v20[4500]) >> 12)) + *(float *)(v18 + 4420);
