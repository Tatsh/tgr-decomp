...
int __cdecl sub_10054B50(int a1)
{
  ...
  *((_WORD *)v26 + 5409) = 85;
  ...
  (*(void (__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v29 + 56))(
    ...
    -1);
  v29[61702] = 3;
  v31 = getCaptionString(0x38u);
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v30 + 52))(v29, v31, 1, 1, &unk_100AB458);
  ++*((_WORD *)v4 + 10);
  ...
  v33[1] = sub_10041300;
  *((_WORD *)v33 + 61702) = 52;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v34 + 52))(v33, String2, 1, 4, &unk_100AB458);
  ++*((_WORD *)v4 + 10);
  ...
  v40[1] = sub_100413B0;
  *((_WORD *)v40 + 61702) = 52;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v41 + 52))(v40, String2, 1, 4, &unk_100AB458);
  ++*((_WORD *)v4 + 10);
  ...
  if ( !v43 )
    sub_1003E260(4);
  v44 = *(_DWORD *)v43;
  (*(void (__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(*(_DWORD *)v43 + 56))(
    v43,
    a1,
    0,
    1116471296,
    ...
    -1);
  v43[61702] = 3;
  v45 = getCaptionString(0x52u);
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v44 + 52))(v43, v45, 1, 1, &unk_100AB468);
  ++*((_WORD *)v4 + 10);
  ...
  v47[1] = sub_10041670;
  *((_WORD *)v47 + 61702) = 5;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v48 + 52))(v47, String2, 1, 3, &unk_100AB468);
  ++*((_WORD *)v4 + 10);
  ...
  if ( !v50 )
    sub_1003E260(4);
  v51 = *(_DWORD *)v50;
  (*(void (__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(*(_DWORD *)v50 + 56))(
    v50,
    a1,
    0,
    1125515264,
    ...
    -1);
  v50[61702] = 3;
  v52 = getCaptionString(0x53u);
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v51 + 52))(v50, v52, 1, 1, &unk_100AB468);
  ++*((_WORD *)v4 + 10);
  ...
  (*(void (__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v54 + 56))(
    ...
    -1);
  v54[61702] = 3;
  v56 = getCaptionString(0x40u);
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v55 + 52))(v54, v56, 1, 1, &unk_100AB4F8);
  ++*((_WORD *)v4 + 10);
  v57 = (_DWORD *)operator new(0x1E214u);
  if ( v57 )
  ...
  v62[1] = sub_100417B0;
  *((_WORD *)v62 + 61702) = 5;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v63 + 52))(v62, String2, 1, 3, &unk_100AB4F8);
  ++*((_WORD *)v4 + 10);
  ...
  if ( !v65 )
    sub_1003E260(4);
  v66 = *(_DWORD *)v65;
  (*(void (__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(*(_DWORD *)v65 + 56))(
    v65,
    a1,
    v4[206],
    1128988672,
    ...
    -1);
  v65[61702] = 3;
  v67 = getCaptionString(0x40u);
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v66 + 52))(v65, v67, 1, 1, &unk_100AB478);
  ++*((_WORD *)v4 + 10);
  ...
  if ( !v69 )
    sub_1003E260(4);
  v70 = *(_DWORD *)v69;
  (*(void (__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(*(_DWORD *)v69 + 56))(
    v69,
    a1,
    v4[206],
    1132756992,
    ...
    -1);
  v69[61702] = 3;
  v71 = getCaptionString(0x41u);
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v70 + 52))(v69, v71, 1, 1, &unk_100AB478);
  ++*((_WORD *)v4 + 10);
  ...
  v73[1] = sub_10041710;
  *((_WORD *)v73 + 61702) = 5;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v74 + 52))(v73, String2, 1, 3, &unk_100AB478);
  ++*((_WORD *)v4 + 10);
  return 1;
}
