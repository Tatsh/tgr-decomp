...
int __thiscall sub_100603A0(int *this, int a2) {
    ...
    if (!result)
        return result;
    (*(void(__stdcall **)(int))(*(_DWORD *)result + 28))(this[20]);
    while ((*(int(__stdcall **)(int, int, int *))(*(_DWORD *)this[20] + 36))(this[20], 16, v19) ==
           -2147024866) {
        if ((*(int(__stdcall **)(int))(*(_DWORD *)this[20] + 28))(this[20]) < 0)
            break;
        (*(void(__stdcall **)(int))(*(_DWORD *)this[20] + 28))(this[20]);
    }
    v6 = v19[0] + *this;
    v7 = v19[1] + this[1];
    v8 = v19[2] + this[2];
    ...
    *((_BYTE *)this + 39) = v12;
    ...
    dword_10AA339C = 0;
    dword_10AA3398 = 0;
    if (*this != this[3] || this[1] != this[4] || *((_BYTE *)this + 36) != *((_BYTE *)this + 40) ||
