...
int __cdecl sub_100491B0(int a1)
{
  ...
  *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
  ...
  (*(void (__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, _DWORD, int))(*v7 + 56))(
    ...
    0,
    1);
  v8 = (_DWORD *)operator new(0x1E214u);
  if ( v8 )
    v9 = sub_100476C0(v8);
  else
    v9 = 0;
  ...
  if ( !v9 )
    sub_1003E260(4);
  v10 = *(_DWORD *)v9;
  (*(void (__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(*(_DWORD *)v9 + 56))(
    v9,
    a1,
    v3[206],
    1092616192,
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v10 + 52))(v9, v11, 1, 1, &unk_100AB508);
  ++*((_WORD *)v3 + 10);
  ...
  *((_WORD *)v20 + 5467) = v23 + 1;
  ++*((_WORD *)v3 + 10);
  ++*((_WORD *)v3 + 418);
  v24 = (_DWORD *)operator new(0x1E214u);
  if ( v24 )
  ...
  *((_WORD *)v27 + 5467) = v30 + 1;
  ...
  (*(void (__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v32 + 56))(
    ...
    8);
  ++*((_WORD *)v3 + 10);
  v33 = (_DWORD *)operator new(0x1E214u);
  if ( v33 )
  ...
  *((_WORD *)v34 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v35 + 52))(v34, v36, 1, 1, &dword_100AB448);
  v37 = *((_WORD *)v3 + 10);
  ++*((_WORD *)v34 + 5466);
  ...
  *((_WORD *)v41 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v42 + 52))(v41, v43, 1, 1, &dword_100AB448);
  v44 = *((_WORD *)v3 + 10);
  ++*((_WORD *)v41 + 5466);
  *((_WORD *)v41 + 5467) = v44 + 1;
  ++*((_WORD *)v3 + 10);
  ++*((_WORD *)v3 + 418);
  v45 = (_DWORD *)operator new(0x1E214u);
  if ( v45 )
  ...
  (*(void (__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v46 + 56))(
    ...
    9);
  ++*((_WORD *)v3 + 10);
  v47 = (_DWORD *)operator new(0x1E214u);
  if ( v47 )
  ...
  *((_WORD *)v48 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v49 + 52))(v48, v50, 1, 1, &dword_100AB448);
  v51 = *((_WORD *)v3 + 10);
  ++*((_WORD *)v48 + 5466);
  ...
  *((_WORD *)v53 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v54 + 52))(v53, v55, 1, 1, &dword_100AB448);
  ++*((_WORD *)v3 + 10);
  ++*((_WORD *)v3 + 418);
  ...
  if ( !v57 )
    sub_1003E260(4);
  v58 = *(_DWORD *)v57;
  (*(void (__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(*(_DWORD *)v57 + 56))(
    v57,
    a1,
    v3[206],
    1105723392,
    ...
    -1);
  v57[61702] = 3;
  (*(void (__thiscall **)(_WORD *, char *, int, int, void *))(v58 + 52))(v57, asc_100AD300, 1, 1, &unk_100AB558);
  result = 1;
