//----- (10059760) --------------------------------------------------------
int __cdecl sub_10059760(int a1) {
    ...
    *((_WORD *)v11 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v3[206], LODWORD(v25), 1056769, 2, 5, 1, -1);
    v15[3] = sub_10047360;
    v15[2] = sub_10044D00;
    *((_WORD *)v15 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v19 + 56))(
        v19, a1, v3[206], LODWORD(v26), 1056769, 2, 5, 1, -1);
    v19[3] = sub_10047360;
    v19[2] = sub_10044C70;
    *((_WORD *)v19 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v23 + 56))(
        v23, a1, 1117782016, 1110966272, 9, 2, 5, 0, 8);
    ++*((_WORD *)v3 + 10);
    return 1;
}
