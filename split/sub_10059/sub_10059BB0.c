...
int __cdecl sub_10059BB0(int a1) {
    ...
    (*(void(__thiscall **)(_DWORD, char *))(**(_DWORD **)(dword_10AA2908 + 196) + 4))(
        *(_DWORD *)(dword_10AA2908 + 196), aTimeattackGrf);
    *(_WORD *)(a1 + 18) = 0;
    dword_10AA28E8 = 0;
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v2;
    ...
    for (i = 0; i < 26000; i += 260) {
        if (*(_DWORD *)(dword_10AA2908 + 196) + i != -4)
            (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, void *, int))(*v12 + 16))(
                v12, *(_DWORD *)(dword_10AA2908 + 196) + i + 4, 0, 1, &unk_100AB4D8, 1);
    }
    ++*((_WORD *)v2 + 10);
    ++*((_WORD *)v2 + 418);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v2[206], LODWORD(v62), 1060881, 2, 5, 1, -1);
    v15[3] = sub_10047360;
    v15[2] = sub_10046380;
    v15[1] = sub_100418F0;
    *((_WORD *)v15 + 61702) = 2;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v19 + 56))(
        v19, a1, v2[206], LODWORD(v63), 1056769, 2, 5, 1, -1);
    v19[3] = sub_10047360;
    v19[2] = sub_10044DE0;
    *((_WORD *)v19 + 61702) = 3;
    ...
    *((_WORD *)v23 + 5467) = v24;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v26 + 56))(
        v26, a1, v2[206], 1127546880, 1052673, 2, 5, 1, -1);
    v26[1] = sub_1003FA00;
    *((_WORD *)v26 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v27 + 52))(
        v26, asc_100AD300, 1, 1, &unk_100AB488);
    ++*((_WORD *)v2 + 10);
    ...
    *((_WORD *)v29 + 5467) = v30;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v32 + 56))(
        v32, a1, v2[206], 1124663296, 1052673, 2, 5, 1, -1);
    v32[1] = sub_1003F760;
    *((_WORD *)v32 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v33 + 52))(
        v32, asc_100AD300, 1, 1, &unk_100AB468);
    ++*((_WORD *)v2 + 10);
    ...
    *((_WORD *)v35 + 5467) = v36;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v38 + 56))(
        v38, a1, v2[206], 1133084672, 1052673, 2, 5, 1, -1);
    v38[1] = sub_1003FE80;
    *((_WORD *)v38 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v39 + 52))(
        v38, asc_100AD300, 1, 1, &unk_100AB4B8);
    ++*((_WORD *)v2 + 10);
    ...
    *((_WORD *)v41 + 61702) = 5;
    ...
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v45 + 52))(
        v44, v46, 1, 1, &unk_100AB458);
    ++*((_WORD *)v2 + 10);
    ...
    v48[1] = sub_10041040;
    *((_WORD *)v48 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v49 + 52))(
        v48, asc_100AD300, 1, 4, &unk_100AB478);
    ++*((_WORD *)v2 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v52 + 52))(
        v51, v53, 1, 1, &unk_100AB478);
    ++*((_WORD *)v2 + 10);
    ...
    *((_WORD *)v55 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v56 + 52))(
        v55, asc_100AD300, 1, 4, &unk_100AB478);
    ++*((_WORD *)v2 + 10);
