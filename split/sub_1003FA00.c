...
int __cdecl sub_1003FA00(int a1)
{
  ...
  if ( dword_10AA2904 != (void *)dword_10AA2964 || dword_10AA28E8 )
  {
    ...
    else
    {
      if ( byte_10AA28A8 )
      {
        v4 = getCaptionString(dword_100AC308[(unsigned __int8)byte_100B3820[24 * (char)dword_10AA28B8
                                                                          + 2 * dword_10AA28AC]]);
        v5 = dword_10AA28AC;
      }
      else
      ...
      strcpy(v15, v4);
      v6 = (unsigned __int8)byte_100B3820[24 * (char)dword_10AA28B8 + 2 * v5];
    }
    v1 = a1;
    if ( ((_BYTE)stringOffsets[v6][1] & 0x10) != 0 )
    {
      v14 = *(_DWORD *)(a1 + 64);
      *(_DWORD *)(a1 + 12144) = 1124204544;
      v7 = getCaptionString(0xB0u);
      v8 = *(_DWORD *)(a1 + 11100);
