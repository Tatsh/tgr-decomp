...
int __thiscall sub_1005C590(char *this, int *a2) {
    ...
    if ((v4 & 0x18) != 0)
        return 0;
    v6 = dword_10AA2E80;
    if ((v4 & 0x80000) == 0 || *((_DWORD *)dword_10AA2E80 + 11) ||
        *((_DWORD *)dword_10AA2E80 + 12)) {
        if ((v4 & 0x80000) != 0 &&
            (*((_DWORD *)dword_10AA2E80 + 11) || *((_DWORD *)dword_10AA2E80 + 12))) {
            LOBYTE(v4) = v4 | 0x22;
            *((_DWORD *)this + 6) = v4;
            v7 = getTicks();
            v8 = dword_10AA2A60;
    ...
    v50 = v10;
    if (((int(__fastcall *)(char *, void *, char *))v10)(this, v6, this + 108940) ||
        *((_DWORD *)this + 27245)) {
        v11 = *((_DWORD *)this + 6);
        if ((v11 & 0x200000) == 0) {
            if ((v11 & 2) != 0) {
