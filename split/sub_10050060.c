...
int __cdecl sub_10050060(int a1)
{
  ...
  *((_WORD *)v19 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v26 + 52))(v25, v27, 1, 1, &unk_100AB468);
  ++*((_WORD *)v2 + 10);
  ...
  v29[1] = sub_10040A50;
  *((_WORD *)v29 + 61702) = 5;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v30 + 52))(v29, String2, 1, 3, &unk_100AB468);
  ++*((_WORD *)v2 + 10);
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v33 + 52))(v32, v34, 1, 1, &unk_100AB488);
  ++*((_WORD *)v2 + 10);
  ...
  v36[1] = sub_10040AC0;
  *((_WORD *)v36 + 61702) = 5;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v37 + 52))(v36, String2, 1, 3, &unk_100AB488);
  ++*((_WORD *)v2 + 10);
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v40 + 52))(v39, v41, 1, 1, &unk_100AB478);
  ++*((_WORD *)v2 + 10);
  ...
  v43[1] = sub_10041300;
  *((_WORD *)v43 + 61702) = 52;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v44 + 52))(v43, String2, 1, 4, &unk_100AB478);
  ++*((_WORD *)v2 + 10);
  *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 108) = 0;
  v45 = (_DWORD *)operator new(0x348u);
  if ( v45 )
  ...
  *((_WORD *)v48 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, void *))(v49 + 52))(v48, v50, 1, 1, &unk_100AB438);
