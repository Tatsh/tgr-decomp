  ...
  if ( dword_100AA8B4 > 0 )
  {
    ...
    do
    {
      ...
      else
      {
        ...
        *(float *)((char *)&unk_104BBDF0 + v2) = cos(*(float *)&dword_104BBE0C)
                                               * flt_100A79C8
      ...
      if ( v4 )
      {
        v31 = ((double)(unsigned __int16)sub_1003BD50() * 0.000030518044 - 1.0) * *(float *)&dword_106C2CFC * 0.25;
        v32 = ((double)(unsigned __int16)sub_1003BD50() * 0.000030518044 - 1.0) * *(float *)&dword_106C2CFC * 0.25;
      }
      else
      {
        v32 = 0.0;
