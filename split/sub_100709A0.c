...
char sub_100709A0()
{
  ...
  Buffer = CalculateChecksum(v0, dword_10ACED34->gap0, 0x200u);
  v1 = fopen(aCRallyseasonDatFilepath_ptr, aWb);
  v2 = v1;
  if ( !v1 )
    return 0;
  if ( fwriteLock(aRsea, 1u, 4u, v1) == 4 )
  {
    v4 = fwriteLock(&Buffer, 1u, 4u, v2);
    v7 = v2;
    if ( v4 != 4 )
      goto LABEL_9;
    v5 = fwriteLock(dword_10ACED34, 1u, 0x200u, v2);
    v7 = v2;
    if ( v5 != 512 )
      goto LABEL_9;
    fwriteLock(&dword_10AA2A08, 4u, 1u, v2);
    fwriteLock(&dword_100AC64C, 4u, 1u, v2);
