...
int __thiscall sub_10075360(int this)
{
  ...
  v27 = v3;
  v28 = v4;
  if ( (g_chosenTrack == 3 || g_chosenTrack == 9) && v3 >= 0x38u && v3 <= 0x3Au && v4 >= 0x17u && v4 <= 0x1Bu )
  {
    v27 = 57;
    v28 = 25;
    v33 = 0;
  ...
  if ( !v33
    || (v5 = *(_DWORD *)(v1 + 3980) + 40 * *(_DWORD *)(v1 + 3984),
        sub_1003BC90((float *)(v5 + 64), (float *)(v5 + 88), (float *)(v1 + 3968), (float *)(this + 48)))
    || (v6 = *(_DWORD *)(v1 + 3980) + 40 * *(_DWORD *)(v1 + 3984),
        sub_1003BC90((float *)(v6 + 104), (float *)(v6 + 128), (float *)(v1 + 3968), v2))
    || sub_1003B0E0(v2, (float *)(*(_DWORD *)(v1 + 3980) + 40 * *(_DWORD *)(v1 + 3984) + 76)) >= 64.0 )
  {
    v9 = 0;
    ...
    if ( dword_106C7CC4 > 0 )
    {
      ...
      do
      {
        if ( *(_DWORD *)(v1 + 320) < dword_100B4050
          || g_GameMode == 2
          || (*(_BYTE *)(*(_DWORD *)(dword_106C7CC0 + 4 * v9) + 22) & 1) == 0 )
        {
          ...
          if ( v27 >= *(_BYTE *)(v11 + 16)
            ...
            && (!v33
             ...
             && v36 - (*(float *)(v10 + 100) - *(float *)(v11 + 40 * *(unsigned __int16 *)(v11 + 20) + 100)) <= 1000.0) )
          {
            v12 = 0;
  ...
  v35 = (double)(*(_DWORD *)(this + 4012) + 1) * *(float *)(dword_106C7CB8 + 100)
      - v23[25]
      + sub_1003AC90(&v44, v47)
      - *(float *)(this + 4084);
