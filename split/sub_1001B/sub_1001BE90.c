...
# 490 * v19;              // edi
    ...
    if (dword_104C1694 == 5260096) {
        ...
        *(float *)v33 = v22;
        ...
        (*((void(__stdcall **)(IDirect3DDevice2 *, int, int, char *, int, int))v14 + 29))(
            g_D3DDevice2, 4, 3, v38, 3, 9);
        *(float *)v33 = v22;
        v33[2] = 0;
        v33[3] = 1065353216;
        ...
        *(float *)&v33[1] = v23;
        ...
        v33[7] = 1065353216;
        qmemcpy(v40, v33, sizeof(v40));
        (*((void(__stdcall **)(IDirect3DDevice2 *, int, int, char *, int, int))v15 + 29))(
            g_D3DDevice2, 4, 3, v38, 3, 9);
        ...
        *((_DWORD *)v17 + 22) = 1;
        ...
        v18->field_58 = 1;
        sub_1001C620(v18);
        (*(void(__stdcall **)(#490 *, D3DMATERIALHANDLE))(*(_DWORD *)v19 + 32))(
            v19, v18->lpD3DMaterialHandle);
