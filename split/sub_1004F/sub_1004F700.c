...
int __cdecl sub_1004F700(int a1)
{
  ...
  *((_WORD *)v16 + 61702) = 2;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v22 + 52))(v21, v23, 1, v55, &dword_100AB448);
  ++*((_WORD *)v3 + 10);
  ++*((_WORD *)v3 + 418);
  ...
  *((_WORD *)v25 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v32 + 52))(v31, v33, 1, 1, &unk_100AB468);
  ++*((_WORD *)v3 + 10);
  v34 = (_DWORD *)operator new(0x1E214u);
  if ( v34 )
  ...
  v35[1] = sub_10040A50;
  *((_WORD *)v35 + 61702) = 5;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v36 + 52))(v35, String2, 1, 3, &unk_100AB468);
  ++*((_WORD *)v3 + 10);
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v39 + 52))(v38, v40, 1, 1, &unk_100AB488);
  ++*((_WORD *)v3 + 10);
  ...
  v42[1] = sub_10040AC0;
  *((_WORD *)v42 + 61702) = 5;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v43 + 52))(v42, String2, 1, 3, &unk_100AB488);
  ++*((_WORD *)v3 + 10);
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v46 + 52))(v45, v47, 1, 1, &unk_100AB478);
  ++*((_WORD *)v3 + 10);
  ...
  v49[1] = sub_10041300;
  *((_WORD *)v49 + 61702) = 52;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v50 + 52))(v49, String2, 1, 4, &unk_100AB478);
  ++*((_WORD *)v3 + 10);
  return 1;
}
