...
int __cdecl sub_100773F0(int *a1, int *a2)
{
  ...
  if ( v7 || v6 == 2 )
  {
    ...
    v8 = g_DirectInputDevice2A->lpVtbl->GetDeviceState(g_DirectInputDevice2A, 272, &dword_118ABAE0[68 * dword_118ABAB8]);
    if ( v8 )
    {
      if ( v8 == -2147024866 )
        sub_100773D0();
  ...
  {
    v11 = (*(int (__stdcall **)(_DWORD, int, int *))(*(_DWORD *)v10 + 36))(*((_DWORD *)dword_10AA2E80 + 20), 16, &v62);
    if ( !v11 )
    {
