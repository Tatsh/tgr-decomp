...
int __cdecl sub_1004CAC0(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v4;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v12 + 56))(
        v12, a1, v4[206], v4[207], 12289, 2, 5, 1, -1);
    v13 = v12[3598];
    v12[1] = sub_1003EC80;
    v12[30845] = 1;
    v44 = v12 + 3598;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v18 + 56))(
        v18, a1, v4[206], LODWORD(v41), 1056769, 2, 5, 1, -1);
    v18[3] = sub_10047360;
    v18[2] = sub_10040680;
    v18[6] = sub_10040450;
    *((_WORD *)v18 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v22 + 56))(
        v22, a1, v4[206], LODWORD(v42), 1056769, 2, 5, 1, -1);
    v22[3] = sub_10047360;
    v22[2] = sub_10046560;
    *((_WORD *)v22 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v26 + 56))(
        v26, a1, 1117782016, 1110966272, 9, 2, 5, 0, 9);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v28 + 56))(
        v28, a1, v4[206], 1124532224, 1052673, 2, 5, 1, -1);
    v28[1] = sub_1003F8D0;
    *((_WORD *)v28 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v29 + 52))(
        v28, asc_100AD300, 1, 1, &unk_100AB488);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v31 + 56))(
        v31, a1, 1134690304, 1110966272, 1, 2, 5, 1, 22);
    v31[1] = sub_10041870;
    v32 = *((_WORD *)v4 + 10) + 1;
    ++*((_WORD *)v31 + 5466);
    *((_WORD *)v31 + 5467) = v32;
    ...
    v35 = *(_DWORD *)v34;
    (*(void(__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(
        *(_DWORD *)v34 + 56))(v34, a1, v4[206], 1125842944, 1048577, 2, 5, 1, -1);
    v34[61702] = 3;
    v36 = getCaptionString(0x28u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v35 + 52))(
        v34, v36, 1, 1, &unk_100AB4C8);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v38 + 56))(
        v38, a1, v4[206], 1120403456, 1052673, 2, 5, 1, -1);
    v38[1] = sub_100400E0;
    *((_WORD *)v38 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v39 + 52))(
        v38, asc_100AD300, 1, 1, &unk_100AB4C8);
    ++*((_WORD *)v4 + 10);
