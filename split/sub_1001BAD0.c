...
int sub_1001BAD0()
{
  ...
  v0 = g_gsu0;
  if ( g_D3dwaitcanflip && g_gsu0->lpDDrawSurface2->lpVtbl->GetFlipStatus(g_gsu0->lpDDrawSurface2, 1) )
  {
  ...
  if ( g_D3dwaitflipdon )
  {
    for ( result = v0->lpDDrawSurface2->lpVtbl->GetFlipStatus(v0->lpDDrawSurface2, 2);
          result;
