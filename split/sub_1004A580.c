...
int __cdecl sub_1004A580(int a1)
{
  ...
  *((_WORD *)v32 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v33 + 52))(v32, v34, 1, 1, &dword_100AB448);
  ++*((_WORD *)v4 + 10);
  ++*((_WORD *)v4 + 418);
