...
int __cdecl sub_100558A0(int a1)
{
  ...
  *((_WORD *)v10 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v11 + 52))(v10, v12, 1, 1, &dword_100AB448);
  ++*((_WORD *)v2 + 10);
  ++*((_WORD *)v2 + 418);
  v13 = (_DWORD *)operator new(0x1E214u);
  if ( v13 )
    v14 = sub_100476C0(v13);
  else
    v14 = 0;
  ...
  *((_WORD *)v14 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v15 + 52))(v14, v16, 1, 1, &dword_100AB448);
  ++*((_WORD *)v2 + 10);
  ++*((_WORD *)v2 + 418);
  v17 = (_DWORD *)operator new(0x1E214u);
  if ( v17 )
  ...
  *((_WORD *)v22 + 61702) = 3;
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, int *))(v29 + 52))(v28, v30, 1, 4, &dword_100AB448);
  ++*((_WORD *)v2 + 10);
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, int *))(v33 + 52))(v32, v34, 1, 1, &dword_100AB448);
  ++*((_WORD *)v2 + 10);
  ...
  (*(void (__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v36 + 56))(
    ...
    57);
  ++*((_WORD *)v2 + 10);
  v37 = (_DWORD *)operator new(0x1E214u);
  if ( v37 )
  ...
  v38[4] = sub_10042AF0;
  *((_WORD *)v38 + 61702) = 3;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, int *))(v39 + 52))(v38, String2, 1, 1, &dword_100AB448);
  ...
  *((_WORD *)v38 + 6076) = *((_WORD *)v38 + 6084) - *((_WORD *)v38 + 6080) - 16;
  ++*((_WORD *)v2 + 10);
  ++*((_WORD *)v2 + 418);
  v40 = (_DWORD *)operator new(0x1E214u);
  if ( v40 )
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, int *))(v42 + 52))(v41, v43, 1, 1, &dword_100AB448);
  ++*((_WORD *)v2 + 10);
  ...
  v47[4] = sub_10042AF0;
  *((_WORD *)v47 + 61702) = 3;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, int *))(v48 + 52))(v47, String2, 1, 1, &dword_100AB448);
  ...
  *((_WORD *)v52 + 5467) = v53;
  ++*((_WORD *)v2 + 10);
  v54 = (_DWORD *)operator new(0x1E214u);
  if ( v54 )
  ...
  v55[1] = sub_1003FC40;
  *((_WORD *)v55 + 61702) = 3;
  (*(void (__thiscall **)(_DWORD *, char *, int, int, void *))(v56 + 52))(v55, asc_100AD300, 1, 1, &unk_100AB4A8);
  ++*((_WORD *)v2 + 10);
  return 1;
}
