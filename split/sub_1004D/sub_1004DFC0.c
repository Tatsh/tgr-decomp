...
int __cdecl sub_1004DFC0(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v4;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v12 + 56))(
        v12, a1, 1117782016, 1110966272, 9, 2, 5, 0, 9);
    ++*((_WORD *)v4 + 10);
    v13 = (_DWORD *)malloc(0x1E214u);
    if (v13)
        v14 = (float *)sub_100476C0(v13);
    else
        v14 = 0;
    v4[*((unsigned __int16 *)v4 + 10) + 6] = v14;
    if (!v14)
        sub_1003E260(4);
    (*(void(__thiscall **)(float *, int, _DWORD, _DWORD, int, int, int, int, int))(
        *(_DWORD *)v14 + 56))(v14, a1, v4[206], v4[207], 12289, 2, 5, 1, -1);
    ...
    *((_DWORD *)v14 + 30845) = 1;
    ...
    (*(void(__thiscall **)(_DWORD *, int, void *, int, int, int))(v16 + 20))(
        (_DWORD *)v14 + 3598, 262145, &unk_100AB548, 4, v15, -1);
    ...
    *((_DWORD *)v14 + 3599) = sub_1004E810;
    ...
    if (dword_10AA2A34 >= 0) {
        if (dword_10AA2A34 <= 11)
            v14[30842] =
                v14[30848] - (v14[30849] - v14[30848]) * (double)dword_10AA2A34 * -0.090909094;
        else
            v14[30842] = v14[30849];
    } else {
        v14[30842] = v14[30848];
    ...
    *((_DWORD *)v14 + 30836) = v19 + 16;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v21 + 56))(
        v21, a1, v4[206], LODWORD(v47), 1056769, 2, 5, 1, -1);
    v21[3] = sub_10047360;
    v21[2] = sub_10042CF0;
    *((_WORD *)v21 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v25 + 56))(
        v25, a1, v4[206], LODWORD(v48), 1056769, 2, 5, 1, -1);
    v25[3] = sub_10047360;
    v25[2] = sub_10042D60;
    *((_WORD *)v25 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v29 + 56))(
        v29, a1, v4[206], LODWORD(v49), 1056769, 2, 5, 1, -1);
    v29[3] = sub_10047360;
    v29[2] = sub_100466C0;
    *((_WORD *)v29 + 61702) = 3;
    v31 = getCaptionString(0xCu);
    (*(void(__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v30 + 52))(
        v29, v31, 1, 1, &dword_100AB448);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v33 + 56))(
        v33, a1, 1117257728, 1129512960, 1, 2, 5, 1, 104);
    v33[1] = sub_1003E950;
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v35 + 56))(
        v35, a1, 1117126656, 1132822528, 9, 2, 5, 1, 106);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v37 + 56))(
        v37, a1, 1117650944, 1132462080, 1, 2, 5, 1, 107);
    v37[1] = sub_1003EA40;
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v39 + 56))(
        v39, a1, 1135181824, 1119092736, 1056769, 2, 5, 1, -1);
    v39[1] = sub_1003E980;
    *((_WORD *)v39 + 61702) = 3;
    v41 = getCaptionString(0x2Eu);
    (*(void(__thiscall **)(_DWORD *, LPCSTR, int, int, void *))(v40 + 52))(
        v39, v41, 1, 1, &unk_100AB468);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v43 + 56))(
        v43, a1, 1135181824, 1124073472, 1056769, 2, 5, 1, -1);
    v43[1] = sub_1003E9E0;
    *((_WORD *)v43 + 61702) = 3;
    v45 = getCaptionString(0x2Fu);
    (*(void(__thiscall **)(_DWORD *, LPCSTR, int, int, void *))(v44 + 52))(
