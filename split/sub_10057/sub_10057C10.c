...
int __cdecl sub_10057C10(int a1) {
    ...
    if (g_NetworkPlay == 2) {
        ...
        *((_WORD *)v11 + 61702) = 3;
        ...
        (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
            v15, a1, v3[206], LODWORD(v58), 1056769, 2, 5, 1, -1);
        v15[3] = sub_10047360;
        v15[2] = sub_10043180;
        *((_WORD *)v15 + 61702) = 3;
        ...
        (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v19 + 56))(
            v19, a1, v3[206], LODWORD(v59), 1056769, 2, 5, 1, -1);
        v19[3] = sub_10047360;
        v19[2] = sub_100430B0;
        *((_WORD *)v19 + 61702) = 3;
        ...
        (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v23 + 56))(
            v23, a1, v3[206], LODWORD(v60), 1056769, 2, 5, 1, -1);
        v23[3] = sub_10047360;
        v23[2] = sub_10044600;
        *((_WORD *)v23 + 61702) = 3;
    ...
    *((_WORD *)v27 + 61702) = 3;
    ...
    (*(void(__thiscall **)(
        _DWORD *, int, _DWORD, _DWORD, int, int, int, int, int, int, int, int *))(*v31 + 56))(
        v31, a1, v3[206], LODWORD(v62), 1056769, 2, 5, 1, -1, 1, 1, &dword_100AB448);
    v31[3] = sub_10047360;
    *((_WORD *)v31 + 61702) = 3;
    if (dword_10A9D000)
    ...
    *((_WORD *)v35 + 5467) = v36;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v38 + 56))(
        v38, a1, v3[206], 1133084672, 1052673, 2, 5, 1, -1);
    v38[1] = sub_1003FE80;
    *((_WORD *)v38 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v41 + 56))(
        v41, a1, 1134723072, 1116733440, 1, 2, 5, 1, 17);
    v41[1] = sub_10040730;
    v42 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v41 + 5466);
    *((_WORD *)v41 + 5467) = v42;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v44 + 56))(
        v44, a1, v3[206], 1125646336, 1052673, 2, 5, 1, -1);
    v44[1] = sub_1003FA00;
    *((_WORD *)v44 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v45 + 52))(
        v44, asc_100AD300, 1, 1, &unk_100AB4A8);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v47 + 56))(
        v47, a1, 1121189888, 1116209152, 20481, 2, 5, 1, -1);
    v47[1] = sub_100408D0;
    *((_WORD *)v47 + 61702) = 5;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v48 + 52))(
        v47, ::a1, 1, 3, &unk_100AB458);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v54 + 56))(
        v54, a1, 1138393088, 1124925440, 1, 2, 5, 1, 86);
    v54[1] = sub_1003F5E0;
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v56 + 56))(
        v56, a1, 1139671040, 1130364928, 1, 2, 5, 1, -1);
    v56[1] = sub_1003F680;
    ++*((_WORD *)v3 + 10);
    return 1;
}
