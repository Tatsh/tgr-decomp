...
int __cdecl sub_100575F0(int a1)
{
  ...
  *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v2;
  ...
  if ( !v10 )
    sub_1003E260(4);
  v11 = *(_DWORD *)v10;
  (*(void (__thiscall **)(_WORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*(_DWORD *)v10 + 56))(
    v10,
    a1,
    v2[206],
    v2[207],
    ...
    -1);
  v10[61702] = 52;
  v12 = getCaptionString(0x63u);
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, int *))(v11 + 52))(v10, v12, 1, 4, &dword_100AB448);
  ++*((_WORD *)v2 + 10);
  ++*((_WORD *)v2 + 418);
  ...
  v16[4] = sub_1003F280;
  *((_WORD *)v16 + 61702) = 3;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, int *))(v17 + 52))(v16, String2, 1, 1, &dword_100AB448);
  ...
  *((_WORD *)v16 + 6076) = *((_WORD *)v16 + 6084) - *((_WORD *)v16 + 6080) - 16;
  ...
  v26[2] = sub_100443E0;
  *((_WORD *)v26 + 61702) = 3;
  v28 = getCaptionString(0x1Eu);
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v27 + 52))(v26, v28, 1, 1, &dword_100AB448);
  ...
  v30[2] = sub_100444C0;
  *((_WORD *)v30 + 61702) = 3;
  v32 = getCaptionString(0xCu);
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v31 + 52))(v30, v32, 1, 1, &dword_100AB448);
  ++*((_WORD *)v2 + 10);
  ++*((_WORD *)v2 + 418);
