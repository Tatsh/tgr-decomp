  ...
  if ( result )
  {
    ...
    if ( gameSpecificUnk1_instance0 )
    {
      do
      {
        ...
        if ( dword_10AA29F0 )
        {
          (*(void (__thiscall **)(int, CHAR *, _DWORD, int, void *, int))(*(_DWORD *)(dword_10AA29F0 + 14392) + 16))(
            dword_10AA29F0 + 14392,
            v5,
            0,
            1,
            &unk_100AB528,
            1);
          (*(void (__thiscall **)(int, gameSpecificUnk1 *, int, int))(*(_DWORD *)(dword_10AA29F0 + 14392) + 40))(
            dword_10AA29F0 + 14392,
            v2 + 4,
            16,
            v3);
