...
_DWORD *__cdecl sub_10023A10(_DWORD *a1) {
    ...
    if ((unsigned __int16)*a1 >> 10) {
        ...
        do {
            v9 = 0;
            *(v7 - 5) =
                flt_104C4D20 * v5[1] + flt_104C4D30 * v5[2] + *v5 * flt_104C4D10 + flt_104C4D40;
            *(v7 - 4) =
                flt_104C4D24 * v5[1] + flt_104C4D34 * v5[2] + *v5 * flt_104C4D14 + flt_104C4D44;
            *(v7 - 3) =
                flt_104C4D28 * v5[1] + flt_104C4D38 * v5[2] + *v5 * flt_104C4D18 + flt_104C4D48;
