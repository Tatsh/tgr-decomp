...
int __cdecl sub_100509F0(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * v5 + 20) = v4;
    ...
    (*(void(__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(
        *(_DWORD *)v10 + 56))(v10, a1, v4[206], 1092616192, 1048585, 2, 5, 1, -1);
    v10[61702] = 3;
    v13 = getCaptionString(0x3Du);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v12 + 52))(
        v10, v13, 1, 1, &unk_100AB508);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v4[206], v4[207], 12289, 2, 5, 1, -1);
    v16 = v15[3598];
    v17 = v15 + 3598;
    v15[1] = sub_1003EB60;
    v15[30845] = 1;
    (*(void(__thiscall **)(_DWORD *, int, void *, int, _DWORD, int))(v16 + 20))(
        v15 + 3598, 2359296, &unk_100AB4D8, 5, 0, -1);
    v15[5] = sub_1003E8B0;
    v15[6] = sub_1003E8C0;
    v18 = 0;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v23 + 56))(
        v23, a1, v4[206], LODWORD(v103), 1056769, 2, 5, 1, -1);
    v23[3] = sub_10047360;
    v23[2] = sub_10045DC0;
    *((_WORD *)v23 + 61702) = 2;
    v25 = getCaptionString(0x1Eu);
    (*(void(__thiscall **)(_DWORD *, LPCSTR, int, _DWORD, int *))(v24 + 52))(
        v23, v25, 1, 0, &dword_100AB448);
    ++*((_WORD *)v4 + 10);
    ++*((_WORD *)v4 + 418);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v27 + 56))(
        v27, a1, v4[206], LODWORD(v104), 1056769, 2, 5, 1, -1);
    v27[3] = sub_10047360;
    v27[2] = sub_10046F50;
    v27[5] = sub_1003E840;
    *((_WORD *)v27 + 61702) = 3;
    ...
    *((_WORD *)v39 + 5409) = 85;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v42 + 56))(
        v42, a1, 1116864512, 1129578496, 1, 2, 5, 1, 22);
    v42[1] = sub_100407E0;
    v44 = *((_WORD *)v4 + 10) + 1;
    ++*((_WORD *)v42 + 5466);
    *((_WORD *)v42 + 5467) = v44;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v46 + 56))(
        v46, a1, v4[206], 1133084672, 1052673, 2, 5, 1, -1);
    v46[1] = sub_1003FE80;
    *((_WORD *)v46 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v48 + 52))(
        v46, asc_100AD300, 1, 1, &unk_100AB4B8);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v50 + 56))(
        v50, a1, 1134723072, 1116733440, 1, 2, 5, 1, 17);
    v50[1] = sub_10040730;
    v52 = *((_WORD *)v4 + 10) + 1;
    ++*((_WORD *)v50 + 5466);
    *((_WORD *)v50 + 5467) = v52;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v54 + 56))(
        v54, a1, v4[206], 1125646336, 1052673, 2, 5, 1, -1);
    v54[1] = sub_1003FA00;
    *((_WORD *)v54 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v56 + 52))(
        v54, asc_100AD300, 1, 1, &unk_100AB4A8);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v58 + 56))(
        v58, a1, 1138819072, 1125318656, 1048585, 2, 5, 1, -1);
    v58[61702] = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v62 + 56))(
        v62, a1, 1138819072, 1124073472, 20481, 2, 5, 1, -1);
    v62[1] = sub_10040C00;
    *((_WORD *)v62 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v64 + 52))(
        v62, String2, 1, 4, &unk_100AB4F8);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v66 + 56))(
        v66, a1, 1138819072, 1127809024, 1048585, 2, 5, 1, -1);
    v66[61702] = 3;
    v69 = getCaptionString(0x3Fu);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v68 + 52))(
        v66, v69, 1, 1, &unk_100AB4F8);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v71 + 56))(
        v71, a1, 1138819072, 1126563840, 20481, 2, 5, 1, -1);
    v71[1] = sub_10040D70;
    *((_WORD *)v71 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v72 + 52))(
        v71, String2, 1, 4, &unk_100AB4F8);
    ++*((_WORD *)v4 + 10);
    ...
    v76 = *(_DWORD *)v74;
    (*(void(__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(
        *(_DWORD *)v74 + 56))(v74, a1, v4[206], 1128988672, 1048585, 2, 5, 1, -1);
    v74[61702] = 3;
    v77 = getCaptionString(0x40u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v76 + 52))(
        v74, v77, 1, 1, &unk_100AB478);
    ++*((_WORD *)v4 + 10);
    ...
    v80 = *(_DWORD *)v79;
    (*(void(__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(
        *(_DWORD *)v79 + 56))(v79, a1, v4[206], 1132756992, 1048585, 2, 5, 1, -1);
    v79[61702] = 3;
    v81 = getCaptionString(0x41u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v80 + 52))(
        v79, v81, 1, 1, &unk_100AB478);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v83 + 56))(
        v83, a1, 1138819072, 1129906176, 20481, 2, 5, 1, -1);
    v83[1] = sub_100414B0;
    *((_WORD *)v83 + 61702) = 5;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v85 + 52))(
        v83, String2, 1, 3, &unk_100AB478);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v87 + 56))(
        v87, a1, 1121189888, 1118437376, 1048577, 2, 5, 1, -1);
    v87[61702] = 3;
    v89 = getCaptionString(0x38u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v88 + 52))(
        v87, v89, 1, 1, &unk_100AB458);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v91 + 56))(
        v91, a1, 1138491392, 1115947008, 20481, 2, 5, 1, -1);
    v91[1] = sub_10041300;
    *((_WORD *)v91 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v93 + 52))(
        v91, String2, 1, 4, &unk_100AB458);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v95 + 56))(
        v95, a1, 1121189888, 1123418112, 1048577, 2, 5, 1, -1);
    v95[61702] = 3;
    v98 = getCaptionString(0x36u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v97 + 52))(
        v95, v98, 1, 1, &unk_100AB458);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v100 + 56))(
        v100, a1, 1138491392, 1120927744, 20481, 2, 5, 1, -1);
    v100[1] = sub_100413B0;
    *((_WORD *)v100 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v101 + 52))(
        v100, String2, 1, 4, &unk_100AB458);
    ++*((_WORD *)v4 + 10);
    return 1;
}
