...
int sub_10073820() {
    ...
    if (dword_100B8C90 <= 1) {
        for (i = 0; i < 27; ++i)
            dword_11829238[i] = dword_118AA0AC((char *)&unk_1009B4C8 + dword_100A6070[i],
                                               0,
                                               64,
                                               64,
                                               704,
                                               ...
                                               0);
        for (j = 0; j < 26; ++j)
            dword_118292A8[j] = dword_118AA0AC((char *)&unk_100946C8 + dword_100A60E0[j],
                                               0,
                                               64,
                                               64,
                                               704,
    ...
    for (k = 0; k < 27; ++k)
        dword_11829158[k] = dword_118AA0AC((char *)&unk_100A4170 + dword_100A6150[k],
                                           0,
                                           32,
                                           32,
                                           392,
                                           ...
                                           0);
    for (l = 0; l < 26; ++l) {
        result = dword_118AA0AC((char *)&unk_100A22D0 + dword_100A61C0[l],
                                0,
                                32,
                                32,
                                392,
