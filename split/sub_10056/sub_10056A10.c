...
int __cdecl sub_10056A10(int a1)
{
  ...
  *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
  ...
  if ( !v11 )
    sub_1003E260(4);
  v12 = *(_DWORD *)v11;
  (*(void (__thiscall **)(_WORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*(_DWORD *)v11 + 56))(
    v11,
    a1,
    v3[206],
    v3[207],
  ...
  (*(void (__thiscall **)(_WORD *, LPCSTR, int, int, int *))(v12 + 52))(v11, v13, 1, 4, &dword_100AB448);
  ++*((_WORD *)v3 + 10);
  ...
  v17[4] = sub_1003F020;
  *((_WORD *)v17 + 61702) = 3;
  (*(void (__thiscall **)(_DWORD *, CHAR *, int, int, int *))(v18 + 52))(v17, String2, 1, 1, &dword_100AB448);
  v19 = v17[2775];
  ...
  *((_WORD *)v21 + 61702) = 2;
  ...
  (*(void (__thiscall **)(_DWORD *, LPCSTR, int, _DWORD, int *))(v22 + 52))(v21, v23, 1, 0, &dword_100AB448);
