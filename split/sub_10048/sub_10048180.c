...
int __thiscall sub_10048180(char *this) {
    ...
    v19 = *((_WORD *)this + 148);
    if ((this[28] & 0x10) != 0 || (v2 = *(_DWORD *)this,
                                   v20 = *(_DWORD *)this,
                                   (*(int(__thiscall **)(char *))(*(_DWORD *)this + 60))(this))) {
    ...
    LABEL_28:
        if ((*((_DWORD *)this + 7) & 0x10000) != 0 && *((__int16 *)this + 5466) > 0) {
            ...
            do {
                ...
                *(_WORD *)(*(_DWORD *)(*(_DWORD *)(*((_DWORD *)this + 2746) + 100) + 4 * *v11 +
                                       24) +
                           296) = v19;
                *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*((_DWORD *)this + 2746) + 100) + 4 * *v11 +
                                        24) +
                            10612) = 0;
                *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*((_DWORD *)this + 2746) + 100) + 4 * *v11 +
                                        24) +
                ...
                *((_DWORD *)this + 22) +=
                    *(__int16 *)(*(_DWORD *)(*(_DWORD *)(v13 + 100) + 4 * *v11 + 24) + 72);
