...
int __fastcall sub_8023DF9C(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11, int a12, int a13, int a14)
{
  int v15; // $s4
  int v17; // $s2
  int v18; // $a3
    ...
    do
    {
      ...
      if ( *(_BYTE *)(a1 + 17) )
      {
        if ( v28 == 1 )
        {
          ...
          dword_8028A858 = 8;
          MEMORY[0] = -234881024;
          MEMORY[4] = (((4 * (*(unsigned __int16 *)(a1 + 12) - 1)) & 0xFFF) << 12) | (4 * v25) & 0xFFF;
        }
        else if ( v28 == 2 )
        {
          MEMORY[4] = ((v34 & 0xF) << 14) | 0x80200 | (16 * (v35 & 0xF));
