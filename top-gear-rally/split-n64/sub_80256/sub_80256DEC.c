    ...
    *((_BYTE *)v1 + 22) = 0;
    ...
    if ( v4 )
    {
      ...
      *(_DWORD *)v16 = v17 + 40;
      ...
      v18 = &gMusicThreadStack[2 * (unsigned __int16)(*(char *)(v17 + 16) + *((unsigned __int8 *)v1 + 12))];
      v19 = v18[1];
      *((_DWORD *)v16 + 2) = *v18;
      *((_DWORD *)v16 + 3) = v19;
    }
    if ( v14 )
      LODWORD(qword_802A4798[v2 + 2]) = (*((unsigned __int8 *)v1 + 14)
                                       * *(unsigned __int8 *)(dword_803787D0[v14 - 1] + 12)) >> 6;
    v1 += 6;
    v2 += 3;
  }
