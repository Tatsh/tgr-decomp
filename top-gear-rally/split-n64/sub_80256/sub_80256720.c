...
void __fastcall sub_80256720(int a1, int a2)
{
  ...
  v10 = (char *)(a1
               + (unsigned __int8)HIBYTE(*(_DWORD *)(a1 + 60))
  ...
  if ( v9 )
  {
    ...
    {
      *v11 = v8;
      v12 = ((unsigned __int8)v10[3] << 24)
          + (unsigned __int8)*v10
          + ((unsigned __int8)v10[1] << 8)
          + ((unsigned __int8)v10[2] << 16)
          + ((unsigned __int8)v10[8] << 8)
...
LABEL_27:
          ...
          if ( v32 )
          {
            ...
            if ( v32 == 1 )
            {
              v39 = &v20[-v25[8] + -256 * v25[9] + -65536 * v25[10] + -16777216 * v25[11]];
              do
              {
                v38 += 4;
                v20 += 4;
