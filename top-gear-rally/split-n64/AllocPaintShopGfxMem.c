...
int __fastcall AllocPaintShopGfxMem(int a1)
{
  ...
  *(_DWORD *)a1 = sub_8024296C((*(_DWORD *)(a1 + 16) * *(_DWORD *)(a1 + 20) * (unsigned int)*(unsigned __int8 *)(a1 + 12)) >> 3);
  if ( CHK_GetFileSize(*(_DWORD *)(a1 + 4)) != (*(_DWORD *)(a1 + 16)
                                              * *(_DWORD *)(a1 + 20)
                                              * (unsigned int)*(unsigned __int8 *)(a1 + 12)) >> 3 )
  {
