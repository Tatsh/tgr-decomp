...
int __fastcall sub_8021EB50(int a1)
{
  ...
  v44 = *(_BYTE *)(a1 + 8305);
  v7 = (float *)(a1 + 48);
  v41 = *(float *)(a1 + 4008) - (float)(*(float *)(MEMORY[0x80025C70] + 100) * (float)*(int *)(a1 + 3964));
  v8 = *(_DWORD *)(a1 + 3932) + 40 * *(_DWORD *)(a1 + 3936);
  if ( !sub_80225E1C((float *)(v8 + 64), (float *)(v8 + 88), (float *)(a1 + 3920), (float *)(a1 + 48)) )
  {
    v9 = *(_DWORD *)(a1 + 3932) + 40 * *(_DWORD *)(a1 + 3936);
    if ( !sub_80225E1C((float *)(v9 + 104), (float *)(v9 + 128), (float *)(a1 + 3920), (float *)(a1 + 48))
      && sub_80224A78((float *)(a1 + 48), (float *)(*(_DWORD *)(a1 + 3932) + 40 * *(_DWORD *)(a1 + 3936) + 76)) < 64.0 )
    {
      v10 = 0.0;
      v11 = *(_DWORD *)(a1 + 3932);
      v12 = *(_DWORD *)(a1 + 3936);
  ...
  v14 = 0;
  v15 = (float)(MEMORY[0x80025C2C] - MEMORY[0x80025C28]) * (float)(MEMORY[0x80025C2C] - MEMORY[0x80025C28]);
  ...
  do
  {
    ...
    if ( v42 )
    {
      ...
      if ( (float)(v41 - (float)(v19 - *(float *)(v18 + 40 * *(unsigned __int16 *)(v18 + 20) + 100))) > 1000.0 )
      {
        v17 = v34;
        goto LABEL_33;
      }
...
LABEL_37:
    ...
    v32 = v43;
    v33 = (float)(v30
                + (float)((float)(*(float *)(MEMORY[0x80025C70] + 100) * (float)(*(_DWORD *)(a1 + 3964) + 1)) - v27[25]))
        - v31;
    if ( !v42 )
      goto LABEL_42;
    if ( v33 <= -1000.0 )
