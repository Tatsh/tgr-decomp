...
LABEL_18:
  ...
  return ((*(unsigned __int16 *)(MEMORY[0x80025C24]
                               + 2 * (unsigned __int16)((unsigned __int8)v6 + ((unsigned __int8)v12 << 6) + 1))
         - *(unsigned __int16 *)(MEMORY[0x80025C24]
                               + 2 * (unsigned __int16)((unsigned __int8)v6 + ((unsigned __int8)v12 << 6)))) << 16) | *(unsigned __int16 *)(MEMORY[0x80025C24] + 2 * (unsigned __int16)((unsigned __int8)v6 + ((unsigned __int8)v12 << 6)));
}
