...
int __fastcall sub_8025D060(int a1, float *a2)
{
  ...
  if ( *(_WORD *)(2 * v4 - 2143819128) )
  {
    do
    {
      ...
      v9[0] = (float)((float)(v14 - v11) * (float)(v18 - v12)) - (float)((float)(v17 - v11) * (float)(v15 - v12));
      v9[1] = (float)((float)(v15 - v12) * (float)(v16 - v10)) - (float)((float)(v18 - v12) * (float)(v13 - v10));
      v9[2] = (float)((float)(v13 - v10) * (float)(v17 - v11)) - (float)((float)(v16 - v10) * (float)(v14 - v11));
