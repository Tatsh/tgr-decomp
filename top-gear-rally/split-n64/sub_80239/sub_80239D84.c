...
float *sub_80239D84()
{
  ...
  flt_8028C808 = (float)((float)((float)((float)(unsigned __int16)sub_80225EE4() * 0.000030518044) - 1.0) * 0.0) + 0.0;
  if ( 6.2831855 <= 0.0 )
    flt_8028C808 = 0.0 - 6.2831855;
  flt_8028C80C = (float)((float)((float)((float)(unsigned __int16)sub_80225EE4() * 0.000030518044) - 1.0) * 0.0) + 0.5;
  if ( 1.0 < 0.5 )
    flt_8028C80C = 1.0;
