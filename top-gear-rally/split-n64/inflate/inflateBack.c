...
LABEL_11:
        ...
        case 3u:
          ...
          if ( v61 < 0x13 )
            v62 = (char *)((int (__fastcall *)(void *, int, int))a2->zalloc)(a2->opaque, 19, 4);
          else
            v62 = (char *)((int (__fastcall *)(void *, unsigned int, int))a2->zalloc)(a2->opaque, v61, 4);
          a1->next_out = v62;
          if ( !v62 )
          {
            a1->zalloc = v9;
...
LABEL_116:
            ...
            v94 = v75;
            if ( (v74 & 0x1F) + ((v74 >> 5) & 0x1F) + 258 < v75 + v93 || v83 == 16 && !v75 )
            {
              a1->next_in = (char *)9;
