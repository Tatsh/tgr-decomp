...
void __fastcall sub_8022C9FC(int a1)
{
  ...
  else if ( (v3 & 2) != 0 )
  {
    if ( v4 )
    {
      ...
      {
        *(_BYTE *)(v4 + 8291) = 2;
        *(float *)(*(_DWORD *)(a1 + 96) + 8292) = *(float *)(*(_DWORD *)(a1 + 96) + 8292) - 0.0;
        v4 = *(_DWORD *)(a1 + 96);
  ...
  else
  {
    ...
    *(float *)(a1 + 20) = v14;
    ...
    v19 = (float)((float)((float)(*(float *)(MEMORY[0x80025C70] + 100) * (float)v15) - *(float *)(a1 + 80))
    ...
    if ( *(int *)((char *)&dword_8031B760[948] + v18) )
    {
      ...
      *(float *)(a1 + 80) = *(float *)(a1 + 80)
                          + (float)(sub_80224B08((float *)&dword_8031B760[2084 * *(_DWORD *)(a1 + 116) + 3098]) * 0.0);
    }
    else
    {
