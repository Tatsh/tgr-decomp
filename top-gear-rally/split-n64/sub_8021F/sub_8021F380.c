#include "../../types-n64.h"
//----- (8021F380) --------------------------------------------------------
int __fastcall sub_8021F380(int a1, float *a2, float *a3, _WORD *a4, _DWORD *a5, _WORD *a6, int *a7, float *a8, _DWORD *a9)
{
  float v9; // $f0
  float v10; // $f20
  float v11; // $f18
  ...
  v10 = a3[1];
  v11 = *a3;
  v12 = (float)((float)(MEMORY[0x80025C3C] - MEMORY[0x80025C38]) * (float)(MEMORY[0x80025C3C] - MEMORY[0x80025C38]))
      + 1.0;
  v61 = 0;
  v53 = v10;
  v52 = v11;
