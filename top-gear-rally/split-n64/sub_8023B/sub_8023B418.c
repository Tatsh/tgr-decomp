...
LABEL_27:
        if ( !v37 )
        {
          ...
          if ( v12 == 3 )
          {
            sub_80224528(v43, (float)(1.0 - (float)(25.0 / (float)((float)(2.24 * v35) + 25.0))) * 3.0);
            if ( (float)((float)(1.0 - (float)(25.0 / (float)((float)(2.24 * v35) + 25.0))) * 3.0) != 0.0 )
            {
              if ( v5 >= 2 )
                v44 = v44 + v44;
...
LABEL_54:
          ...
          sub_802248FC(
            ...
            v14 + 1064,
            &v40,
            (float)((float)v23 * 0.000015259022) * (float)((float)v23 * 0.000015259022));
        }
        v22 = v45;
        goto LABEL_54;
      }
