...
void sub_8025721C()
{
  ...
  do
  {
    ...
    if ( *((_BYTE *)v0 + 13) )
    {
      ...
      v6 = &gMusicThreadStack[2
                            * (unsigned __int16)(*(char *)(dword_803787D0[v2 - 1] + 16)
...
LABEL_41:
    if ( v10 )
    {
      ...
      *((_BYTE *)v0 + 14) = v25;
      if ( v2 )
        LODWORD(qword_802A4798[v1 + 2]) = ((unsigned __int8)v25 * *(unsigned __int8 *)(dword_803787D0[v2 - 1] + 12)) >> 6;
    }
    v0 += 6;
    v1 += 3;
  }
