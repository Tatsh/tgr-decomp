    ...
    if ( *(_DWORD *)(*(_DWORD *)(a1 + 12) + 436) )
    {
      if ( *(_DWORD *)(*(_DWORD *)(a1 + 8) + 436) )
      {
        if ( *(_DWORD *)(*(_DWORD *)(a1 + 16) + 436) )
        {
          ...
          v43 = (float)(v50 * v44[2]) + (float)((float)(v44[0] * v48) + (float)(v44[1] * v49));
          v11 = *(float *)(a2 + 128);
          v59 = 0.0;
          v58 = 0.0;
          v12 = v11 - -0.97;
          v60 = (float)((float)(*(float *)(a1 + 44) + (float)(4.0 * *(float *)(a2 + 44))) * 2.9430003)
              + (float)(v12 * 0.0);
          v13 = *(float *)(a2 + 460);
          v14 = v13 / *(float *)(a2 + 456);
          v15 = (float)((float)(*(float *)(a2 + 428) * v60)
                      + (float)((float)(0.0 * *(float *)(a2 + 420)) + (float)(0.0 * *(float *)(a2 + 424))))
              * 3.5;
          *a3 = *a3 + (float)(v14 / 2.0);
          if ( *a4 )
            v14 = v14 * 0.9;
          ...
          v21 = v41;
          v22 = v40;
          *(float *)(*(_DWORD *)(a2 + 24) + 8) = v58 + *(float *)(*(_DWORD *)(a2 + 24) + 8);
          *(float *)(*(_DWORD *)(a2 + 24) + 12) = v59 + *(float *)(*(_DWORD *)(a2 + 24) + 12);
          *(float *)(*(_DWORD *)(a2 + 24) + 16) = v60 + *(float *)(*(_DWORD *)(a2 + 24) + 16);
          v23 = *(float *)(a2 + 456);
          *(float *)(a2 + 452) = *(float *)(a2 + 452) + (float)((float)(v22 - (float)(v23 * v21)) * a5);
          v24 = *(float *)(a2 + 452) - (float)((float)(*(float *)(a2 + 452) * v23) + v43) * 0.4;
          *(float *)(a2 + 452) = v24;
          v25 = *(float *)(a2 + 452);
          if ( v25 < 0.0 )
            v26 = -v25;
