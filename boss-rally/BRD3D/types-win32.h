...
/* 721 */
struct $7EFAA06ABB61ADC9CAC513F319E7BED1 {
    u_char ld12[12];
};

/* 722 */
typedef struct $7EFAA06ABB61ADC9CAC513F319E7BED1 _LDBL12;

/* 723 */
enum $CA9E4032A8710C47576EC3D2DBF0E31D {
    INTRNCVT_OK = 0x0,
...
/* 724 */
typedef enum $CA9E4032A8710C47576EC3D2DBF0E31D INTRNCVT_STATUS;

/* 725 */
struct $A10F9559CB3013744A375B1C2F423593 {
    int max_exp;
    int min_exp;
    int precision;
    int exp_width;
...
/* 726 */
typedef struct $A10F9559CB3013744A375B1C2F423593 FpFormatDescriptor;
...
/* 730 */
enum MACRO_D3DPTEXTURECAPS {
    D3DPTEXTURECAPS_PERSPECTIVE = 0x1,
    D3DPTEXTURECAPS_POW2 = 0x2,
    D3DPTEXTURECAPS_ALPHA = 0x4,
    D3DPTEXTURECAPS_TRANSPARENCY = 0x8,
    D3DPTEXTURECAPS_BORDER = 0x10,
    D3DPTEXTURECAPS_SQUAREONLY = 0x20,
};
...
enum MACRO_DSBCAPS {
    ...
    DSBCAPS_CTRLDEFAULT = 0xE0,
    DSBCAPS_CTRLALL = 0x1F0,
