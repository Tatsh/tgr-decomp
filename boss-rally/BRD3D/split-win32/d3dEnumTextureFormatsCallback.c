  ...
  switch ( *(_DWORD *)context )
  {
    case 2:
      if ( (v16[1] & 3) != 0 )
        ...
        v3 = 0;
      if ( !*((_DWORD *)context + 5)
        || v3 && (!sub_10009640(*((_DWORD *)context + 9)) || v3 > sub_10009640(*((_DWORD *)context + 9)) && v3 <= 8) )
      {
        goto LABEL_51;
      }
      break;
...
LABEL_32:
    ...
    case 0xB:
      ...
      if ( (v12 & 0x40) != 0
        && (!*((_DWORD *)context + 5)
         || v13 && (!sub_10009640(*((_DWORD *)context + 9)) || v13 < sub_10009640(*((_DWORD *)context + 9)))) )
      {
        goto LABEL_51;
      }
      break;
    case 0xC:
      ...
      if ( (v14 & 0x40) != 0
        && (!*((_DWORD *)context + 5)
         || v15 && (!sub_10009640(*((_DWORD *)context + 9)) || v15 > sub_10009640(*((_DWORD *)context + 9)))) )
      {
LABEL_51:
