...
int sub_10033498()
{
  ...
  for ( i = 0; i < dword_106C7C60; ++i )
  {
      ...
      && dword_106909E0 != 2 )
    {
      ...
      {
        for ( j = 1; j < *(unsigned __int16 *)(*(_DWORD *)(dword_106C7C64 + 36 * i + 8) + 2); ++j )
        {
          v6 = *(_DWORD *)(*(_DWORD *)(dword_106C7C64 + 36 * i + 8)
                         + 12 * (*(unsigned __int16 *)(*(_DWORD *)(dword_106C7C64 + 36 * i + 8) + 2) - 1)
                         + 8)
             - *(_DWORD *)(*(_DWORD *)(dword_106C7C64 + 36 * i + 8) + 8);
          if ( dword_106C56D8 - v6 * (dword_106C56D8 / v6) < *(_DWORD *)(*(_DWORD *)(dword_106C7C64 + 36 * i + 8)
                                                                       + 12 * j
                                                                       + 8) )
            break;
        }
