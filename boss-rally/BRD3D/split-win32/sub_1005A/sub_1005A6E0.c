...
int __cdecl sub_1005A6E0(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v2;
    ...
    for (i = 0; i < 26000; i += 260) {
        if (*(_DWORD *)(dword_10AA2908 + 196) + i != -4)
            (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, void *, _DWORD))(*v12 + 16))(
                v12, *(_DWORD *)(dword_10AA2908 + 196) + i + 4, 0, 1, &unk_100AB4D8, 0);
    }
    ++*((_WORD *)v2 + 10);
    ++*((_WORD *)v2 + 418);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v2[206], LODWORD(v41), 1056769, 2, 5, 1, -1);
    v15[3] = sub_10047360;
    v15[2] = sub_10044F00;
    *((_WORD *)v15 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v19 + 56))(
        v19, a1, 1138491392, 1129316352, 1052673, 2, 5, 1, -1);
    v19[1] = sub_10041040;
    *((_WORD *)v19 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v20 + 52))(
        v19, asc_100AD300, 1, 4, &unk_100AB478);
    ++*((_WORD *)v2 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v22 + 56))(
        v22, a1, 1138491392, 1130364928, 1048577, 2, 5, 1, -1);
    v22[61702] = 3;
    v24 = getCaptionString(0x6Fu);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v23 + 52))(
        v22, v24, 1, 1, &unk_100AB478);
    ++*((_WORD *)v2 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v26 + 56))(
        v26, a1, 1138491392, 1131413504, 1052673, 2, 5, 1, -1);
    v26[1] = sub_10041180;
    *((_WORD *)v26 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v27 + 52))(
        v26, asc_100AD300, 1, 4, &unk_100AB478);
    ++*((_WORD *)v2 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v33 + 56))(
        v33, a1, 1117782016, 1110966272, 9, 2, 5, 0, 6);
    ++*((_WORD *)v2 + 10);
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 108) = 0;
    v34 = (_DWORD *)malloc(0x348u);
    if (v34)
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v35;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v37 + 56))(
        v37, a1, 0, 1130889216, 1048585, 2, 5, 1, -1);
    v37[3] = sub_10047360;
    v37[1] = sub_10047250;
    v37[5] = sub_1003E7A0;
    *((_WORD *)v37 + 61702) = 3;
    v39 = getCaptionString(0x70u);
    (*(void(__thiscall **)(_DWORD *, LPCSTR, int, int, void *))(v38 + 52))(
        v37, v39, 1, 1, &unk_100AB438);
