...
int __cdecl sub_10056FF0(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v2;
    ...
    (*(void(__thiscall **)(_DWORD *, int, void *, int, _DWORD, int))(v11 + 20))(
        v10 + 3598, 262145, &unk_100AB4E8, 3, 0, -1);
    ...
    if (dword_10AA287C == 2) {
        ...
        (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v13 + 56))(
            v13, a1, v2[206], LODWORD(v33), 1056769, 2, 5, 1, -1);
        v13[3] = sub_10047360;
        v13[2] = sub_10043DA0;
        *((_WORD *)v13 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v17 + 56))(
        v17, a1, v2[206], LODWORD(v34), v18, 2, 5, 1, -1);
    v17[3] = sub_10047360;
    v17[2] = sub_10044280;
    *((_WORD *)v17 + 61702) = 2;
    ...
    (*(void(__thiscall **)(_DWORD *, LPCSTR, int, BOOL, int *))(v19 + 52))(
        v17, v21, 1, v37, &dword_100AB448);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v23 + 56))(
        v23, a1, v2[206], LODWORD(v35), 1056769, 2, 5, 1, -1);
    v23[3] = sub_10047360;
    v23[2] = sub_100440D0;
    *((_WORD *)v23 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v27 + 56))(
        v27, a1, v2[206], LODWORD(v36), 1056769, 2, 5, 1, -1);
    v27[3] = sub_10047360;
    v27[2] = sub_10044AE0;
    *((_WORD *)v27 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v31 + 56))(
        v31, a1, 1117782016, 1110966272, 9, 2, 5, 0, 7);
    ++*((_WORD *)v2 + 10);
    return 1;
}
