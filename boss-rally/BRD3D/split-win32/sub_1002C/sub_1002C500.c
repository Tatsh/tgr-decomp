...
LABEL_177:
                ...
                for (j = 0; j < (int)v73; ++j) {
                    if ((byte_10ACD500[128 * j] & 2) != 0) {
                        if (v87 == 2 && *((_DWORD *)*(&dword_10AD0868 + 2778 * j) + j + 11)) {
                            if (!j && (!dword_10ACEEA0 || (char)dword_10680738 != g_chosenTrack ||
                                       (int)ElementCount <= 8)) {
                                debugPrint(
    ...
    LABEL_230:
        ...
        goto LABEL_235;
    case 5:
        if ((g_GameMode == 2 || g_GameMode == 1 || !g_GameMode || g_GameMode == 6) &&
            !dword_106909E0)
            sub_1002F2A0();
        goto LABEL_265;
    case 6:
...
LABEL_469:
    ...
    if (!dword_106909E4) {
        ...
        if (g_GameMode != 4 || dword_106805B8 != 2) {
            if (dword_106909B8 &&
                (g_GameMode == 2 || g_GameMode == 1 || !g_GameMode || g_GameMode == 6)) {
                sub_1002F320();
            ...
            if ((g_GameMode != 4 || dword_106805B8 != 1 && (dword_106805B8 || dword_10680938)) &&
                dword_106909F0 == 2) {
