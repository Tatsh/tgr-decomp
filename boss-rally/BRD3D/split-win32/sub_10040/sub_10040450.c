    ...
    if (dword_10AA2844) {
        ...
        case 0:
            if (v0 >= 0) {
                ...
                meth_BossRallyConfig_10069B10(
                    &gConfig, 0, dword_100AB334[2 * dword_10AA2840], v5, dword_100AC6A0);
            }
        ...
        case 1:
            ...
            if (v0 >= 0) {
                ...
                dword_10AA2A38 = 1;
                meth_BossRallyConfig_10069B10(
                    &gConfig, 1, dword_100AB334[2 * dword_10AA2840], v5, v0);
            }
        ...
        case 2:
            ...
            if (v0 >= 0) {
                ...
                dword_10AA2A38 = 1;
                meth_BossRallyConfig_10069B10(&gConfig, 2, v4, v5, v0);
            }
        ...
        case 3:
            ...
            if (v0 >= 0) {
                dword_100AC6A0 = v0;
                meth_BossRallyConfig_10069B10(
                    &gConfig, 3, dword_100AB334[2 * dword_10AA2840], v2, v0);
                dword_10AA2A3C = 1;
            }
