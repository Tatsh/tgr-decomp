...
//----- (1001AF20) --------------------------------------------------------
HRESULT __thiscall meth_1001AF20(unk334 *a1, IDirect3DDevice2 *dev) {
    HRESULT result;                       // eax
    ...
    result = d3dDevice2Vtbl->EnumTextureFormats(
        dev, (LPD3DENUMTEXTUREFORMATSCALLBACK)enumTextureFormatsCallback, &context);
    if (result >= 0) {
    if ( context && v7 && a1[3].? == v7 )
    {
        v5 = a1->field_27;
