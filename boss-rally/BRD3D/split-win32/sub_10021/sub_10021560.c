...
int *__cdecl sub_10021560(unsigned int a1, unsigned int a2, int a3, int a4) {
    ...
    *(float *)&v42 = v24 * 8.0;
    ...
    if ((dword_104C5178 & 0x1000) != 0) {
        sub_1001D420((int)v77, (int)v47, (int)v57);
        result = sub_1001D420((int)v47, (int)v67, (int)v57);
    } else {
        sub_1001D420((int)v57, (int)v47, (int)v77);
        result = sub_1001D420((int)v57, (int)v67, (int)v47);
    }
    return result;
}
