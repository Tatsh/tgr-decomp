...
int __cdecl sub_10002E90(int a1, int a2) {
    ...
    return *(unsigned __int16 *)(MEMORY[0x106C7CB4] + 2 * v2) |
           ((0xFFFF * *(unsigned __int16 *)(MEMORY[0x106C7CB4] + 2 * v2) +
             *(unsigned __int16 *)(MEMORY[0x106C7CB4] + 2 * (unsigned __int16)(v2 + 1)))
            << 16);
}
