...
int __cdecl sub_10002DE0(float a1, float a2) {
    ...
    return *(unsigned __int16 *)(MEMORY[0x106C7C6C] + 2 * v2) |
           ((0xFFFF * *(unsigned __int16 *)(MEMORY[0x106C7C6C] + 2 * v2) +
             *(unsigned __int16 *)(MEMORY[0x106C7C6C] + 2 * (unsigned __int16)(v2 + 1)))
            << 16);
}
