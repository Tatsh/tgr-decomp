...
int sub_10019B50() {
    ...
    if (*(_DWORD *)&gUnk06594.gap1C8[12504] || *(_DWORD *)&gUnk06594.gap1C8[12508]) {
        ...
        LABEL_7:
            v4 = 0;
            v57 = (char *)&unk_104B2570 + 3132 * *(_DWORD *)&gUnk06594.gap1C8[8640];
            if (*(_DWORD *)&gUnk06594.gap1C8[12508])
                meth_DebugPrint((void *)(65 * *(_DWORD *)&gUnk06594.gap1C8[8640]));
            ...
            *v9 = -1191181539;
            ...
            dword_106C0680 += 8;
            if (*(_DWORD *)&gUnk06594.gap1C8[12508]) {
                *v10 = dword_11829100[*(_DWORD *)&gUnk06594.gap1C8[8640]] & 0xFFFFFF | 0xDD000000;
                v10[1] = (unsigned int)&unk_104B3DE8 + 0x4000 * *(_DWORD *)&gUnk06594.gap1C8[8640];
                v10 = (unsigned int *)dword_106C0680;
                dword_106C0680 += 8;
                *v10 = dword_11829100[*(_DWORD *)&gUnk06594.gap1C8[8640]] & 0xFFFFFF | 0xDC000000;
            } else {
            ...
            *v12 = -1241513984;
            ...
            if (*(_DWORD *)&gUnk06594.gap1C8[12508]) {
                sub_10060780(v1,
                             (char *)&unk_104B3DE8 + 0x4000 * *(_DWORD *)&gUnk06594.gap1C8[8640],
                             dword_11829318 << 12,
                             0);
                sub_1003B340(&v59,
                             (float *)&unk_104BBDF0 + 3 * *(_DWORD *)&gUnk06594.gap1C8[8640],
                             &flt_106C0860);
                sub_1003AE50(&v59);
                ...
                do {
                    ...
                    if ((int)v17 >= 2 && (int)v17 <= 61 && v16 >= 2 && v16 <= 61) {
                        sub_1001A4B0(*(int *)&gUnk06594.gap1C8[8640]);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 - 2, v16 - 1, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 - 2, v16, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 - 2, v16 + 1, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 - 1, v16 - 2, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 - 1, v16 - 1, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 - 1, v16, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 - 1, v16 + 1, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 - 1, v16 + 2, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18, v16 - 2, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18, v16 - 1, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18, v16, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18, v16 + 1, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18, v16 + 2, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 + 1, v16 - 2, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 + 1, v16 - 1, v4);
                        ...
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v18 + 1, v16 + 2, v4);
                        v19 = v18 + 2;
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v19, v16 - 1, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v19, v16, v4);
                        sub_1001A4D0(*(int *)&gUnk06594.gap1C8[8640], v19, v16 + 1, v4);
                    }
                    ++v4;
                } while (v4 < 16);
            ...
            *(_DWORD *)(result + 4) = 0x80000;
            ...
            v3 = (unsigned __int16 *)&gUnk06594.gap1C8[12112];
            while (1) {
                result = 21 * *v3;
                if ((*(_BYTE *)(*(_DWORD *)&gUnk06594.gap4918[16] + 84 * *v3 + 76) & 0x10) != 0)
                    break;
                ++v2;
                ++v3;
