...
int __thiscall meth_1005C2C0(__int16 *this, int a2) {
    ...
    if (v4 >= 0)
        (*(void(__thiscall **)(__int16 *, __int16, _DWORD, _DWORD))(*(_DWORD *)this + 4))(
            this, v4, *((_DWORD *)this + 9), *((_DWORD *)this + 10));
            ...
            if (v5 >= 0 && v5 < (unsigned __int16)this[54422]) {
                ...
                if (v6 != (__int16 *)-53) {
                    ...
                    *((_DWORD *)v6 + 279) = v23 + 18;
                    ...
                    (*(void(__thiscall **)(__int16 *, _DWORD, _DWORD))(v7 + 12))(
                        v6 + 22, LODWORD(v13), LODWORD(v18));
                    v3 = v24;
                }
                if ((*((_DWORD *)this + 6) & 0x2000000) != 0) {
                    ...
                    if (sub_100586D0(*((_DWORD *)v6 + 280))) {
                        v19 = (float)v23;
                        v14 = (float)v25;
                        (*(void(__thiscall **)(__int16 *, int, _DWORD, _DWORD))(
                            *(_DWORD *)this + 4))(this, 139, LODWORD(v14), LODWORD(v19));
                    } else {
                        v20 = (float)v23;
                        v15 = (float)v25;
                        (*(void(__thiscall **)(__int16 *, int, _DWORD, _DWORD))(
                            *(_DWORD *)this + 4))(this, 138, LODWORD(v15), LODWORD(v20));
                    }
                }
            }
            v24 = ++v3;
        ...
        if (v10 > 0) {
            ...
            if (*((_DWORD *)this + 27240))
                (*(void(__thiscall **)(__int16 *, int, float, float))(*(_DWORD *)this + 4))(
                    this, 45, COERCE_FLOAT(LODWORD(v17)), COERCE_FLOAT(LODWORD(v22)));
            else
                (*(void(__thiscall **)(__int16 *, __int16, float, float))(*(_DWORD *)this + 4))(
                    this, v10, COERCE_FLOAT(LODWORD(v17)), COERCE_FLOAT(LODWORD(v22)));
        }
        v11 = this[54428];
        if (v11 > 0)
            (*(void(__thiscall **)(__int16 *, __int16, _DWORD, _DWORD))(*(_DWORD *)this + 4))(
                this, v11, *((_DWORD *)this + 27243), *((_DWORD *)this + 27244));
    }
    return 1;
}
