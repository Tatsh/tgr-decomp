...
int __cdecl sub_10057C10(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
    ...
    if (g_NetworkPlay == 2) {
        ...
        v15->field_0->field_38(v15, (unkC8 *)a1, v3->field_338, LODWORD(v58), 1056769, 2, 5, 1, -1);
        ...
        v19->field_0->field_38(v19, (unkC8 *)a1, v3->field_338, LODWORD(v59), 1056769, 2, 5, 1, -1);
        ...
        v23->field_0->field_38(v23, (unkC8 *)a1, v3->field_338, LODWORD(v60), 1056769, 2, 5, 1, -1);
    ...
    v27->field_0->field_38(v27, (unkC8 *)a1, v3->field_338, LODWORD(v61), 1056769, 2, 5, 1, -1);
    v27->field_C = sub_10047360;
    v27->field_8 = (int(__cdecl *)())meth_100446D0;
    *(_DWORD *)&v27->gap10[8] = sub_100437D0;
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int, int, int, int *))
         v31->field_0->field_38)(
        v31, a1, v3->field_338, LODWORD(v62), 1056769, 2, 5, 1, -1, 1, 1, &dword_100AB448);
    ...
    *(_WORD *)&v35->gap5C[10842] = v36;
    ...
    if (!v38)
        sub_1003E260(4);
    v39 = v38->field_0;
    v38->field_0->field_38(v38, (unkC8 *)a1, v3->field_338, 1133084672, 1052673, 2, 5, 1, -1);
    ...
    if (!v41)
        sub_1003E260(4);
    v41->field_0->field_38(v41, (unkC8 *)a1, 1134723072, 1116733440, 1, 2, 5, 1, 17);
    ...
    *(_WORD *)&v41->gap5C[10842] = v42;
    ...
    if (!v44)
        sub_1003E260(4);
    v45 = v44->field_0;
    v44->field_0->field_38(v44, (unkC8 *)a1, v3->field_338, 1125646336, 1052673, 2, 5, 1, -1);
    ...
    if (!v47)
        sub_1003E260(4);
    v48 = v47->field_0;
    v47->field_0->field_38(v47, (unkC8 *)a1, 1121189888, 1116209152, 20481, 2, 5, 1, -1);
    v47->field_4 = sub_100408D0;
    LOWORD(v47->field_1E20C) = 5;
    ...
    if (!v50)
        sub_1003E260(4);
    v51 = v50->field_0;
    v50->field_0->field_38(v50, (unkC8 *)a1, 1121189888, 1122369536, 1048577, 2, 5, 1, -1);
    ...
    if (!v54)
        sub_1003E260(4);
    v54->field_0->field_38(v54, (unkC8 *)a1, 1138393088, 1124925440, 1, 2, 5, 1, 86);
    ...
    if (!v56)
        sub_1003E260(4);
    v56->field_0->field_38(v56, (unkC8 *)a1, 1139671040, 1130364928, 1, 2, 5, 1, -1);
