...
int __cdecl sub_1003FA00(int a1) {
    ...
    if (gUnkC8Ptr1 != gUnkC8Ptr32 || dword_10AA28E8) {
        if (gGameMode) {
            strcpy(buffer, text_GetStringWithIndex(dword_100AC308[dword_100AC648]));
            trackIndex = dword_100AC648;
        } else {
            if (byte_10AA28A8) {
                v4 = text_GetStringWithIndex(dword_100AC308[(
        ...
        if ((gTrackData[trackIndex]->field_4 & 0x10) != 0) {
            ...
            *(_DWORD *)(a1 + 12144) = 1124204544;
            v7 = text_GetStringWithIndex(0xB0u);
            v8 = *(_DWORD *)(a1 + 11100);
        ...
        v1 = a1;
        v2 = text_GetStringWithIndex(0x1Bu);
        v3 = (char *)(a1 + 11109);
    }
    v9 = strlen(v2) + 1;
    v10 = v2;
