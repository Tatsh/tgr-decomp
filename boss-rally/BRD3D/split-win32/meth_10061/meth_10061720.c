...
void __thiscall meth_10061720(_DWORD *this) {
    ...
    *(_DWORD *)(*(_DWORD *)(this[93] + 24) + 16) = 0;
    ...
    sub_100743A0((int)(this + 119), (int)(this + 89), 0.033333335);
    ...
    *(_DWORD *)(this[93] + 24) = 0;
    ...
    sub_100743A0((int)(this + 175), (int)(this + 89), 0.033333335);
    v4 = (float *)(this + 129);
    v5 = 3;
    do {
        if (*v4 == 0.0) {
