...
void __thiscall meth_10061720(int this) {
    ...
    *(_DWORD *)(this + 628) = 0;
    ...
    sub_10074450((float *)(*(_DWORD *)(this + 360) + 188),
                 (float *)(*(_DWORD *)(this + 360) + 120));
    sub_10074450((float *)(*(_DWORD *)(this + 364) + 188),
                 (float *)(*(_DWORD *)(this + 364) + 120));
    sub_10074450((float *)(*(_DWORD *)(this + 368) + 188),
                 (float *)(*(_DWORD *)(this + 368) + 120));
    sub_10074450((float *)(*(_DWORD *)(this + 372) + 188),
                 (float *)(*(_DWORD *)(this + 372) + 120));
    debugPrint(v13);
}
