...
int __cdecl sub_10014A30(int a1) {
    ...
    if (dword_100AA8B4 > 0) {
            ...
            *(_DWORD *)&gUnk06594.gap1C8[12104] = v8;
            ...
            if (dword_100AA894) {
                if (gGameMode == GAME_MODE_4) {
                    ...
                    sub_100192F0(15);
                    v54 = (char *)text_GetStringWithIndex(0xF2u);
                ...
                v107 = g_Height1 - 24;
                v97 = g_Width1 - 28;
                v53 = (char *)text_GetStringWithIndex(0xF4u);
                goto LABEL_108;
            }
        LABEL_109:
            sub_10032E58();
        ...
        if (*(_BYTE *)(*((_DWORD *)v112 + 931) + 4))
            v53 = (char *)text_GetStringWithIndex(0xF0u);
        else
            v53 = (char *)text_GetStringWithIndex(0xF1u);
    LABEL_108:
...
LABEL_110:
    ...
    if (dword_106909B4 == 2) {
        ...
        sub_100192F0(40);
        v108 = 5 * g_Height1 / 16;
        v58 = (char *)text_GetStringWithIndex(0xF5u);
        text_10019300(v58, v57, v108);
        v59 = 5 * g_Height1 / 11;
        sub_100192F0(20);
        v60 = (char *)text_GetStringWithIndex(0xF6u);
        text_10019300(v60, v57, v59);
        v61 = v59 + 40;
        if (dword_10680734)
            v62 = (char *)text_GetStringWithIndex(0xF8u);
        else
            v62 = (char *)text_GetStringWithIndex(0xF7u);
        text_10019300(v62, v57, v61);
        v63 = v61 + 20;
        if (dword_10680734 == 1)
            v64 = (char *)text_GetStringWithIndex(0xF9u);
        else
            v64 = (char *)text_GetStringWithIndex(0xFAu);
    LABEL_140:
    ...
    if (dword_106909B4) {
        ...
        sub_100192F0(40);
        v109 = 5 * g_Height1 / 16;
        v65 = (char *)text_GetStringWithIndex(0xF5u);
        text_10019300(v65, v57, v109);
        v66 = 5 * g_Height1 / 11;
        sub_100192F0(20);
        if (dword_10680734)
            v67 = (char *)text_GetStringWithIndex(0xFCu);
        else
            v67 = (char *)text_GetStringWithIndex(0xFBu);
        text_10019300(v67, v57, v66);
        v68 = v66 + 20;
        if (!gNetworkPlay) {
            if (dword_10680734 == 1)
                v69 = (char *)text_GetStringWithIndex(0xFFu);
            else
                v69 = (char *)text_GetStringWithIndex(0x100u);
        ...
        v110 = dword_10B4E70C;
        v98 = v71;
        v72 = text_GetStringWithIndex(0x101u);
        ...
        v111 = dword_10B4E708;
        v99 = v74;
        v75 = text_GetStringWithIndex(0x102u);
        sprintf(Buffer, v75, v99, v111);
        text_10019300(Buffer, v57, v73);
        v76 = v73 + 20;
        if (gGameMode) {
            if (dword_10680734 == 4)
                v77 = (char *)text_GetStringWithIndex(0x105u);
            else
                v77 = (char *)text_GetStringWithIndex(0x106u);
        } else if (dword_10680734 == 4) {
            v77 = (char *)text_GetStringWithIndex(0x103u);
        } else {
            v77 = (char *)text_GetStringWithIndex(0x104u);
        }
        text_10019300(v77, v57, v76);
        v63 = v76 + 20;
        if (dword_10680734 == 5)
            v64 = (char *)text_GetStringWithIndex(0x107u);
        else
            v64 = (char *)text_GetStringWithIndex(0x108u);
        goto LABEL_140;
    }
LABEL_141:
