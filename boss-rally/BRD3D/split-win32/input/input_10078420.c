...
char __cdecl input_10078420(int a1) {
            ...
            if ((*(_WORD *)v2 & 0xFF00u) > 0x8400) {
                if ((*(_WORD *)v2 & 0xFF00u) > 0x8600) {
                    if ((*(_WORD *)v2 & 0xFF00u) > 0x8800) {
                        if (v3 == 35072) {
                            if (dword_118ABD38[7 * dword_118ABD80 + 1] <= 50)
                                goto LABEL_49;
                        } else if (v3 == 35328) {
                            if (dword_118ABD38[7 * dword_118ABD80 + 2] >= -50)
                                goto LABEL_49;
                        } else if (v3 != 35584 || dword_118ABD38[7 * dword_118ABD80 + 2] <= 50) {
                            goto LABEL_49;
                        }
                    } else if (v3 == 34816) {
                        if (dword_118ABD38[7 * dword_118ABD80 + 1] >= -50)
    ...
    if (v3 == 768)
        result = *((_BYTE *)&dword_118ABD38[7 * dword_118ABD80 + 6] + *v2) & 0x80;
LABEL_49:
    if (!v2[3])
