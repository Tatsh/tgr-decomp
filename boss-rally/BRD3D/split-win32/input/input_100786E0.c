...
char __cdecl input_100786E0(int a1) {
            ...
            if ((*(_WORD *)v2 & 0xFF00u) > 0x8400) {
                if ((*(_WORD *)v2 & 0xFF00u) > 0x8600) {
                    if ((*(_WORD *)v2 & 0xFF00u) > 0x8800) {
                        if (v3 == 35072) {
                            if (dword_118ABD38[7 * dword_118ABAD4 + 1] > 50 ||
                                dword_118ABD38[7 * dword_118ABD80 + 1] <= 50)
                                goto LABEL_68;
                        } else if (v3 == 35328) {
                            if (dword_118ABD38[7 * dword_118ABAD4 + 2] < -50 ||
                                dword_118ABD38[7 * dword_118ABD80 + 2] >= -50)
                                goto LABEL_68;
                        } else if (v3 != 35584 || dword_118ABD38[7 * dword_118ABAD4 + 2] > 50 ||
                                   dword_118ABD38[7 * dword_118ABD80 + 2] <= 50) {
                            goto LABEL_68;
                        }
                    } else if (v3 == 34816) {
    ...
    if (v3 != 0x8000) {
        if (v3 != 768)
            goto LABEL_68;
        v7 = *v2;
        if ((*((_BYTE *)&dword_118ABD38[7 * dword_118ABAD4 + 6] + v7) & 0x80) == 0) {
            v5 = *((_BYTE *)&dword_118ABD38[7 * dword_118ABD80 + 6] + v7) >= 0;
        LABEL_14:
            if (!v5) {
                result = 1;
                goto LABEL_68;
