...
int __cdecl input_100773F0(int *a1, int *a2) {
    ...
    if (gUnk54Ptr && (v10 = gUnk54Ptr->lpDIDeviceA) != 0) {
        ...
        if (!v11) {
            v12 = &dword_118ABD38[7 * dword_118ABAD4 + 3];
            v13 = 7 * dword_118ABD80;
            dword_118ABD38[v13 + 3] = *v12 + v62;
            dword_118ABD38[v13 + 4] = *v12 + v63;
            v14 = *v12;
            v15 = dword_10ACED40;
            v16 = dword_10ACED40 < 0;
            dword_118ABD38[v13 + 5] = v14 + v64;
            if (v16) {
                v15 = 0;
            } else if (v15 > 7) {
                v15 = 7;
            ...
            dword_118ABD38[v13] = (dword_118ABD38[v13 + 3] << 7) / v17;
            dword_118ABD38[v13 + 1] = (dword_118ABD38[v13 + 4] << 7) / v17;
            dword_118ABD38[v13 + 2] = (dword_118ABD38[v13 + 5] << 7) / v17;
            v18 = dword_118ABD38[v13];
            if (v18 >= -128) {
                if (v18 > 128) {
                    dword_118ABD38[v13] = 128;
                    dword_118ABD38[v13 + 3] = v17;
                }
            } else {
                dword_118ABD38[v13] = -128;
                dword_118ABD38[v13 + 3] = -v17;
            }
            v19 = dword_118ABD38[v13 + 1];
            if (v19 >= -128) {
                if (v19 > 128) {
                    dword_118ABD38[v13 + 1] = 128;
                    dword_118ABD38[v13 + 4] = v17;
                }
            } else {
                dword_118ABD38[v13 + 1] = -128;
                dword_118ABD38[v13 + 4] = -v17;
            }
            v20 = dword_118ABD38[v13 + 2];
            if (v20 >= -128) {
                if (v20 <= 128) {
                LABEL_36:
                    v21 = *(_WORD *)((char *)&v65 + 1);
                    LOBYTE(dword_118ABD38[v13 + 6]) = v65;
                    v22 = HIBYTE(v65);
                    BYTE1(dword_118ABD38[v13 + 6]) = v21;
                    BYTE2(dword_118ABD38[v13 + 6]) = HIBYTE(v21);
                    HIBYTE(dword_118ABD38[v13 + 6]) = v22;
                    goto LABEL_41;
                }
                dword_118ABD38[v13 + 2] = 128;
            } else {
                dword_118ABD38[v13 + 2] = -128;
                v17 = -v17;
            }
            dword_118ABD38[v13 + 5] = v17;
            goto LABEL_36;
        }
        if (v11 == -2147024866)
            gUnk54Ptr->lpDIDeviceA->lpVtbl->Acquire(gUnk54Ptr->lpDIDeviceA);
        dword_118ABD38[7 * dword_118ABD80 + 6] = 0;
    } else {
        ...
        *a1 = 0;
        ...
        if ((gConfigJoystickPtr->field_0 & 0xFF00u) > 0x8700) {
            if ((gConfigJoystickPtr->field_0 & 0xFF00u) > 0x8900) {
                if (v25 == 35328) {
                    v32 = dword_118ABD80;
                    v38 = dword_118ABD38[7 * dword_118ABD80 + 2];
                    if (v38 < 0) {
                        *a1 = 80 * v38 / 128;
                        v26 = dword_118ABAB8;
                    LABEL_157:
                    ...
                    if (v25 != 35584)
                        goto LABEL_158;
                    v32 = dword_118ABD80;
                    v37 = dword_118ABD38[7 * dword_118ABD80 + 2];
                    if (v37 > 0) {
                        v28 = -5 * v37;
                        goto LABEL_154;
                    }
                ...
                v32 = dword_118ABD80;
                v36 = dword_118ABD38[7 * dword_118ABD80 + 1];
                if (v36 > 0) {
                    *a1 = -80 * v36 / 128;
                    v26 = dword_118ABAB8;
                    v32 = dword_118ABD80;
                ...
                if (v25 != 34816)
                    goto LABEL_158;
                v32 = dword_118ABD80;
                v35 = dword_118ABD38[7 * dword_118ABD80 + 1];
                if (v35 < 0) {
                    v28 = 5 * v35;
                    goto LABEL_154;
                }
                ...
                if (v50 > 34048) {
                    if (v50 > 34560) {
                        if (v50 > 35072) {
                            if (v50 != 35328) {
                                if (v50 == 35584) {
                                    v58 = dword_118ABD38[7 * dword_118ABD80 + 2];
                                    if (v58 > 0) {
                                        v53 = 5 * v58;
                                    LABEL_259:
                                        *a2 = 16 * v53 / 128;
                            ...
                            v51 = dword_118ABD38[7 * dword_118ABD80 + 2];
                            if (v51 >= 0)
                                goto LABEL_260;
                        } else {
                            if (v50 == 35072) {
                                v57 = dword_118ABD38[7 * dword_118ABD80 + 1];
                                if (v57 <= 0)
                                    goto LABEL_260;
                                v53 = 5 * v57;
                                goto LABEL_259;
                            ...
                            if (v50 != 34816)
                                goto LABEL_260;
                            v51 = dword_118ABD38[7 * dword_118ABD80 + 1];
                            if (v51 >= 0)
                                goto LABEL_260;
                        }
                    } else {
            ...
            if (v40 > 34048) {
                if (v40 > 34560) {
                    if (v40 > 35072) {
                        ...
                        v41 = dword_118ABD38[7 * v32 + 2];
                        if (v41 >= 0)
                            goto LABEL_203;
                    } else {
                        if (v40 == 35072) {
                            v47 = dword_118ABD38[7 * v32 + 1];
                            if (v47 <= 0)
                                goto LABEL_203;
                            v43 = 5 * v47;
                            goto LABEL_202;
