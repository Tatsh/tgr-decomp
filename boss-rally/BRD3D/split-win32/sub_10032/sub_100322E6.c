...
void __cdecl sub_100322E6(_DWORD *a1, void *a2) {
    ...
    if (*(_DWORD *)&gUnk06594.gap1C8[12444] != (unsigned int)a2) {
        *(_DWORD *)&gUnk06594.gap1C8[12440] = 1;
        *(_DWORD *)&gUnk06594.gap1C8[12444] = a2;
    }
    meth_DebugPrint(a2);
    if (dword_100AA8B4 == 1) {
        *a1 = 0;
    ...
    dword_106C0688 = 64;
    dword_106C0920 = 0;
    v27 = (_DWORD *)(dword_106C0944 + 96000 * *(_DWORD *)&gUnk06594.gap1C8[12452] + 512);
    dword_106C0680 = dword_106C0944 + 96000 * *(_DWORD *)&gUnk06594.gap1C8[12452] + 520;
    *v27 = -1140850682;
    v27[1] = 0;
    ...
    *v10 = -1224736768;
    ...
    dword_106C0680 += 8;
    *v7 = 100663296;
    v7[1] = (char *)&unk_100AA770 + 40 * *(_DWORD *)&gUnk06594.gap1C8[12468];
