    ...
    *v72 = -184549120;
    ...
    LABEL_51:
        if ((*(_BYTE *)(v84 + 77) & 0x20) != 0) {
            ...
            flt_106C0890 =
                flt_106C29B8 * *(float *)(v84 + 52) + flt_106C29C8 * *(float *)(v84 + 56) +
                flt_106C29D8 * *(float *)(v84 + 60) + flt_106C29A8 * *(float *)(v84 + 48);
            flt_106C0894 =
                flt_106C29BC * *(float *)(v84 + 52) + flt_106C29CC * *(float *)(v84 + 56) +
                flt_106C29DC * *(float *)(v84 + 60) + flt_106C29AC * *(float *)(v84 + 48);
            flt_106C0898 =
                flt_106C29C0 * *(float *)(v84 + 52) + flt_106C29D0 * *(float *)(v84 + 56) +
            ...
            if (g_ChosenWeather == 2 || g_ChosenWeather == 3) {
                if (!v132 && (v138 = *(_DWORD *)(v209 - 10360)) != 0 && *(_DWORD *)(v138 + 436) ||
                    v132 == 1 && (v139 = *(_DWORD *)(v209 - 10352)) != 0 &&
                        *(_DWORD *)(v139 + 436) ||
                    v132 == 2 && (v140 = *(_DWORD *)(v209 - 10356)) != 0 &&
                        *(_DWORD *)(v140 + 436) ||
                    v132 == 3 && (v141 = *(_DWORD *)(v209 - 10348)) != 0 &&
                        *(_DWORD *)(v141 + 436)) {
                    v137 = 1;
                    goto LABEL_169;
                }
            } else if (!v132 && (v133 = *(_DWORD *)(v209 - 10360)) != 0 &&
                           *(_BYTE *)(v133 + 416) == 3 && *(_DWORD *)(v133 + 436) ||
        ...
        LABEL_169:
            if (v137) {
                ...
                if (v150 != v151) {
                    ...
                    if (v152 != v151 &&
                        (dword_10277EC0[3500 * v148 + 7 * v152] & 0x8000000) == 0x8000000) {
                        v153 = v222 - 1;
                        if (v222 - 1 < 0)
                            v153 = 499;
