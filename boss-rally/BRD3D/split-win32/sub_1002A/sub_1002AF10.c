...
void __cdecl sub_1002AF10(int a1, float a2) {
    ...
    if (a2 >= 0.1) {
        ...
        *v6 = -1174403582;
        ...
        dword_106C0680 += 8;
        *v7 = ((*(_DWORD *)(a1 + 88 * *(_DWORD *)&gUnk06594.gap1C8[8640]) +
                *(_DWORD *)(a1 + 88 * *(_DWORD *)&gUnk06594.gap1C8[8640] + 8))
               << 12) &
                  0xFFF000 |
              ((unsigned __int16)*(_DWORD *)(a1 + 88 * *(_DWORD *)&gUnk06594.gap1C8[8640] + 4) +
               (unsigned __int16)*(_DWORD *)(a1 + 88 * *(_DWORD *)&gUnk06594.gap1C8[8640] + 12)) &
                  0xFFF |
              0xE1000000;
        v7[1] = ((*(_DWORD *)(a1 + 88 * *(_DWORD *)&gUnk06594.gap1C8[8640]) & 0xFFF) << 12) |
                *(_DWORD *)(a1 + 88 * *(_DWORD *)&gUnk06594.gap1C8[8640] + 4) & 0xFFF;
