...
int __cdecl sub_10051990(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v9 + 56))(
        v9, a1, 1095761920, 1088421888, 9, 2, 5, 0, 79);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v11 + 56))(
        v11, a1, 1098907648, 1125711872, 9, 2, 5, 1, 71);
    v11[1] = sub_1003F440;
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v13 + 56))(
        v13, a1, 1136918528, 1127546880, 9, 2, 5, 1, 72);
    v13[1] = sub_1003F540;
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, _DWORD, int))(*v15 + 56))(
        v15, a1, v3[206], 1139146752, 1056769, 2, 5, 0, -1);
    v15[3] = sub_10047360;
    v15[2] = sub_10047120;
    v15[1] = sub_100471F0;
    *((_WORD *)v15 + 61702) = 2;
    v17 = getCaptionString(0x42u);
    (*(void(__thiscall **)(_DWORD *, LPCSTR, int, _DWORD, void *))(v16 + 52))(
        v15, v17, 1, 0, &unk_100AB438);
    ++*((_WORD *)v3 + 10);
    ++*((_WORD *)v3 + 418);
    return 1;
}
