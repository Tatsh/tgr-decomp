...
int __cdecl sub_1000E950(float a1) {
    ...
    result = *(_DWORD *)&gUnk06594.gap1C8[12500];
            ...
            if (LODWORD(a1) != dword_106C2CF8 ||
                ...
                if (*(_BYTE *)(LODWORD(a1) + 10671) != 2) {
                    ...
                    *v20 = -1174403582;
                    ...
                    if (LODWORD(a1) != dword_106C2CF8) {
                        sub_1003AF40(
                            (float *)v37, (float *)(LODWORD(a1) + 48), (float *)LODWORD(a1));
                        sub_1003AEE0((float *)v37,
                        ...
                        if (v21 != 0.0) {
                            ...
                            if (sub_1003AC90((float *)v37, *(float **)&gUnk06594.gap1C8[12104]) >
                                ...
                                v23 = sub_1003AC90((float *)v37,
                                                   *(float **)&gUnk06594.gap1C8[12104]) *
                                      v36;
                                if (v23 > 0.94999999)
                                    flt_105754F8 =
                                        (v23 - 0.94999999) * 750.0 / (v39 * v39) + flt_105754F8;
                            }
                        }
                    }
