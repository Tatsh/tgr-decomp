...
int graphics_10074DD0() {
    ...
    sub_100739B0();
    graphics_100739E0();
    dword_11829100[0] = gGraphics_118AA0B0(&unk_104B3DE8, 0, 64, 64, 1, 4, 0, 0, 1, 1, 0, 0, 1, 0);
    dword_11829104 = gGraphics_118AA0B0(&unk_104B7DE8, 0, 64, 64, 1, 4, 0, 0, 1, 1, 0, 0, 1, 0);
    v0 = 0;
    v1 = &unk_11829331;
    do {
        *(v1 - 1) = -1;
