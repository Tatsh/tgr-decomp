...
LABEL_12:
    ...
    if (v17 || v39 || v37 || gD3DAlwaysSquareTextures ||
        (gHWCaps.dpcTriCaps.dwTextureCaps & 0x20) != 0 ||
        (gHELCaps.dpcTriCaps.dwTextureCaps & 0x20) != 0 ||
        gHWCaps.dwMaxTextureWidth && a2 > gHWCaps.dwMaxTextureWidth ||
        gHWCaps.dwMaxTextureHeight && a3[0] > gHWCaps.dwMaxTextureHeight || a2 > dword_100A7DF4 ||
        a3[0] > dword_100A7DF8) {
        v22 = a2;
        v23 = a3[0];
        v38 = a2;
    ...
    LABEL_62:
        ...
        if (gHWCaps.dwMaxTextureHeight && v23 > gHWCaps.dwMaxTextureHeight) {
            v37 = gHWCaps.dwMaxTextureHeight;
            math_pow2ExponentToAdd(&outExponent, v22, gHWCaps.dwMaxTextureHeight);
            sub_10028200(&v46, v38, v37);
            v23 = v37;
            v44 = dword_10575430 + outExponent - dword_1057544C;
            v22 = v38;
        ...
        if ((gD3DAlwaysSquareTextures || (gHWCaps.dpcTriCaps.dwTextureCaps & 0x20) != 0 ||
             (gHELCaps.dpcTriCaps.dwTextureCaps & 0x20) != 0) &&
            v22 != v23) {
            if (v22 < v23) {
                v22 = dword_100A7DF8;
