...
//----- (10027C60) --------------------------------------------------------
int __cdecl graphics_10027C60(unsigned __int8 *a1,
                              int a2,
                              int a3,
                              int a4,
                              int a5,
    ...
    v20 = v29;
    dword_100A7DF8 = v19;
    if (a8 || a9 || gD3DAlwaysSquareTextures ||
        (gHWCaps.dpcTriCaps.dwTextureCaps & D3DPTEXTURECAPS_SQUAREONLY) != 0 ||
        (gHELCaps.dpcTriCaps.dwTextureCaps & D3DPTEXTURECAPS_SQUAREONLY) != 0 ||
        gHWCaps.dwMaxTextureWidth && v28 > gHWCaps.dwMaxTextureWidth ||
        gHWCaps.dwMaxTextureHeight && v29 > gHWCaps.dwMaxTextureHeight ||
        ...
        if (gHWCaps.dwMaxTextureWidth && v21 > gHWCaps.dwMaxTextureWidth) {
            v21 = gHWCaps.dwMaxTextureWidth;
            math_pow2ExponentToAdd(&v33, gHWCaps.dwMaxTextureWidth, v20);
            sub_10028200(v34, v21, v20);
            v32 = dword_10575430 + v33;
        }
        if (gHWCaps.dwMaxTextureHeight && v20 > gHWCaps.dwMaxTextureHeight) {
            v20 = gHWCaps.dwMaxTextureHeight;
            math_pow2ExponentToAdd(&v33, v21, gHWCaps.dwMaxTextureHeight);
            sub_10028200(v34, v21, v20);
            v32 = dword_10575430 + v33;
        }
        if (a14) {
