...
int graphics_1001BAD0() {
    ...
    v0 = gUnk8C;
    if (gD3DWaitCanFlip &&
        (*(int(__stdcall **)(_DWORD, int))(*(_DWORD *)LODWORD(gUnk8C->field_8.emissive.b) +
                                           72))( // GetFlipStatus
    ...
    if (gD3DWaitFlipDone) {
        for (result = (*(int(__stdcall **)(_DWORD, int))(
                 *(_DWORD *)LODWORD(v0->field_8.emissive.b) + 72))( // GetFlipStatus
                 LODWORD(v0->field_8.emissive.b),
                 2);
             result;
             result =
                 (*(int(__stdcall **)(_DWORD, int))(*(_DWORD *)LODWORD(v0->field_8.emissive.b) +
