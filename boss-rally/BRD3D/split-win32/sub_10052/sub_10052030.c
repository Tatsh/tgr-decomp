...
int __cdecl sub_10052030(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v4;
    ...
    if (!v6)
        sub_1003E260(4);
    v6->lpVtbl->field_38(v6, (unk000C8 *)a1, 0, 0, 9, 2, 5, 0, 0);
    ++LOWORD(v4->field_14);
    ...
    if (!v8)
        sub_1003E260(4);
    v9 = v8->lpVtbl;
    v8->lpVtbl->field_38(v8, (unk000C8 *)a1, v4->mask_338, 1092616192, 1048585, 2, 5, 1, -1);
  LOWORD(v8->?) = 3;
  ...
  v12->lpVtbl->field_38(v12, (unk000C8 *)a1, v4->mask_338, LODWORD(v84), 1056769, 2, 5, 1, -1);
  ...
  v16->lpVtbl->field_38(v16, (unk000C8 *)a1, v4->mask_338, LODWORD(v85), 1056769, 2, 5, 1, -1);
  ...
  v20->lpVtbl->field_38(v20, (unk000C8 *)a1, v4->mask_338, LODWORD(v86), 1056769, 2, 5, 1, -1);
  ...
  if (!v24)
      sub_1003E260(4);
  ((void(__thiscall *)(
      unk1E214 *, int, float, float, int, int, int, int, int))v24->lpVtbl->field_38)(
  ...
  *(_WORD *)&v24->gap5C[10726] = 121;
  ...
  if (!v27)
      sub_1003E260(4);
  ((void(__thiscall *)(
      unk1E214 *, int, float, float, int, int, int, int, int))v27->lpVtbl->field_38)(
  ...
  *(_WORD *)&v27->gap5C[10726] = 83;
  ...
  if (!v30)
      sub_1003E260(4);
  ((void(__thiscall *)(
      unk1E214 *, int, float, float, int, int, int, int, int))v30->lpVtbl->field_38)(
  ...
  *(_WORD *)&v30->gap5C[10726] = 85;
  ...
  if (!v33)
      sub_1003E260(4);
  v33->lpVtbl->field_38(v33, (unk000C8 *)a1, 1116864512, 1129578496, 1, 2, 5, 1, 22);
  ...
  *(_WORD *)&v33->gap5C[10842] = v34;
  ...
  if (!v36)
      sub_1003E260(4);
  v37 = v36->lpVtbl;
  v36->lpVtbl->field_38(v36, (unk000C8 *)a1, v4->mask_338, 1133084672, 1052673, 2, 5, 1, -1);
  ...
  if (!v39)
      sub_1003E260(4);
  v39->lpVtbl->field_38(v39, (unk000C8 *)a1, 1134723072, 1116733440, 1, 2, 5, 1, 17);
  ...
  *(_WORD *)&v39->gap5C[10842] = v40;
  ...
  if (!v42)
      sub_1003E260(4);
  v43 = v42->lpVtbl;
  v42->lpVtbl->field_38(v42, (unk000C8 *)a1, v4->mask_338, 1125646336, 1052673, 2, 5, 1, -1);
  ...
  if (!v45)
      sub_1003E260(4);
  v46 = v45->lpVtbl;
  v45->lpVtbl->field_38(v45, (unk000C8 *)a1, 1138819072, 1123680256, 1048585, 2, 5, 1, -1);
  LOWORD(v45->?) = 3;
  ...
  if (!v49)
      sub_1003E260(4);
  v50 = v49->lpVtbl;
  v49->lpVtbl->field_38(v49, (unk000C8 *)a1, 1138819072, 1127809024, 1048585, 2, 5, 1, -1);
  LOWORD(v49->?) = 3;
  ...
  if (!v53)
      sub_1003E260(4);
  v54 = v53->lpVtbl;
  v53->lpVtbl->field_38(v53, (unk000C8 *)a1, 1138819072, 1124925440, 20481, 2, 5, 1, -1);
  ...
  if (!v56)
      sub_1003E260(4);
  v57 = v56->lpVtbl;
  v56->lpVtbl->field_38(v56, (unk000C8 *)a1, v4->mask_338, 1128988672, 1048585, 2, 5, 1, -1);
  LOWORD(v56->?) = 3;
  ...
  if (!v60)
      sub_1003E260(4);
  v61 = v60->lpVtbl;
  v60->lpVtbl->field_38(v60, (unk000C8 *)a1, v4->mask_338, 1132756992, 1048585, 2, 5, 1, -1);
  LOWORD(v60->?) = 3;
  ...
  if (!v64)
      sub_1003E260(4);
  v65 = v64->lpVtbl;
  v64->lpVtbl->field_38(v64, (unk000C8 *)a1, 1138819072, 1129906176, 20481, 2, 5, 1, -1);
  ...
  if (!v67)
      sub_1003E260(4);
  v68 = v67->lpVtbl;
  v67->lpVtbl->field_38(v67, (unk000C8 *)a1, 1121189888, 1118437376, 1048577, 2, 5, 1, -1);
  LOWORD(v67->?) = 3;
  ...
  if (!v71)
      sub_1003E260(4);
  v72 = v71->lpVtbl;
  v71->lpVtbl->field_38(v71, (unk000C8 *)a1, 1138491392, 1115947008, 20481, 2, 5, 1, -1);
  ...
  if (!v74)
      sub_1003E260(4);
  v75 = v74->lpVtbl;
  v74->lpVtbl->field_38(v74, (unk000C8 *)a1, 1121189888, 1123418112, 1048577, 2, 5, 1, -1);
  LOWORD(v74->?) = 3;
  ...
  if (!v78)
      sub_1003E260(4);
  v79 = v78->lpVtbl;
  v78->lpVtbl->field_38(v78, (unk000C8 *)a1, 1138491392, 1120927744, 20481, 2, 5, 1, -1);
  ...
  v81->lpVtbl->field_38(v81, (unk000C8 *)a1, v4->mask_338, LODWORD(v87), 20481, 2, 5, 1, -1);
