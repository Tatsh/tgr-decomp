...
int __cdecl sub_10052030(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v4;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v12 + 56))(
        v12, a1, v4[206], LODWORD(v84), 1056769, 2, 5, 1, -1);
    v12[3] = sub_10047360;
    v12[2] = sub_10047340;
    *((_WORD *)v12 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v16 + 56))(
        v16, a1, v4[206], LODWORD(v85), 1056769, 2, 5, 1, -1);
    v16[3] = sub_10047360;
    v16[2] = sub_10045050;
    *((_WORD *)v16 + 61702) = 2;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v20 + 56))(
        v20, a1, v4[206], LODWORD(v86), 1056769, 2, 5, 1, -1);
    v20[3] = sub_10047360;
    v20[2] = sub_10047060;
    *((_WORD *)v20 + 61702) = 3;
    ...
    *((_WORD *)v33 + 5467) = v34;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v36 + 56))(
        v36, a1, v4[206], 1133084672, 1052673, 2, 5, 1, -1);
    v36[1] = sub_1003FE80;
    *((_WORD *)v36 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v37 + 52))(
        v36, asc_100AD300, 1, 1, &unk_100AB4B8);
    ++*((_WORD *)v4 + 10);
    ...
    *((_WORD *)v39 + 5467) = v40;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v42 + 56))(
        v42, a1, v4[206], 1125646336, 1052673, 2, 5, 1, -1);
    v42[1] = sub_1003FA00;
    *((_WORD *)v42 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v43 + 52))(
        v42, asc_100AD300, 1, 1, &unk_100AB4A8);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v49 + 56))(
        v49, a1, 1138819072, 1127809024, 1048585, 2, 5, 1, -1);
    v49[61702] = 3;
    v51 = getCaptionString(0x46u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v50 + 52))(
        v49, v51, 1, 1, &unk_100AB4F8);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v53 + 56))(
        v53, a1, 1138819072, 1124925440, 20481, 2, 5, 1, -1);
    v53[1] = sub_100415A0;
    *((_WORD *)v53 + 61702) = 5;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v54 + 52))(
        v53, String2, 1, 3, &unk_100AB4F8);
    ++*((_WORD *)v4 + 10);
    ...
    v57 = *(_DWORD *)v56;
    (*(void(__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(
        *(_DWORD *)v56 + 56))(v56, a1, v4[206], 1128988672, 1048585, 2, 5, 1, -1);
    v56[61702] = 3;
    v58 = getCaptionString(0x40u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v57 + 52))(
        v56, v58, 1, 1, &unk_100AB478);
    ++*((_WORD *)v4 + 10);
    ...
    v61 = *(_DWORD *)v60;
    (*(void(__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(
        *(_DWORD *)v60 + 56))(v60, a1, v4[206], 1132756992, 1048585, 2, 5, 1, -1);
    v60[61702] = 3;
    v62 = getCaptionString(0x41u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v61 + 52))(
        v60, v62, 1, 1, &unk_100AB478);
    ++*((_WORD *)v4 + 10);
    v63 = (_DWORD *)malloc(0x1E214u);
    if (v63)
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v64 + 56))(
        v64, a1, 1138819072, 1129906176, 20481, 2, 5, 1, -1);
    v64[1] = sub_100414B0;
    *((_WORD *)v64 + 61702) = 5;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v65 + 52))(
        v64, String2, 1, 3, &unk_100AB478);
    ++*((_WORD *)v4 + 10);
    v66 = (_DWORD *)malloc(0x1E214u);
    if (v66)
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v71 + 56))(
        v71, a1, 1138491392, 1115947008, 20481, 2, 5, 1, -1);
    v71[1] = sub_10041300;
    *((_WORD *)v71 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v72 + 52))(
        v71, String2, 1, 4, &unk_100AB458);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v74 + 56))(
        v74, a1, 1121189888, 1123418112, 1048577, 2, 5, 1, -1);
    v74[61702] = 3;
    v76 = getCaptionString(0x36u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v75 + 52))(
        v74, v76, 1, 1, &unk_100AB458);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v78 + 56))(
        v78, a1, 1138491392, 1120927744, 20481, 2, 5, 1, -1);
    v78[1] = sub_100413B0;
    *((_WORD *)v78 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v79 + 52))(
        v78, String2, 1, 4, &unk_100AB458);
    ++*((_WORD *)v4 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v81 + 56))(
        v81, a1, v4[206], LODWORD(v87), 20481, 2, 5, 1, -1);
    v81[1] = sub_10040B30;
    *((_WORD *)v81 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, int *))(v82 + 52))(
        v81, String2, 1, 4, &dword_100AB448);
    ++*((_WORD *)v4 + 10);
    return 1;
}
