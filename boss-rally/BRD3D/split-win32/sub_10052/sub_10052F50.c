...
int __cdecl sub_10052F50(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v11 + 56))(
        v11, a1, v3[206], v3[207], 1056769, 2, 5, 1, -1);
    v11[3] = sub_10047360;
    v11[2] = sub_100412C0;
    *((_WORD *)v11 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v3[206], LODWORD(v73), 1056769, 2, 5, 1, -1);
    v15[3] = sub_10047360;
    v15[2] = sub_100412D0;
    *((_WORD *)v15 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v19 + 56))(
        v19, a1, v3[206], LODWORD(v74), 1056769, 2, 5, 1, -1);
    v19[3] = sub_10047360;
    v19[2] = sub_100412E0;
    *((_WORD *)v19 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v23 + 56))(
        v23, a1, v3[206], LODWORD(v75), 1056769, 2, 5, 1, -1);
    v23[3] = sub_10047360;
    v23[2] = sub_100412F0;
    *((_WORD *)v23 + 61702) = 3;
    v25 = getCaptionString(0x4Bu);
    (*(void(__thiscall **)(_DWORD *, LPCSTR, int, int, int *))(v24 + 52))(
        v23, v25, 1, 1, &dword_100AB448);
    ++*((_WORD *)v3 + 10);
    ++*((_WORD *)v3 + 418);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v27 + 56))(
        v27, a1, v3[206], LODWORD(v76), 1056769, 2, 5, 1, -1);
    v27[3] = sub_10047360;
    v27[2] = sub_10045F70;
    *((_WORD *)v27 + 61702) = 3;
    ...
    *((_WORD *)v37 + 5409) = 85;
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v40 + 56))(
        v40, a1, 1121189888, 1123418112, 1048577, 2, 5, 1, -1);
    v40[61702] = 3;
    v42 = getCaptionString(0x4Cu);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v41 + 52))(
        v40, v42, 1, 1, &unk_100AB458);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v44 + 56))(
        v44, a1, 1138491392, 1117650944, 20481, 2, 5, 1, -1);
    v44[1] = sub_1003E8D0;
    *((_WORD *)v44 + 61702) = 5;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v45 + 52))(
        v44, String2, 1, 3, &unk_100AB458);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v47 + 56))(
        v47, a1, 1116864512, 1129578496, 1, 2, 5, 1, 22);
    v47[1] = sub_100407E0;
    v48 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v47 + 5466);
    *((_WORD *)v47 + 5467) = v48;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v50 + 56))(
        v50, a1, v3[206], 1133084672, 1052673, 2, 5, 1, -1);
    v50[1] = sub_1003FE80;
    *((_WORD *)v50 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v51 + 52))(
        v50, asc_100AD300, 1, 1, &unk_100AB4B8);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v53 + 56))(
        v53, a1, 1134723072, 1116733440, 1, 2, 5, 1, 17);
    v53[1] = sub_10040730;
    v54 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v53 + 5466);
    *((_WORD *)v53 + 5467) = v54;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v56 + 56))(
        v56, a1, v3[206], 1125646336, 1052673, 2, 5, 1, -1);
    v56[1] = sub_1003FA00;
    *((_WORD *)v56 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v57 + 52))(
        v56, asc_100AD300, 1, 1, &unk_100AB4A8);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_WORD *, int, int, int, int, int, int, int, int))(*(_DWORD *)v59 + 56))(
        v59, a1, 1138819072, 1127809024, 1048585, 2, 5, 1, -1);
    v59[61702] = 3;
    v61 = getCaptionString(0x4Du);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v60 + 52))(
        v59, v61, 1, 1, &unk_100AB4F8);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v63 + 56))(
        v63, a1, 1138819072, 1126563840, 20481, 2, 5, 1, -1);
    v63[1] = sub_10040EE0;
    *((_WORD *)v63 + 61702) = 52;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v64 + 52))(
        v63, String2, 1, 4, &unk_100AB4F8);
    ++*((_WORD *)v3 + 10);
    ...
    v67 = *(_DWORD *)v66;
    (*(void(__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(
        *(_DWORD *)v66 + 56))(v66, a1, v3[206], 1132527616, 1048585, 2, 5, 1, -1);
    v66[61702] = 3;
    v68 = getCaptionString(0x40u);
    (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v67 + 52))(
        v66, v68, 1, 1, &unk_100AB478);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v70 + 56))(
        v70, a1, 1138819072, 1129512960, 20481, 2, 5, 1, -1);
    v70[1] = sub_1003EA90;
    *((_WORD *)v70 + 61702) = 5;
    (*(void(__thiscall **)(_DWORD *, CHAR *, int, int, void *))(v71 + 52))(
        v70, String2, 1, 3, &unk_100AB478);
    ++*((_WORD *)v3 + 10);
    return 1;
}
