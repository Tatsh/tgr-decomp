...
int __cdecl sub_10052F50(int a1) {
    ...
    *(_DWORD *)&v3->gap4[4] = sub_10040A20;
    ...
    v11->field_0->field_38(
        v11, (unkC8 *)a1, v3->field_338, LODWORD(v3->field_33C), 1056769, 2, 5, 1, -1);
    ...
    v15->field_0->field_38(v15, (unkC8 *)a1, v3->field_338, LODWORD(v73), 1056769, 2, 5, 1, -1);
    ...
    v19->field_0->field_38(v19, (unkC8 *)a1, v3->field_338, LODWORD(v74), 1056769, 2, 5, 1, -1);
    ...
    v23->field_0->field_38(v23, (unkC8 *)a1, v3->field_338, LODWORD(v75), 1056769, 2, 5, 1, -1);
    ...
    v27->field_0->field_38(v27, (unkC8 *)a1, v3->field_338, LODWORD(v76), 1056769, 2, 5, 1, -1);
    ...
    if (!v31)
        sub_1003E260(4);
    ((void(__thiscall *)(
        unk1E214 *, int, float, float, int, int, int, int, int))v31->field_0->field_38)(
    ...
    *(_WORD *)&v31->gap5C[10726] = 121;
    ...
    if (!v34)
        sub_1003E260(4);
    ((void(__thiscall *)(
        unk1E214 *, int, float, float, int, int, int, int, int))v34->field_0->field_38)(
    ...
    *(_WORD *)&v34->gap5C[10726] = 83;
    ...
    if (!v37)
        sub_1003E260(4);
    ((void(__thiscall *)(
        unk1E214 *, int, float, float, int, int, int, int, int))v37->field_0->field_38)(
    ...
    *(_WORD *)&v37->gap5C[10726] = 85;
    ...
    if (!v40)
        sub_1003E260(4);
    v41 = v40->field_0;
    v40->field_0->field_38(v40, (unkC8 *)a1, 1121189888, 1123418112, 1048577, 2, 5, 1, -1);
    LOWORD(v40->field_1E20C) = 3;
    ...
    if (!v44)
        sub_1003E260(4);
    v45 = v44->field_0;
    v44->field_0->field_38(v44, (unkC8 *)a1, 1138491392, 1117650944, 20481, 2, 5, 1, -1);
    v44->field_4 = sub_1003E8D0;
    LOWORD(v44->field_1E20C) = 5;
    ...
    if (!v47)
        sub_1003E260(4);
    v47->field_0->field_38(v47, (unkC8 *)a1, 1116864512, 1129578496, 1, 2, 5, 1, 22);
    ...
    *(_WORD *)&v47->gap5C[10842] = v48;
    ...
    if (!v50)
        sub_1003E260(4);
    v51 = v50->field_0;
    v50->field_0->field_38(v50, (unkC8 *)a1, v3->field_338, 1133084672, 1052673, 2, 5, 1, -1);
    v50->field_4 = sub_1003FE80;
    LOWORD(v50->field_1E20C) = 3;
    ...
    if (!v53)
        sub_1003E260(4);
    v53->field_0->field_38(v53, (unkC8 *)a1, 1134723072, 1116733440, 1, 2, 5, 1, 17);
    ...
    *(_WORD *)&v53->gap5C[10842] = v54;
    ...
    if (!v56)
        sub_1003E260(4);
    v57 = v56->field_0;
    v56->field_0->field_38(v56, (unkC8 *)a1, v3->field_338, 1125646336, 1052673, 2, 5, 1, -1);
    ...
    if (!v59)
        sub_1003E260(4);
    v60 = v59->field_0;
    v59->field_0->field_38(v59, (unkC8 *)a1, 1138819072, 1127809024, 1048585, 2, 5, 1, -1);
    LOWORD(v59->field_1E20C) = 3;
    ...
    if (!v63)
        sub_1003E260(4);
    v64 = v63->field_0;
    v63->field_0->field_38(v63, (unkC8 *)a1, 1138819072, 1126563840, 20481, 2, 5, 1, -1);
    v63->field_4 = sub_10040EE0;
    LOWORD(v63->field_1E20C) = 52;
    ...
    if (!v66)
        sub_1003E260(4);
    v67 = v66->field_0;
    v66->field_0->field_38(v66, (unkC8 *)a1, v3->field_338, 1132527616, 1048585, 2, 5, 1, -1);
    ...
    if (!v70)
        sub_1003E260(4);
    v71 = v70->field_0;
    v70->field_0->field_38(v70, (unkC8 *)a1, 1138819072, 1129512960, 20481, 2, 5, 1, -1);
    v70->field_4 = sub_1003EA90;
    LOWORD(v70->field_1E20C) = 5;
