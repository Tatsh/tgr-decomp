...
//----- (1004C4A0) --------------------------------------------------------
int __cdecl sub_1004C4A0(unkC8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    v15->field_0->field_38(v15, a1, v3->field_338, LODWORD(v35), 1056769, 2, 5, 1, -1);
    ...
    v19->field_0->field_38(v19, a1, v3->field_338, LODWORD(v36), 1056769, 2, 5, 1, -1);
    ...
    v23->field_0->field_38(v23, a1, v3->field_338, LODWORD(v37), 1056769, 2, 5, 1, -1);
    ...
    if (!v27)
        sub_1003E260(4);
    v27->field_0->field_38(v27, a1, 1117782016, 1110966272, 9, 2, 5, 0, 9);
    ++LOWORD(v3->field_14);
    ...
    if (!v29)
        sub_1003E260(4);
    v29->field_0->field_38(v29, a1, 1134690304, 1110966272, 1, 2, 5, 1, 22);
    ...
    *(_WORD *)&v29->gap5C[10842] = v30;
    ...
    if (!v32)
        sub_1003E260(4);
    v33 = v32->field_0;
    v32->field_0->field_38(v32, a1, v3->field_338, 1125842944, 1052673, 2, 5, 1, -1);
