...
int __cdecl sub_1004C4A0(int a1) {
    ...
    *((_WORD *)v11 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v3[206], LODWORD(v35), 1056769, 2, 5, 1, -1);
    v15[3] = sub_10047360;
    v15[2] = sub_100434C0;
    *((_WORD *)v15 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v19 + 56))(
        v19, a1, v3[206], LODWORD(v36), 1056769, 2, 5, 1, -1);
    v19[3] = sub_10047360;
    v19[2] = sub_100406C0;
    *((_WORD *)v19 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v23 + 56))(
        v23, a1, v3[206], LODWORD(v37), 1056769, 2, 5, 1, -1);
    v23[3] = sub_10047360;
    v23[2] = sub_100465A0;
    *((_WORD *)v23 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v27 + 56))(
        v27, a1, 1117782016, 1110966272, 9, 2, 5, 0, 9);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v29 + 56))(
        v29, a1, 1134690304, 1110966272, 1, 2, 5, 1, 22);
    v29[1] = sub_10041870;
    v30 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v29 + 5466);
    *((_WORD *)v29 + 5467) = v30;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v32 + 56))(
        v32, a1, v3[206], 1125842944, 1052673, 2, 5, 1, -1);
    v32[1] = sub_1003FFD0;
    *((_WORD *)v32 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v33 + 52))(
        v32, asc_100AD300, 1, 1, &unk_100AB4C8);
    ++*((_WORD *)v3 + 10);
    return 1;
}
