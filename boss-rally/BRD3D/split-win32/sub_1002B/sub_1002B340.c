...
void sub_1002B340()
{
  ...
  if ( *(float *)&dword_10575518 != 1.0 )
  {
    ...
    *v2 = -1191181539;
    ...
    dword_106C0680 += 8;
    *v3 = -503316480;
    v3[1] = (((__int64)(double)(g_Width1 << dword_106C65E4) & 0xFFF) << 12) | (__int64)(double)(g_Height1 << dword_106C65E4) & 0xFFF;
    ...
    *v4 = -100597761;
    ...
    if ( dword_10575500 >= g_Width1 )
    {
      if ( *(float *)&dword_10575518 == 0.0 && dword_100A81BC )
      {
        ...
        dword_106C0680 += 8;
        --dword_100A81BC;
        *v13 = ((unsigned __int16)(g_Height1 << dword_106C65E4) - 1) & 0xFFF | (((g_Width1 << dword_106C65E4) + 0xFFFFF) << 12) & 0xFFF000 | 0xE1000000;
        v13[1] = 0;
      }
    }
    else if ( dword_100A81BC )
    {
      ...
      dword_106C0680 += 8;
      --dword_100A81BC;
      *v12 = ((unsigned __int16)(g_Height1 << dword_106C65E4) - 1) & 0xFFF | (((g_Width1 << dword_106C65E4) + 0xFFFFF) << 12) & 0xFFF000 | 0xE1000000;
