                    ...
                    if (v3) {
                        ...
                        *(_DWORD *)(v3 + 4092) =
                            gGameMode == GAME_MODE_6 ?
                                String2 :
                                text_GetStringWithIndex(dword_100B3960[dword_118AB470]);
                        *(_DWORD *)(v3 + 4096) = 1084227584;
                        if (this[25] < dword_100B4050 && dword_100BD3E0 == 3 &&
                            ...
                            *(_DWORD *)(v3 + 4100) = text_GetStringWithIndex(0x121u);
                    ...
                    if (dword_100B4050 > 0) {
                        ...
                        do {
                            ...
                            if (*(_DWORD *)(*v46 + 4092) == *v46 + 4108) {
                                ...
                                *(_DWORD *)(v29 + 4092) = text_GetStringWithIndex(0x122u);
                            ...
                            *(float *)(v29 + 4080) =
                            ...
                            if (*(float *)(v29 + 4076) != 0.0 && dword_100B36FC > 1) {
                                ...
                                if (*(_DWORD *)(v29 + 4088)) {
                                    if (v48 > 120.0)
                                        *(_DWORD *)(v29 + 4100) = text_GetStringWithIndex(0x123u);
                                    v43 = text_GetStringWithIndex(0x124u);
                    ...
                    *(_DWORD *)(this[24] + 4072) = v13;
                    ...
                    if (*((float *)dword_10ACED34 + gChosenTrack + 44) == 0.0 ||
                        ...
                        *((_DWORD *)dword_10ACED34 + gChosenTrack + 44) = this[13];
                        v15 = text_GetStringWithIndex(0x109u);
                        goto LABEL_28;
                    }
                    if (this[16]) {
                        v15 = text_GetStringWithIndex(0x10Au);
                    LABEL_28:
                        v7 = (int)v15;
                        v47 = v15;
                        goto LABEL_29;
            ...
            *((float *)this + 12) = v16;
            if (gGameMode == GAME_MODE_3) {
                ...
                if (v21 == dword_100BD3E0 - 1) {
                    strcpy((char *)(v3 + 4108), text_GetStringWithIndex(0x10Bu));
                    v7 = (int)v47;
                } else {
                    v42 = v21 + 1;
                    v22 = text_GetStringWithIndex(0x10Cu);
                ...
                *(_DWORD *)(this[24] + 4072) = v31;
                ...
                if (*((float *)dword_10ACED34 + gChosenTrack + 44) == 0.0 ||
                    ...
                    *((float *)dword_10ACED34 + gChosenTrack + 44) = v45;
                    v34 = text_GetStringWithIndex(0x109u);
                    goto LABEL_101;
                }
                if (this[16]) {
                    v34 = text_GetStringWithIndex(0x10Au);
                LABEL_101:
                    v7 = (int)v34;
                    goto LABEL_102;
                }
    ...
    LABEL_102:
        ...
        *((float *)this + 12) = v35;
        if (v3) {
            meth_DebugPrint(v31);
            v44 = this[16] + 1;
            v36 = text_GetStringWithIndex(0x10Cu);
