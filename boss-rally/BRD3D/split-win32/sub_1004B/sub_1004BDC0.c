...
int __cdecl sub_1004BDC0(int a1) {
    ...
    *((_WORD *)v11 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v3[206], LODWORD(v39), 1056769, 2, 5, 1, -1);
    v15[3] = sub_10047360;
    v15[2] = sub_10045390;
    *((_WORD *)v15 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v19 + 56))(
        v19, a1, v3[206], LODWORD(v40), 1056769, 2, 5, 1, -1);
    v19[3] = sub_10047360;
    v19[2] = sub_100455E0;
    *((_WORD *)v19 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v23 + 56))(
        v23, a1, v3[206], LODWORD(v41), 1056769, 2, 5, 1, -1);
    v23[3] = sub_10047360;
    v23[2] = sub_100456B0;
    *((_WORD *)v23 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v27 + 56))(
        v27, a1, v3[206], LODWORD(v42), 1056769, 2, 5, 1, -1);
    v27[3] = sub_10047360;
    v27[2] = sub_10046520;
    *((_WORD *)v27 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v33 + 56))(
        v33, a1, 1134690304, 1110966272, 1, 2, 5, 1, 22);
    v33[1] = sub_10041870;
    v34 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v33 + 5466);
    *((_WORD *)v33 + 5467) = v34;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v36 + 56))(
        v36, a1, v3[206], 1125842944, 1052673, 2, 5, 1, -1);
    v36[1] = sub_1003FFD0;
    *((_WORD *)v36 + 61702) = 3;
