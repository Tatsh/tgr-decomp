...
//----- (1004BDC0) --------------------------------------------------------
int __cdecl sub_1004BDC0(unkC8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    v15->field_0->field_38(v15, a1, v3->field_338, LODWORD(v39), 1056769, 2, 5, 1, -1);
    ...
    v19->field_0->field_38(v19, a1, v3->field_338, LODWORD(v40), 1056769, 2, 5, 1, -1);
    ...
    v23->field_0->field_38(v23, a1, v3->field_338, LODWORD(v41), 1056769, 2, 5, 1, -1);
    ...
    v27->field_0->field_38(v27, a1, v3->field_338, LODWORD(v42), 1056769, 2, 5, 1, -1);
    ...
    if (!v33)
        sub_1003E260(4);
    v33->field_0->field_38(v33, a1, 1134690304, 1110966272, 1, 2, 5, 1, 22);
    ...
    *(_WORD *)&v33->gap5C[10842] = v34;
    ...
    if (!v36)
        sub_1003E260(4);
    v37 = v36->field_0;
    v36->field_0->field_38(v36, a1, v3->field_338, 1125842944, 1052673, 2, 5, 1, -1);
