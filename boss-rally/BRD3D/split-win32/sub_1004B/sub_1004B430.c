...
int __cdecl sub_1004B430(int a1) {
  ...
  *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
  ...
  (*(void(__thiscall **)(_WORD *, int, _DWORD, int, int, int, int, int, int))(*(_DWORD *)v7 + 56))(
      v7, a1, v3[206], 1092616192, 1048585, 2, 5, 1, -1);
  v7[61702] = 3;
  ...
  (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
      v15, a1, v3[206], LODWORD(v52), 1056769, 2, 5, 1, -1);
  v15[3] = sub_10047360;
  v15[2] = sub_10043180;
  *((_WORD *)v15 + 61702) = 3;
  ...
  (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v19 + 56))(
      v19, a1, v3[206], LODWORD(v53), 1056769, 2, 5, 1, -1);
  v19[3] = sub_10047360;
  v19[2] = sub_100430B0;
  *((_WORD *)v19 + 61702) = 3;
  ...
  (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v23 + 56))(
      v23, a1, v3[206], LODWORD(v54), 1056769, 2, 5, 1, -1);
  v23[3] = sub_100474B0;
  v23[2] = sub_10045110;
  *((_WORD *)v23 + 61702) = 3;
  ...
  (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v27 + 56))(
      v27, a1, v3[206], LODWORD(v55), 1056769, 2, 5, 1, -1);
  ...
  (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v29 + 56))(
      v29, a1, v3[206], LODWORD(v56), 1056769, 2, 5, 1, -1);
  v29[3] = sub_10047360;
  v29[2] = sub_10046450;
  *((_WORD *)v29 + 61702) = 3;
  ...
  *((_WORD *)v33 + 5467) = v34;
  ...
  (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v36 + 56))(
      v36, a1, v3[206], 1133084672, 1052673, 2, 5, 1, -1);
  v36[1] = sub_1003FE80;
  *((_WORD *)v36 + 61702) = 3;
  ...
  if (dword_100AC304) {
      ...
      *((_WORD *)v39 + 5467) = v40;
      ...
      (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v42 + 56))(
          v42, a1, v3[206], 1125646336, 1052673, 2, 5, 1, -1);
      v42[1] = sub_1003FA00;
      *((_WORD *)v42 + 61702) = 3;
  ...
  v45[1] = sub_100408D0;
  *((_WORD *)v45 + 61702) = 5;
  (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v46 + 52))(
      v45, ::a1, 1, 3, &unk_100AB458);
  ++*((_WORD *)v3 + 10);
  ...
  (*(void(__thiscall **)(_WORD *, LPCSTR, int, int, void *))(v49 + 52))(
      v48, v50, 1, 1, &unk_100AB458);
  ++*((_WORD *)v3 + 10);
  return 1;
}
