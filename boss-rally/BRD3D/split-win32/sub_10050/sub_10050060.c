...
int __cdecl sub_10050060(unk000C8 *a1) {
    ...
    *(&a1->field_6C + LOWORD(a1->field_10)) = 1;
    ...
    if (!v6)
        sub_1003E260(4);
    v7 = v6->lpVtbl;
    v6->lpVtbl->field_38(v6, a1, v2->mask_338, 1092616192, 1048585, 2, 5, 1, -1);
  LOWORD(v6->?) = 3;
  ...
  *(_DWORD *)&v10->? [16] = sub_10041DF0;
  for (i = 0; i < 26000; i += 260) {
      if (&gUnkC8Ptr6->field_C0[i] != (char *)-4)
          (*(void(__thiscall **)(int *, char *, _DWORD, int, void *, _DWORD))(*v12 + 16))(
              v12, &gUnkC8Ptr6->field_C0[i + 4], 0, 1, &unk_100AB4D8, 0);
  }
  ++LOWORD(v2->field_14);
  ++LOWORD(v2->last);
  ...
  v15->lpVtbl->field_38(v15, a1, v2->mask_338, LODWORD(v52), 1060881, 2, 5, 1, -1);
  ...
  v19->lpVtbl->field_38(v19, a1, v2->mask_338, LODWORD(v53), 1056769, 2, 5, 1, -1);
  ...
  if (!v25)
      sub_1003E260(4);
  v26 = v25->lpVtbl;
  v25->lpVtbl->field_38(v25, a1, 1134886912, 1125711872, 1048585, 2, 5, 1, -1);
  LOWORD(v25->?) = 3;
  ...
  if (!v29)
      sub_1003E260(4);
  v30 = v29->lpVtbl;
  v29->lpVtbl->field_38(v29, a1, 1134886912, 1120010240, 20481, 2, 5, 1, -1);
  ...
  if (!v32)
      sub_1003E260(4);
  v33 = v32->lpVtbl;
  v32->lpVtbl->field_38(v32, a1, 1138491392, 1127546880, 1048585, 2, 5, 1, -1);
  LOWORD(v32->?) = 3;
  ...
  if (!v36)
      sub_1003E260(4);
  v37 = v36->lpVtbl;
  v36->lpVtbl->field_38(v36, a1, 1138491392, 1124139008, 20481, 2, 5, 1, -1);
  ...
  if (!v39)
      sub_1003E260(4);
  v40 = v39->lpVtbl;
  v39->lpVtbl->field_38(v39, a1, 1138491392, 1131610112, 1048585, 2, 5, 1, -1);
  LOWORD(v39->?) = 3;
  ...
  if (!v43)
      sub_1003E260(4);
  v44 = v43->lpVtbl;
  v43->lpVtbl->field_38(v43, a1, 1138491392, 1130364928, 20481, 2, 5, 1, -1);
  ...
  *(&a1->field_6C + LOWORD(a1->field_10)) = 0;
  ...
  if (!v48)
      sub_1003E260(4);
  v49 = v48->lpVtbl;
  v48->lpVtbl->field_38(v48, a1, 0, 1130889216, 1048585, 2, 5, 1, -1);
