...
//----- (1004E830) --------------------------------------------------------
int __cdecl sub_1004E830(unkC8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    if (!v11)
        sub_1003E260(4);
    v12 = v11->field_0;
    v11->field_0->field_38(v11,
                           a1,
                           v3->field_338,
                           LODWORD(v3->field_33C),
                           diEffect.dwStartDelay != 0 ? 1056769 : 1056785,
                           2,
                           5,
                           1,
                           -1);
    ...
    if (diEffect.dwStartDelay) {
        LOWORD(v11->field_1E20C) = 3;
        v61 = 1;
    } else {
        LOWORD(v11->field_1E20C) = 2;
        v61 = 0;
    }
    v13 = getCaptionString(0x30u);
    v12->field_34(v11, v13, 1, v61, &dword_100AB448);
    ++LOWORD(v3->field_14);
    ++LOWORD(v3->last);
    ...
    v15->field_0->field_38(v15, a1, v3->field_338, LODWORD(v57), 1056769, 2, 5, 1, -1);
    ...
    v19->field_0->field_38(v19, a1, v3->field_338, LODWORD(v58), 1056769, 2, 5, 1, -1);
    ...
    v23->field_0->field_38(v23, a1, v3->field_338, LODWORD(v59), 1056769, 2, 5, 1, -1);
    ...
    v27->field_0->field_38(v27, a1, v3->field_338, LODWORD(v60), 1056769, 2, 5, 1, -1);
    ...
    if (!v31)
        sub_1003E260(4);
    v31->field_0->field_38(v31, a1, 1117782016, 1110966272, 9, 2, 5, 0, 9);
    ++LOWORD(v3->field_14);
    ...
    if (!v33)
        sub_1003E260(4);
    v33->field_0->field_38(v33, a1, 1135083520, 1111490560, 1, 2, 5, 1, 97);
    ...
    *(_WORD *)&v33->gap5C[10842] = v34;
    ...
    if (!v36)
        sub_1003E260(4);
    v37 = v36->field_0;
    v36->field_0->field_38(v36, a1, v3->field_338, 1126563840, 1052673, 2, 5, 1, -1);
    ...
    if (!v39)
        sub_1003E260(4);
    v39->field_0->field_38(v39, a1, 1116078080, 1128726528, 1, 2, 5, 1, 140);
    ...
    *(_WORD *)&v39->gap5C[10842] = v40;
    ...
    if (!v42)
        sub_1003E260(4);
    v43 = v42->field_0;
    v42->field_0->field_38(v42, a1, v3->field_338, 1133215744, 1052673, 2, 5, 1, -1);
    ...
    if (!v45)
        sub_1003E260(4);
    v45->field_0->field_38(v45, a1, 1138491392, 1122238464, 1, 2, 5, 1, 101);
    ...
    *(_WORD *)&v45->gap5C[10842] = v46;
    ...
    if (!v48)
        sub_1003E260(4);
    v49 = v48->field_0;
    v48->field_0->field_38(v48, a1, v3->field_338, 1128529920, 1052673, 2, 5, 1, -1);
    ...
    if (!v51)
        sub_1003E260(4);
    v51->field_0->field_38(v51, a1, 1139933184, 1129709568, 1, 2, 5, 1, 99);
    ...
    *(_WORD *)&v51->gap5C[10842] = v52;
    ...
    if (!v54)
        sub_1003E260(4);
    v55 = v54->field_0;
    v54->field_0->field_38(v54, a1, v3->field_338, 1133019136, 1052673, 2, 5, 1, -1);
