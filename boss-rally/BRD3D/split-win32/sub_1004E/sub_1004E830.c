...
int __cdecl sub_1004E830(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v11 + 56))(
        v11, a1, v3[206], v3[207], MEMORY[0x118ABDBC] != 0 ? 1056769 : 1056785, 2, 5, 1, -1);
    v11[3] = sub_10047360;
    v11[2] = sub_10043590;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v3[206], LODWORD(v57), 1056769, 2, 5, 1, -1);
    v15[3] = sub_10047360;
    v15[2] = sub_100435F0;
    *((_WORD *)v15 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v19 + 56))(
        v19, a1, v3[206], LODWORD(v58), 1056769, 2, 5, 1, -1);
    v19[3] = sub_10047360;
    v19[2] = sub_100436B0;
    *((_WORD *)v19 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v23 + 56))(
        v23, a1, v3[206], LODWORD(v59), 1056769, 2, 5, 1, -1);
    v23[3] = sub_10047360;
    v23[2] = sub_10043650;
    *((_WORD *)v23 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v27 + 56))(
        v27, a1, v3[206], LODWORD(v60), 1056769, 2, 5, 1, -1);
    v27[3] = sub_10047360;
    v27[2] = sub_10046710;
    *((_WORD *)v27 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v31 + 56))(
        v31, a1, 1117782016, 1110966272, 9, 2, 5, 0, 9);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v33 + 56))(
        v33, a1, 1135083520, 1111490560, 1, 2, 5, 1, 97);
    v33[1] = sub_10040950;
    v34 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v33 + 5466);
    *((_WORD *)v33 + 5467) = v34;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v36 + 56))(
        v36, a1, v3[206], 1126563840, 1052673, 2, 5, 1, -1);
    v36[1] = sub_1003FCB0;
    *((_WORD *)v36 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v37 + 52))(
        v36, asc_100AD300, 1, 1, &unk_100AB4C8);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v39 + 56))(
        v39, a1, 1116078080, 1128726528, 1, 2, 5, 1, 140);
    v39[1] = sub_10040990;
    v40 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v39 + 5466);
    *((_WORD *)v39 + 5467) = v40;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v42 + 56))(
        v42, a1, v3[206], 1133215744, 1052673, 2, 5, 1, -1);
    v42[1] = sub_1003FD30;
    *((_WORD *)v42 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v43 + 52))(
        v42, asc_100AD300, 1, 1, &unk_100AB4B8);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v45 + 56))(
        v45, a1, 1138491392, 1122238464, 1, 2, 5, 1, 101);
    v45[1] = sub_100409D0;
    v46 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v45 + 5466);
    *((_WORD *)v45 + 5467) = v46;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v48 + 56))(
        v48, a1, v3[206], 1128529920, 1052673, 2, 5, 1, -1);
    v48[1] = sub_1003FE10;
    *((_WORD *)v48 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v49 + 52))(
        v48, asc_100AD300, 1, 1, &unk_100AB488);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, int, int))(*v51 + 56))(
        v51, a1, 1139933184, 1129709568, 1, 2, 5, 1, 99);
    v51[1] = sub_100409B0;
    v52 = *((_WORD *)v3 + 10) + 1;
    ++*((_WORD *)v51 + 5466);
    *((_WORD *)v51 + 5467) = v52;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v54 + 56))(
        v54, a1, v3[206], 1133019136, 1052673, 2, 5, 1, -1);
    v54[1] = sub_1003FDA0;
    *((_WORD *)v54 + 61702) = 3;
    (*(void(__thiscall **)(_DWORD *, char *, int, int, void *))(v55 + 52))(
        v54, asc_100AD300, 1, 1, &unk_100AB478);
    ++*((_WORD *)v3 + 10);
    return 1;
}
