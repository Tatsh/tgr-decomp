...
void __cdecl sub_1006B5F0(int a1, float a2, int a3, int a4, int a5, int a6) {
    ...
    math_10074720(&v132, (float *)(a1 + 188), v153);
    v29 = *(_DWORD *)(a1 + 4);
    v30 = *(_DWORD *)(a1 + 12);
    v31 = *(_DWORD *)(a1 + 16);
    v128 = *(_BYTE *)(v29 + 416);
    ...
    *(_BYTE *)(a1 + 521) = 0;
    ...
    math_10074720(&v135, (float *)(a1 + 188), v154);
    v75 = *(_DWORD *)(a1 + 12);
    ...
    if (v145) {
        ...
        math_10074720((float *)v151, (float *)(a1 + 188), (float *)(a1 + 160));
        *(float *)&v151[2] = v140;
        math_10074770((float *)(a1 + 160), a1 + 188, (float *)v151);
        math_10074720((float *)v151, (float *)(a1 + 188), (float *)(a1 + 132));
        *(float *)v151 = v138;
        *(float *)&v151[1] = v139;
        math_10074770((float *)(a1 + 132), a1 + 188, (float *)v151);
    }
    v105 = v144;
    v107 = v144;
    if (v108)
