...
int sub_10031DCF()
{
  ...
  {
    byte_106C1580 = (255 * (255 - (unsigned __int8)byte_10690BE8)
                   + (unsigned __int8)byte_10690BE8 * (((unsigned __int8)byte_106C0260 + 255) >> 1))
                  / 255;
    byte_106C335C = (255 * (255 - (unsigned __int8)byte_10690BE8)
                   + (unsigned __int8)byte_10690BE8 * (((unsigned __int8)byte_106C1614 + 255) >> 1))
                  / 255;
    byte_106C0968 = (204 * (255 - (unsigned __int8)byte_10690BE8)
    ...
    byte_106C0960 = (102 * (255 - (unsigned __int8)byte_10690BE8)
                  ...
                  / 255;
    byte_106C65BC = (119 * (255 - (unsigned __int8)byte_10690BE8)
  ...
  else
  {
    ...
    byte_10690FFA = ((int)(unsigned __int8)byte_106C1580 >> 2) + ((int)(unsigned __int8)byte_106C1580 >> 1);
    byte_106C6496 = ((int)(unsigned __int8)byte_106C335C >> 2) + ((int)(unsigned __int8)byte_106C335C >> 1);
    byte_106C335A = ((int)(unsigned __int8)byte_106C0968 >> 2) + ((int)(unsigned __int8)byte_106C0968 >> 1);
    byte_10690FFB = byte_106C1580;
    byte_106C6497 = byte_106C335C;
    byte_106C335B = byte_106C0968;
  }
  dword_106C29E8 = ((unsigned __int8)byte_106C65BC << 8) | ((unsigned __int8)byte_106C0960 << 16) | ((unsigned __int8)byte_10690BF0 << 24);
  result = (unsigned __int8)byte_106C335C << 16;
  dword_106C5AB0 = ((unsigned __int8)byte_106C0968 << 8) | result | ((unsigned __int8)byte_106C1580 << 24);
  for ( i = 0; i < 4; ++i )
  {
    result = (unsigned __int8)byte_106C3358[i] << 8;
    dword_106C0950[i] = result | ((unsigned __int8)byte_106C6494[i] << 16) | ((unsigned __int8)byte_10690FF8[i] << 24);
  }
  return result;
}
