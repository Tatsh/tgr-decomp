...
char sub_10031866()
{
  ...
  {
    v11 = (__int64)((*(float *)(dword_106C2CF8 + 56) - flt_106C7C80) / (flt_106C7C84 - flt_106C7C80) * 255.0);
    if ( v11 >= 0 )
    {
      if ( v11 > 255 )
        LOBYTE(v11) = -1;
    ...
    else
    {
      if ( *((float *)dword_106C6490 + 13) <= 1024.0 )
        ...
        v10 = *((float *)dword_106C6490 + 12)
            * 0.00043945311
            * ((*((float *)dword_106C6490 + 13) - 1024.0)
             * 0.00087890623);
  ...
  dword_106C0680 += 8;
  *v9 = -1140850680;
  v9[1] = (unsigned __int16)(((500 - dword_106C3398) << 8) / (dword_106C64D8 - dword_106C3398)) | ((unsigned __int16)(128000 / (dword_106C64D8 - dword_106C3398)) << 16);
  v8 = (_DWORD *)dword_106C0680;
  dword_106C0680 += 8;
  *v8 = -134217728;
  v0 = ((unsigned __int8)byte_106C0200 << 8) | ((unsigned __int8)byte_106C1614 << 16) | ((unsigned __int8)byte_106C0260 << 24);
  LOBYTE(v0) = -1;
  v8[1] = v0;
  return v0;
}
