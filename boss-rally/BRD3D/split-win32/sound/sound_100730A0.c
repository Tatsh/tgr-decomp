...
//----- (100730A0) --------------------------------------------------------
int __cdecl sound_100730A0(int a1) {
    int v1;                 // edx
    HMMIO v2;               // eax
    HMMIO v3;               // eax
    HMMIO v4;               // eax
