...
int __cdecl sub_1006DB20(int a1, float *a2) {
    ...
    if (!dword_117554E8) {
        ...
        if (v4 > 0) {
            v15 = v4;
            do {
                math_100747C0(&v34, a2, v14[4]);
                math_100747C0(&v37, a2, v14[5]);
                math_100747C0(&v40, a2, v14[6]);
                v16 = v40 - v34;
                v20 = v16;
                v17 = v41 - v35;
                v22 = v17;
    ...
    v9 = v7 + 1;
    do {
        math_100747C0(&v34, a2, v8[4]);
        math_100747C0(&v37, a2, v8[5]);
        math_100747C0(&v40, a2, v8[6]);
        v10 = v40 - v34;
        v19 = v10;
        v11 = v41 - v35;
        v21 = v11;
