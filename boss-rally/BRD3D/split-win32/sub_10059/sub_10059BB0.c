...
int __cdecl sub_10059BB0(int a1) {
  ...
  *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v2;
  ...
  if (!v6)
    sub_1003E260(4);
  v7 = v6->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v6->lpVtbl->meth14)(
      v6, a1, v2->flags_338, 1092616192, 1048585, 2, 5, 1, -1);
  ...
  if (!v10)
    sub_1003E260(4);
  ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))v10->lpVtbl->meth14)(
      v10, a1, v2->flags_338, LODWORD(v2->field_33C), 12289, 2, 5, 1, -1);
  ...
  *(_DWORD *)&v10->field_3838.field_1A99C[16] = 1;
  ...
  ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))v15->lpVtbl->meth14)(
      v15, a1, v2->flags_338, LODWORD(v62), 1060881, 2, 5, 1, -1);
  ...
  ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))v19->lpVtbl->meth14)(
      v19, a1, v2->flags_338, LODWORD(v63), 1056769, 2, 5, 1, -1);
  ...
  if (!v23)
    sub_1003E260(4);
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v23->lpVtbl->meth14)(
      v23, a1, 1138425856, 1123418112, 1, 2, 5, 1, 17);
  ...
  if (!v26)
    sub_1003E260(4);
  v27 = v26->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v26->lpVtbl->meth14)(
      v26, a1, v2->flags_338, 1127546880, 1052673, 2, 5, 1, -1);
  ...
  if (!v29)
    sub_1003E260(4);
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v29->lpVtbl->meth14)(
      v29, a1, 1135181824, 1116471296, 1, 2, 5, 1, 11);
  ...
  if (!v32)
    sub_1003E260(4);
  v33 = v32->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v32->lpVtbl->meth14)(
      v32, a1, v2->flags_338, 1124663296, 1052673, 2, 5, 1, -1);
  ...
  if (!v35)
    sub_1003E260(4);
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v35->lpVtbl->meth14)(
      v35, a1, 1116864512, 1129578496, 1, 2, 5, 1, 22);
  ...
  if (!v38)
    sub_1003E260(4);
  v39 = v38->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v38->lpVtbl->meth14)(
      v38, a1, v2->flags_338, 1133084672, 1052673, 2, 5, 1, -1);
  ...
  if (!v41)
    sub_1003E260(4);
  v42 = v41->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v41->lpVtbl->meth14)(
      v41, a1, 1121189888, 1116209152, 20481, 2, 5, 1, -1);
  ...
  if (!v44)
    sub_1003E260(4);
  v45 = v44->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v44->lpVtbl->meth14)(
      v44, a1, 1121189888, 1122369536, 1048577, 2, 5, 1, -1);
  ...
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v48->lpVtbl->meth14)(
      v48, a1, 1138491392, 1129316352, 1052673, 2, 5, 1, -1);
  ...
  if (!v51)
    sub_1003E260(4);
  v52 = v51->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v51->lpVtbl->meth14)(
      v51, a1, 1138491392, 1130364928, 1048577, 2, 5, 1, -1);
  ...
  if (!v55)
    sub_1003E260(4);
  v56 = v55->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v55->lpVtbl->meth14)(
      v55, a1, 1138491392, 1131413504, 1052673, 2, 5, 1, -1);
  ...
  if (!v58)
    sub_1003E260(4);
  v59 = v58->lpVtbl;
  ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))v58->lpVtbl->meth14)(
      v58, a1, 1138491392, 1132462080, 1048577, 2, 5, 1, -1);
