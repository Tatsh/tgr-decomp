...
int __cdecl sub_10059BB0(int a1) {
    ...
    gUnkC8Ptr6->last->lpVtbl->field_4(gUnkC8Ptr6->last, aTimeattackGrf);
    *(_WORD *)(a1 + 18) = 0;
    dword_10AA28E8 = 0;
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v2;
    ...
    if (!v4)
        sub_1003E260(4);
    v4->lpVtbl->field_38(v4, (unk000C8 *)a1, 0, 0, 9, 2, 5, 0, 0);
    ++LOWORD(v2->field_14);
    ...
    if (!v6)
        sub_1003E260(4);
    v7 = v6->lpVtbl;
    v6->lpVtbl->field_38(v6, (unk000C8 *)a1, v2->mask_338, 1092616192, 1048585, 2, 5, 1, -1);
  LOWORD(v6->?) = 3;
  ...
  if (!v10)
      sub_1003E260(4);
  v10->lpVtbl->field_38(
      v10, (unk000C8 *)a1, v2->mask_338, LODWORD(v2->field_33C), 12289, 2, 5, 1, -1);
  v11 = v10->field_3838;
  v12 = &v10->field_3838;
  ...
  *(_DWORD *)v10->? = sub_10042880;
  for (i = 0; i < 26000; i += 260) {
      if ((unk06594 *)((char *)gUnkC8Ptr6->last + i) != (unk06594 *)-4)
          (*(void(__thiscall **)(int *, char *, _DWORD, int, void *, int))(*v12 + 16))(
              v12, (char *)&gUnkC8Ptr6->last->field_4 + i, 0, 1, &unk_100AB4D8, 1);
  }
  ++LOWORD(v2->field_14);
  ++LOWORD(v2->last);
  ...
  v15->lpVtbl->field_38(v15, (unk000C8 *)a1, v2->mask_338, LODWORD(v62), 1060881, 2, 5, 1, -1);
  ...
  v19->lpVtbl->field_38(v19, (unk000C8 *)a1, v2->mask_338, LODWORD(v63), 1056769, 2, 5, 1, -1);
  ...
  if (!v23)
      sub_1003E260(4);
  v23->lpVtbl->field_38(v23, (unk000C8 *)a1, 1138425856, 1123418112, 1, 2, 5, 1, 17);
  ...
  *(_WORD *)&v23->gap5C[10842] = v24;
  ...
  if (!v26)
      sub_1003E260(4);
  v27 = v26->lpVtbl;
  v26->lpVtbl->field_38(v26, (unk000C8 *)a1, v2->mask_338, 1127546880, 1052673, 2, 5, 1, -1);
  ...
  if (!v29)
      sub_1003E260(4);
  v29->lpVtbl->field_38(v29, (unk000C8 *)a1, 1135181824, 1116471296, 1, 2, 5, 1, 11);
  ...
  *(_WORD *)&v29->gap5C[10842] = v30;
  ...
  if (!v32)
      sub_1003E260(4);
  v33 = v32->lpVtbl;
  v32->lpVtbl->field_38(v32, (unk000C8 *)a1, v2->mask_338, 1124663296, 1052673, 2, 5, 1, -1);
  ...
  *(_WORD *)&v35->gap5C[10842] = v36;
  ...
  if (!v38)
      sub_1003E260(4);
  v39 = v38->lpVtbl;
  v38->lpVtbl->field_38(v38, (unk000C8 *)a1, v2->mask_338, 1133084672, 1052673, 2, 5, 1, -1);
  ...
  if (!v41)
      sub_1003E260(4);
  v42 = v41->lpVtbl;
  v41->lpVtbl->field_38(v41, (unk000C8 *)a1, 1121189888, 1116209152, 20481, 2, 5, 1, -1);
  ...
  if (!v44)
      sub_1003E260(4);
  v45 = v44->lpVtbl;
  v44->lpVtbl->field_38(v44, (unk000C8 *)a1, 1121189888, 1122369536, 1048577, 2, 5, 1, -1);
  LOWORD(v44->?) = 3;
  ...
  if (!v48)
      sub_1003E260(4);
  v49 = v48->lpVtbl;
  v48->lpVtbl->field_38(v48, (unk000C8 *)a1, 1138491392, 1129316352, 1052673, 2, 5, 1, -1);
  ...
  if (!v51)
      sub_1003E260(4);
  v52 = v51->lpVtbl;
  v51->lpVtbl->field_38(v51, (unk000C8 *)a1, 1138491392, 1130364928, 1048577, 2, 5, 1, -1);
  LOWORD(v51->?) = 3;
  ...
  if (!v55)
      sub_1003E260(4);
  v56 = v55->lpVtbl;
  v55->lpVtbl->field_38(v55, (unk000C8 *)a1, 1138491392, 1131413504, 1052673, 2, 5, 1, -1);
  ...
  if (!v58)
      sub_1003E260(4);
  v59 = v58->lpVtbl;
  v58->lpVtbl->field_38(v58, (unk000C8 *)a1, 1138491392, 1132462080, 1048577, 2, 5, 1, -1);
  LOWORD(v58->?) = 3;
