...
//----- (10059760) --------------------------------------------------------
int __cdecl sub_10059760(unkC8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    if (!v11)
        sub_1003E260(4);
    v12 = v11->field_0;
    v11->field_0->field_38(v11, a1, v3->field_338, LODWORD(v3->field_33C), 0x102001, 2, 5, 1, -1);
    v11->field_C = sub_10047360;
    v11->field_8 = sub_10046260;
    LOWORD(v11->field_1E20C) = 3;
    v13 = getCaptionString(0x6Bu);
    ...
    v15->field_0->field_38(v15, a1, v3->field_338, LODWORD(v25), 0x102001, 2, 5, 1, -1);
    v15->field_C = sub_10047360;
    v15->field_8 = sub_10044D00;
    LOWORD(v15->field_1E20C) = 3;
    v17 = getCaptionString(0x6Cu);
    ...
    v19->field_0->field_38(v19, a1, v3->field_338, LODWORD(v26), 0x102001, 2, 5, 1, -1);
    ...
    if (!v23)
        sub_1003E260(4);
    v23->field_0->field_38(v23, a1, 0x42A00000, 0x42380000, 9, 2, 5, 0, 8);
    ++LOWORD(v3->field_14);
    return 1;
}
