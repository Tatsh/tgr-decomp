...
int __cdecl sub_100661B0(int a1, int a2) {
    ...
    if (v3 > 0) {
        do {
            atomic_sub_10074F70(*(_DWORD *)(*(_DWORD *)(a1 + 10692) + 4 * v2 + 4),
    ...
    if (*(_DWORD *)(*(_DWORD *)(result + 32788) + 36 * *(unsigned __int8 *)(result + 33051) + 4) &&
        ...
        if (v5)
            atomic_sub_10074F70(v5, *(_DWORD *)(*(_DWORD *)(a2 + 120) + 4 * v3));
        v6 = *(_DWORD *)(*(_DWORD *)(a1 + 10692) + 136);
        if (v6)
            atomic_sub_10074F70(v6, *(_DWORD *)(*(_DWORD *)(a2 + 120) + 4 * v3 + 4));
        v7 = *(_DWORD *)(*(_DWORD *)(a1 + 10692) + 140);
        if (v7)
            atomic_sub_10074F70(v7, *(_DWORD *)(*(_DWORD *)(a2 + 120) + 4 * v3 + 8));
        result = *(_DWORD *)(*(_DWORD *)(a1 + 10692) + 144);
        if (result)
            result = atomic_sub_10074F70(result, *(_DWORD *)(*(_DWORD *)(a2 + 120) + 4 * v3 + 12));
    }
    return result;
}
