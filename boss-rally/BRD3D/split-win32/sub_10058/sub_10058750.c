...
int __cdecl sub_10058750(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v2;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v8 + 56))(
        v8, a1, v2[206], v2[207], 1056769, 2, 5, 1, -1);
    v8[3] = sub_10047360;
    v8[2] = sub_10042B30;
    *((_WORD *)v8 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v12 + 56))(
        v12, a1, v2[206], LODWORD(v82), 1056769, 2, 5, 1, -1);
    v12[3] = sub_10047360;
    v12[2] = sub_10042DC0;
    *((_WORD *)v12 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v16 + 56))(
        v16, a1, v2[206], LODWORD(v83), 1056769, 2, 5, 1, -1);
    v16[3] = sub_10047360;
    v16[2] = sub_10042E20;
    *((_WORD *)v16 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v20 + 56))(
        v20, a1, v2[206], LODWORD(v84), 1056769, 2, 5, 1, -1);
    v20[3] = sub_10047360;
    v20[2] = sub_10042C80;
    *((_WORD *)v20 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v24 + 56))(
        v24, a1, v2[206], LODWORD(v85), 1056769, 2, 5, 1, -1);
    v24[3] = sub_10047360;
    v24[2] = sub_10042E80;
    *((_WORD *)v24 + 61702) = 3;
    ...
    if (g_NetworkPlay == 2) {
        ...
        (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v28 + 56))(
            v28, a1, v2[206], LODWORD(v86), 1056769, 2, 5, 1, -1);
        v28[3] = sub_10047360;
        v28[2] = sub_100437B0;
        *((_WORD *)v28 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v32 + 56))(
        v32, a1, v2[206], LODWORD(v87), 1056769, 2, 5, 1, -1);
    v32[3] = sub_10047360;
    v32[2] = sub_10043A00;
    v32[6] = sub_10043810;
    *((_WORD *)v32 + 61702) = 3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v36 + 56))(
        v36, a1, v2[206], LODWORD(v88), 1056769, 2, 5, 1, -1);
    v36[3] = sub_10047360;
    v36[2] = sub_10046400;
    *((_WORD *)v36 + 61702) = 3;
    ...
    *((_WORD *)v54 + 5467) = v55;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v57 + 56))(
        v57, a1, v2[206], 1124663296, 1052673, 2, 5, 1, -1);
    v57[1] = sub_1003F760;
    *((_WORD *)v57 + 61702) = 3;
    ...
    *((_WORD *)v60 + 5467) = v61;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v63 + 56))(
        v63, a1, v2[206], 1123418112, 1052673, 2, 5, 1, -1);
    v63[1] = sub_1003F7F0;
    *((_WORD *)v63 + 61702) = 3;
    ...
    *((_WORD *)v66 + 5467) = v67;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v69 + 56))(
        v69, a1, v2[206], 1127546880, 1052673, 2, 5, 1, -1);
    v69[1] = sub_1003F990;
    *((_WORD *)v69 + 61702) = 3;
    ...
    *((_WORD *)v72 + 5467) = v73;
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, int, int, int, int, int, int))(*v75 + 56))(
        v75, a1, v2[206], 1132658688, 1052673, 2, 5, 1, -1);
    v75[1] = sub_1003F860;
    *((_WORD *)v75 + 61702) = 3;
