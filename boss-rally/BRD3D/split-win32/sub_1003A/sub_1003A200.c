    ...
    if ((_WORD)dword_10A99BB0) {
        do {
            ...
            v4 = (double)((unsigned __int8)byte_10A99BD6[32 * v0] *
                 ...
                 0.000015318628;
            flt_10A99BB8[v1] = flt_10A99BC4[8 * v0] * v4 * *(float *)&dword_106C2CFC +
                               flt_104B2560 + flt_10A99BB8[8 * v0];
            flt_10A99BBC[v1] = flt_10A99BC8[8 * v0] * v4 * *(float *)&dword_106C2CFC +
                               flt_104B2564 + flt_10A99BBC[8 * v0];
            flt_10A99BC0[v1] =
                (flt_10A99BCC[8 * v0] * v4 - -0.80000001) * *(float *)&dword_106C2CFC +
                *(float *)&dword_104B2568 + flt_10A99BC0[8 * v0];
            byte_10A99BD6[32 * v0] =
                (__int64)(5.7375007 / (flt_10A99BD0[8 * v0] * flt_10A99BD0[8 * v0]));
            if (v4 >= 0.03125) {
