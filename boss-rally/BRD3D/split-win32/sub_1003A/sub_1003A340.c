        ...
        if ((_WORD)v2) {
            do {
                ...
                v7 = (double)((unsigned __int8)byte_10A99BD6[32 * v2] *
                     ...
                     0.000015318628;
                flt_10A99BB8[v3] = flt_10A99BC4[8 * v2] * v7 * *(float *)&dword_106C2CFC +
                                   flt_104B2560 + flt_10A99BB8[8 * v2];
                flt_10A99BBC[v3] = flt_10A99BC8[8 * v2] * v7 * *(float *)&dword_106C2CFC +
                                   flt_104B2564 + flt_10A99BBC[8 * v2];
                flt_10A99BC0[v3] =
                    (v7 * flt_10A99BCC[8 * v2] - -0.80000001) * *(float *)&dword_106C2CFC +
