...
int __thiscall meth_10075360(int this) {
    ...
    v36 = *(float *)(v1 + 4084) -
          (double)*(int *)(v1 + 4012) * *(float *)(gUnk06594.field_4938 + 100);
    if (!v33 ||
        ...
        sub_1003B0E0(v2, (float *)(*(_DWORD *)(v1 + 3980) + 40 * *(_DWORD *)(v1 + 3984) + 76)) >=
            64.0) {
        v9 = 0;
        v37 = (*(float *)&gUnk06594.gap48F0[4] - *(float *)gUnk06594.gap48F0) *
              (*(float *)&gUnk06594.gap48F0[4] - *(float *)gUnk06594.gap48F0);
        if (*(int *)&gUnk06594.gap493C[8] > 0) {
            v10 = gUnk06594.field_4938;
            do {
                if (*(_DWORD *)(v1 + 320) < dword_100B4050 || gGameMode == GAME_MODE_2 ||
                    (*(_BYTE *)(*(_DWORD *)(*(_DWORD *)&gUnk06594.gap493C[4] + 4 * v9) + 22) & 1) ==
                        0) {
                    v11 = *(_DWORD *)(*(_DWORD *)&gUnk06594.gap493C[4] + 4 * v9);
                ...
                ++v9;
            } while (v9 < *(int *)&gUnk06594.gap493C[8]);
        }
        if (v34 == -1)
            return 0;
        v8 = v34;
        v7 = *(_DWORD *)(*(_DWORD *)&gUnk06594.gap493C[4] + 4 * v38);
    } else {
        v7 = *(_DWORD *)(v1 + 3980);
        v8 = *(_DWORD *)(v1 + 3984);
    }
    ...
    v35 = (double)(*(_DWORD *)(this + 4012) + 1) * *(float *)(gUnk06594.field_4938 + 100) -
          v23[25] + sub_1003AC90(&v44, v47) - *(float *)(this + 4084);
