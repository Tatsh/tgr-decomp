        ...
        if (dword_100BD3E8) {
            ...
            if (v3 < dword_100BD3E0 || dword_100AA8B4 == 1) {
                ...
                if (v3 >= dword_100BD3E0) {
                    v6 = text_GetStringWithIndex(0xE6u);
                    sprintf(Buffer, v6);
                } else {
                    if (dword_100AA8B4 == 2) {
                        v5 = asc_100A73D4;
                    } else {
                        v5 = text_GetStringWithIndex(0xE5u);
                        v2 = dword_100BD3E0;
                    }
        ...
        if (dword_100BD3F8 && !dword_1022AF1C) {
            ...
            if (*(_DWORD *)(dword_106C2CF8 + 4088)) {
                if (*(_DWORD *)(dword_106C2CF8 + 4088) == 1) {
                    v10 = (char *)text_GetStringWithIndex(0xB4u);
                    v9 = 1;
                } else if (*(_DWORD *)(dword_106C2CF8 + 4088) == 2) {
                    v10 = (char *)text_GetStringWithIndex(0xB5u);
                } else {
                    v10 = (char *)text_GetStringWithIndex(0xB6u);
                    v9 = 1;
                }
            } else {
                v10 = (char *)text_GetStringWithIndex(0xB3u);
                v9 = -3;
            }
            if (dword_100AA8B4 == 1) {
                sub_100192F0(40);
