    ...
    if (gGameMode != 3) {
        ...
        if (dword_100BD3E8) {
            ...
            if (v3 < dword_100BD3E0 || dword_100AA8B4 == 1) {
                ...
                sub_100192F0(15);
                text_sub_10019300((int)Buffer, v1, v4 + 15);
            }
        }
        if (dword_100BD3F8 && !dword_1022AF1C) {
            ...
            if (*(_DWORD *)(dword_106C2CF8 + 4088)) {
                if (*(_DWORD *)(dword_106C2CF8 + 4088) == 1) {
                    v10 = GetStringWithIndex(0xB4u);
                    v9 = 1;
                } else if (*(_DWORD *)(dword_106C2CF8 + 4088) == 2) {
                    v10 = GetStringWithIndex(0xB5u);
                } else {
                    v10 = GetStringWithIndex(0xB6u);
                    v9 = 1;
                }
            } else {
                v10 = GetStringWithIndex(0xB3u);
                v9 = -3;
            }
            if (dword_100AA8B4 == 1) {
                sub_100192F0(40);
                v11 = sub_100193C0(Buffer, 40);
                text_sub_10019300((int)Buffer, v7 - 1, v8 - 1);
                sub_100192F0(20);
                text_sub_10019300((int)v10, v9 + v11 + v7 + 3, v8 - 15);
            } else {
                sub_100192F0(26);
                v12 = sub_100193C0(Buffer, 26);
                text_sub_10019300((int)Buffer, v7, v8);
                sub_100192F0(13);
                text_sub_10019300((int)v10, v12 + 2 * v9 / 3 + v7 + 3, v8 - 10);
            }
            sub_10019250();
        }
    }
