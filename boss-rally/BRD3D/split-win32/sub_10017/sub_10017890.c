            ...
            if ( *(_DWORD *)(v6 + 3848) )
            {
              ...
              if ( dword_118ABDC8 )
              {
                ...
                if ( v18 )
                {
                  ...
                  sprintf(Buffer, "%%11%s %dms %c%c", (const char *)(v6 + 328), v10, v8, v7);
                }
                else if ( (*(_BYTE *)(*(_DWORD *)(v6 + 3840) + 104) & 1) != 0 || dword_106909E0 )
                {
                ...
                sub_10019300((int)Buffer, v17 + 16, 16 * *(_DWORD *)(v6 + 4088) + v19 + 20);
                v4 = v19;
                v3 = v17;
              }
              else
              {
                ...
                sub_10019300((int)Buffer, v3 + 16, 16 * *(_DWORD *)(v6 + 4088) + v4 + 20);
              }
            }
            else
            {
