...
int __cdecl s_unk000C8_1004D1F0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    v9 = text_GetStringWithIndex(0x20u);
    ...
    v13->field_8 = (int(__cdecl *)())sub_10045460;
    v13->field_3838.field_1A99C[28] = 3;
    v15 = text_GetStringWithIndex(0x29u);
    ...
    v17->field_8 = (int(__cdecl *)())sub_10045520;
    v17->field_3838.field_1A99C[28] = 3;
    v19 = text_GetStringWithIndex(0x2Au);
    ...
    v23 = text_GetStringWithIndex(0xCu);
