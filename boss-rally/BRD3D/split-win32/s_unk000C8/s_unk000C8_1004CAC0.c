...
int __cdecl s_unk000C8_1004CAC0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v2) = 1;
    ...
    v10 = text_GetStringWithIndex(0x26u);
    ...
    *(_DWORD *)&v12->field_3838.field_1A99C[16] = 1;
    ...
    do {
        ...
        if (text_GetStringWithIndex(*(_DWORD *)v14)) {
            v16 = text_GetStringWithIndex(*(_DWORD *)v14);
    ...
    v20 = text_GetStringWithIndex(0x27u);
    ...
    v36 = text_GetStringWithIndex(0x28u);
