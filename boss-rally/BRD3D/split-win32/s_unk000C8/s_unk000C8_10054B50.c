...
int __cdecl s_unk000C8_10054B50(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v2) = 1;
    ...
    v10 = text_GetStringWithIndex(0x4Fu);
    ...
    v14 = text_GetStringWithIndex(0x50u);
    ...
    v18 = text_GetStringWithIndex(0xCu);
    ...
    *(_WORD *)&v26->field_2A40[2] = 85;
    ...
    v31 = text_GetStringWithIndex(0x38u);
    ...
    v38 = text_GetStringWithIndex(0x36u);
    ...
    v45 = text_GetStringWithIndex(0x52u);
    ...
    v52 = text_GetStringWithIndex(0x53u);
    ...
    v56 = text_GetStringWithIndex(0x40u);
    ...
    v60 = text_GetStringWithIndex(0x46u);
    ...
    v67 = text_GetStringWithIndex(0x40u);
    ...
    v71 = text_GetStringWithIndex(0x41u);
