...
int __cdecl s_unk000C8_10050060(unk000C8 *a1) {
    ...
    *(&a1->field_6C + a1->field_10) = 1;
    ...
    v8 = text_GetStringWithIndex(0x39u);
    ...
    *(_DWORD *)&v10->field_3838.field_1A99C[16] = 1;
    ...
    v27 = text_GetStringWithIndex(0x36u);
    ...
    v34 = text_GetStringWithIndex(0x37u);
    ...
    v41 = text_GetStringWithIndex(0x38u);
    ...
    *(&a1->field_6C + a1->field_10) = 0;
    ...
    v50 = text_GetStringWithIndex(0x3Au);
