...
int __cdecl s_unk000C8_10058750(unk000C8 *a1) {
    ...
    *(&a1->field_6C + a1->field_10) = 1;
    ...
    v10 = text_GetStringWithIndex(0x14u);
    ...
    v14 = text_GetStringWithIndex(0x15u);
    ...
    v18 = text_GetStringWithIndex(0x16u);
    ...
    v22 = text_GetStringWithIndex(0x17u);
    ...
    v26 = text_GetStringWithIndex(0x18u);
    ...
    if (gNetworkPlay == 2) {
        ...
        v30 = text_GetStringWithIndex(0x68u);
    ...
    if (dword_10AA2884)
        ...
        v34 = text_GetStringWithIndex(0x69u);
