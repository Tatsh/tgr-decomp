...
int __cdecl s_unk000C8_1004BDC0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    v13 = text_GetStringWithIndex(0x1Fu);
    ...
    v17 = text_GetStringWithIndex(0x20u);
    ...
    v21 = text_GetStringWithIndex(0x21u);
    ...
    v25 = text_GetStringWithIndex(0x22u);
