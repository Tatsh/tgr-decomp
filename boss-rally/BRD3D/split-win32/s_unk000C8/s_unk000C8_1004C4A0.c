...
int __cdecl s_unk000C8_1004C4A0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    v9 = text_GetStringWithIndex(0x1Fu);
    ...
    v13 = text_GetStringWithIndex(0x23u);
    ...
    v17 = text_GetStringWithIndex(0x24u);
    ...
    v21 = text_GetStringWithIndex(0x25u);
    ...
    v25 = text_GetStringWithIndex(0xCu);
