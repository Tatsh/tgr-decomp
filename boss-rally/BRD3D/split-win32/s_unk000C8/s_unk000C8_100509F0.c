...
int __cdecl s_unk000C8_100509F0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v2) = 1;
    ...
    v13 = text_GetStringWithIndex(0x3Du);
    ...
    *(_DWORD *)&v15->field_3838.field_1A99C[16] = 1;
    ...
    if (dword_100B3814[6 * (char)dword_10AA28B8] > 0) {
        ...
        do {
            ...
            v105 = _strupr(v20);
            v21 = text_GetStringWithIndex(0xBFu);
    ...
    v30 = text_GetStringWithIndex(0xCu);
    ...
    *(_WORD *)&v39->field_2A40[2] = 85;
    ...
    v60 = text_GetStringWithIndex(0x3Eu);
    ...
    v69 = text_GetStringWithIndex(0x3Fu);
    ...
    v77 = text_GetStringWithIndex(0x40u);
    ...
    v81 = text_GetStringWithIndex(0x41u);
    ...
    v89 = text_GetStringWithIndex(0x38u);
    ...
    v98 = text_GetStringWithIndex(0x36u);
