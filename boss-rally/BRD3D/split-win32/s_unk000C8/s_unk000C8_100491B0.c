...
int __cdecl s_unk000C8_100491B0(unk000C8 *a1) {
    ...
    *(_DWORD *)&v3->gap20[788] = v7;
    ...
    v11 = text_GetStringWithIndex(1u);
    ...
    v15 = text_GetStringWithIndex(2u);
    ...
    v22 = text_GetStringWithIndex(3u);
    ...
    v29 = text_GetStringWithIndex(4u);
    ...
    v36 = text_GetStringWithIndex(5u);
    ...
    v43 = text_GetStringWithIndex(6u);
    ...
    v50 = text_GetStringWithIndex(7u);
    ...
    v55 = text_GetStringWithIndex(8u);
