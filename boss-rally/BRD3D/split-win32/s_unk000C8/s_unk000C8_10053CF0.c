...
int __cdecl s_unk000C8_10053CF0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + a1->field_10) = 1;
    ...
    v10 = text_GetStringWithIndex(0x4Eu);
    ...
    *(_DWORD *)&v12->field_3838.field_1A99C[16] = 1;
    ...
    if (dword_100B3814[6 * (char)dword_10AA28B8] > 0) {
        v87 = v14->meth4;
        do {
            strcpy(v91, text_GetStringWithIndex(0x37u));
    ...
    v19 = text_GetStringWithIndex(0x1Eu);
    ...
    *(_WORD *)&v33->field_2A40[2] = 85;
    ...
    v38 = text_GetStringWithIndex(0x38u);
    ...
    v47 = text_GetStringWithIndex(0x36u);
    ...
    v55 = text_GetStringWithIndex(0x4Cu);
    ...
    v79 = text_GetStringWithIndex(0x40u);
