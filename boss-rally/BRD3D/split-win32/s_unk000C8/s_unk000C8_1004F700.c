...
int __cdecl s_unk000C8_1004F700(unk000C8 *a1) {
    ...
    *(&a1->field_6C + a1->field_10) = 1;
    ...
    v9 = text_GetStringWithIndex(0x34u);
    ...
    *(_DWORD *)&v11->field_3838.field_1A99C[16] = 1;
    ...
    v23 = text_GetStringWithIndex(0x35u);
    ...
    v33 = text_GetStringWithIndex(0x36u);
    ...
    v40 = text_GetStringWithIndex(0x37u);
    ...
    v47 = text_GetStringWithIndex(0x38u);
