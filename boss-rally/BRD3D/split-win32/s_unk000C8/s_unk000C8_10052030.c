...
int __cdecl s_unk000C8_10052030(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v2) = 1;
    ...
    v10 = text_GetStringWithIndex(0x44u);
    ...
    v14 = text_GetStringWithIndex(0x45u);
    ...
    v18 = text_GetStringWithIndex(0x1Eu);
    ...
    v22 = text_GetStringWithIndex(0xCu);
    ...
    *(_WORD *)&v30->field_2A40[2] = 85;
    ...
    v47 = text_GetStringWithIndex(0x40u);
    ...
    v51 = text_GetStringWithIndex(0x46u);
    ...
    v58 = text_GetStringWithIndex(0x40u);
    ...
    v62 = text_GetStringWithIndex(0x41u);
    ...
    v69 = text_GetStringWithIndex(0x38u);
    ...
    v76 = text_GetStringWithIndex(0x36u);
