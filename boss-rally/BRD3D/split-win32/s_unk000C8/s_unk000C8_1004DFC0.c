...
int __cdecl s_unk000C8_1004DFC0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v2) = 1;
    ...
    v10 = text_GetStringWithIndex(0x21u);
    ...
    *(_DWORD *)&v14->field_3838.field_1A99C[16] = 1;
    ...
    if (dword_10AA2A34 >= 0) {
        if (dword_10AA2A34 <= 11)
            *(float *)&v14->field_3838.field_1A99C[10] =
                *(float *)&v14->field_3838.field_1A99C[22] -
                (*(float *)&v14->field_3838.field_1A99C[24] -
                 *(float *)&v14->field_3838.field_1A99C[22]) *
                    (double)dword_10AA2A34 * -0.090909094;
        else
            *(_DWORD *)&v14->field_3838.field_1A99C[10] =
                *(_DWORD *)&v14->field_3838.field_1A99C[24];
    } else {
    ...
    *(_DWORD *)&v14->field_3838.gap1A93A[94] = v19 + 16;
    ...
    v23 = text_GetStringWithIndex(0x2Eu);
    ...
    v27 = text_GetStringWithIndex(0x2Fu);
    ...
    v41 = text_GetStringWithIndex(0x2Eu);
    ...
    v45 = text_GetStringWithIndex(0x2Fu);
