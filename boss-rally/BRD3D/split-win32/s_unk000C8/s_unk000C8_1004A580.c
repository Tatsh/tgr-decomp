...
int __cdecl s_unk000C8_1004A580(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v4;
    ...
    v10 = text_GetStringWithIndex(0x13u);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v12->lpVtbl->meth14)(v12, a1, v4->flags_338, LODWORD(v4->field_33C), 1056769, 2, 5, 1, -1);
    v12->field_C = sub_10047360;
    v12->field_8 = sub_10042B30;
    v12->field_3838.field_1A99C[28] = 3;
    v14 = text_GetStringWithIndex(0x14u);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v16->lpVtbl->meth14)(v16, a1, v4->flags_338, LODWORD(v78), 1056769, 2, 5, 1, -1);
    v16->field_C = sub_10047360;
    v16->field_8 = sub_10042DC0;
    v16->field_3838.field_1A99C[28] = 3;
    v18 = text_GetStringWithIndex(0x15u);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v20->lpVtbl->meth14)(v20, a1, v4->flags_338, LODWORD(v79), 1056769, 2, 5, 1, -1);
    v20->field_C = sub_10047360;
    v20->field_8 = sub_10042E20;
    v20->field_3838.field_1A99C[28] = 3;
    v22 = text_GetStringWithIndex(0x16u);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v24->lpVtbl->meth14)(v24, a1, v4->flags_338, LODWORD(v80), 1056769, 2, 5, 1, -1);
    v24->field_C = sub_10047360;
    v24->field_8 = sub_10042C80;
    v24->field_3838.field_1A99C[28] = 3;
    v26 = text_GetStringWithIndex(0x17u);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v28->lpVtbl->meth14)(v28, a1, v4->flags_338, LODWORD(v81), 1056769, 2, 5, 1, -1);
    v28->field_C = sub_10047360;
    v28->field_8 = sub_10042E80;
    v28->field_3838.field_1A99C[28] = 3;
    v30 = text_GetStringWithIndex(0x18u);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v32->lpVtbl->meth14)(v32, a1, v4->flags_338, LODWORD(v82), 1056769, 2, 5, 1, -1);
    v32->field_C = sub_10047360;
    v32->field_8 = (int(__cdecl *)())sub_10043760;
    v32->field_3838.field_1A99C[28] = 3;
    v34 = text_GetStringWithIndex(0x19u);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v36->lpVtbl->meth14)(v36, a1, v4->flags_338, LODWORD(v83), 1056769, 2, 5, 1, -1);
    v36->field_C = sub_10047360;
    v36->field_8 = (int(__cdecl *)())sub_100464E0;
    v36->field_3838.field_1A99C[28] = 3;
    v38 = text_GetStringWithIndex(0xCu);
    ...
    if (!v44)
        sub_1003E260(4);
    ((void(__thiscall *)(
        unk1E214 *, int, float, float, int, int, int, int, int))v44->lpVtbl->meth14)(
    ...
    *(_DWORD *)v44->gap5C = v85 + 33;
    ...
    if (!v47)
        sub_1003E260(4);
    ((void(__thiscall *)(
        unk1E214 *, int, float, float, int, int, int, int, int))v47->lpVtbl->meth14)(
