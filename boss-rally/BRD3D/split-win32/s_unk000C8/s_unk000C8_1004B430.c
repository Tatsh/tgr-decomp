...
int __cdecl s_unk000C8_1004B430(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
    ...
    v9 = text_GetStringWithIndex(0x1Au);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v15->lpVtbl->meth14)(v15, a1, v3->flags_338, LODWORD(v52), 1056769, 2, 5, 1, -1);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v19->lpVtbl->meth14)(v19, a1, v3->flags_338, LODWORD(v53), 1056769, 2, 5, 1, -1);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v23->lpVtbl->meth14)(v23, a1, v3->flags_338, LODWORD(v54), 1056769, 2, 5, 1, -1);
    v23->field_C = sub_100474B0;
    v23->field_8 = sub_10045110;
    v23->field_3838.field_1A99C[28] = 3;
    v25 = text_GetStringWithIndex(0x1Eu);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v27->lpVtbl->meth14)(v27, a1, v3->flags_338, LODWORD(v55), 1056769, 2, 5, 1, -1);
    ...
    ((void(__thiscall *)(unk1E214 *, int, int, _DWORD, int, int, int, int, int))
         v29->lpVtbl->meth14)(v29, a1, v3->flags_338, LODWORD(v56), 1056769, 2, 5, 1, -1);
    v29->field_C = sub_10047360;
    v29->field_8 = (int(__cdecl *)())sub_10046450;
    v29->field_3838.field_1A99C[28] = 3;
    v31 = text_GetStringWithIndex(0xCu);
    ...
    if (dword_100AC304) {
        ...
        if (!v39)
            sub_1003E260(4);
        ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))
             v39->lpVtbl->meth14)(v39, a1, 1134723072, 1116733440, 1, 2, 5, 1, 17);
        ...
        v43 = v42->lpVtbl;
        ((void(__thiscall *)(unk1E214 *, int, int, int, int, int, int, int, int))
             v42->lpVtbl->meth14)(v42, a1, v3->flags_338, 1125646336, 1052673, 2, 5, 1, -1);
    ...
    v50 = text_GetStringWithIndex(0x1Du);
