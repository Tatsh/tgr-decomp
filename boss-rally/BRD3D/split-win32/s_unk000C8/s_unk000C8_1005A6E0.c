...
int __cdecl s_unk000C8_1005A6E0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + a1->field_10) = 1;
    ...
    v8 = text_GetStringWithIndex(0xC2u);
    ...
    *(_DWORD *)&v10->field_3838.field_1A99C[16] = 1;
    ...
    v17 = text_GetStringWithIndex(0x1Eu);
    ...
    v24 = text_GetStringWithIndex(0x6Fu);
    ...
    v31 = text_GetStringWithIndex(0x3Fu);
    ...
    *(&a1->field_6C + a1->field_10) = 0;
    ...
    v39 = text_GetStringWithIndex(0x70u);
