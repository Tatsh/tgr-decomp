...
int __cdecl s_unk000C8_1004E830(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    v9 = text_GetStringWithIndex(0x22u);
    ...
    if (gDIEffectSquare.dwStartDelay) {
        ...
        v11->field_3838.field_1A99C[28] = 2;
        v61 = 0;
    }
    v13 = text_GetStringWithIndex(0x30u);
    ...
    v17 = text_GetStringWithIndex(0x31u);
    ...
    v21 = text_GetStringWithIndex(0x32u);
    ...
    v25 = text_GetStringWithIndex(0x33u);
    ...
    v29 = text_GetStringWithIndex(0xCu);
