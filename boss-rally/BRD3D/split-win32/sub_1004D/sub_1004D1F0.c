...
//----- (1004D1F0) --------------------------------------------------------
int __cdecl sub_1004D1F0(unk000C8 *a1) {
    ...
    *(&a1->field_6C + v1) = 1;
    ...
    if (v2)
        u348 = meth_10048470(v2);
    else
        u348 = 0;
    a1->field_14[LOWORD(a1->field_10)] = u348;
    if (!u348)
        sub_1003E260(4);
    ++LOWORD(a1->field_10);
    u348->field_340 = a1;
    u348->field_10 = 0;
    u348->mask_338 = 1128464384;
    ...
    if (!v7)
        sub_1003E260(4);
    v8 = v7->lpVtbl;
    v7->lpVtbl->field_38(v7, a1, u348->mask_338, 10.0, 1048585, 2, 5, 1, -1);
    ...
    if (!v11)
        sub_1003E260(4);
    v11->lpVtbl->field_38(v11, a1, 0x42A00000, 46.0, 9, 2, 5, 0, 9);
    ++u348->field_14;
    ...
    if (!v13)
        sub_1003E260(4);
    v14 = v13->lpVtbl;
    v13->lpVtbl->field_38(v13, a1, u348->mask_338, u348->field_33C, 1056769, 2, 5, 1, -1);
    ...
    v17->lpVtbl->field_38(v17, a1, u348->mask_338, v25, 1056769, 2, 5, 1, -1);
    ...
    v21->lpVtbl->field_38(v21, a1, u348->mask_338, v26, 1056769, 2, 5, 1, -1);
