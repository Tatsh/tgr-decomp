...
//----- (1004D640) --------------------------------------------------------
int __cdecl sub_1004D640(int a1) {
    ...
    *(_DWORD *)(a1 + 4 * *(unsigned __int16 *)(a1 + 16) + 20) = v3;
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v11 + 56))(
        v11, a1, 1117782016, 1110966272, 9, 2, 5, 0, 9);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, int, int, int, int, int, _DWORD, int))(*v13 + 56))(
        v13, a1, 1119879168, 1114898432, 9, 2, 5, 0, 142);
    ++*((_WORD *)v3 + 10);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v15 + 56))(
        v15, a1, v3[206], v3[207], 12289, 2, 5, 1, -1);
    v16 = v15[3598];
    v15[1] = sub_1003ED10;
    v15[30845] = 1;
    (*(void(__thiscall **)(_DWORD *, int, void *, int, _DWORD, int))(v16 + 20))(
        v15 + 3598, 262145, &unk_100AB528, 7, 0, -1);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v18 + 56))(
        v18, a1, v3[206], LODWORD(v26), 1056769, 2, 5, 1, -1);
    v18[3] = sub_10047360;
    v18[2] = sub_1003ECB0;
    *((_WORD *)v18 + 61702) = 3;
    v20 = getCaptionString(0x2Cu);
    ...
    (*(void(__thiscall **)(_DWORD *, int, _DWORD, _DWORD, int, int, int, int, int))(*v22 + 56))(
        v22, a1, v3[206], LODWORD(v27), 1056769, 2, 5, 1, -1);
    v22[3] = sub_10047360;
    v22[2] = sub_10046620;
    *((_WORD *)v22 + 61702) = 3;
