...
int __fastcall sub_80250FCC(int a1, int a2, int a3, int a4)
{
  ...
  if ( 2 * result * v45 >= 0 )
  {
    ...
    for ( n = 0; ; n = v24 & 1 )
    {
      ...
      {
        v30 = 0;
        for ( ii = (v25 >> 1) + ((v50 + v52) >> 1); ; ii = (v25 >> 1) + ((v50 + v52) >> 1) - v30 )
        {
          sub_8024F25C(ii);
          if ( ++v30 == 4 )
            break;
        ...
        v32 = 0;
        for ( jj = (v25 >> 1) + ((v50 + v52) >> 1); ; jj = (v25 >> 1) + ((v50 + v52) >> 1) - v32 )
        {
          sub_8024F25C(jj);
          if ( ++v32 == 4 )
            break;
        ...
        v34 = 0;
        for ( kk = ((v50 + v52) >> 1) - (v25 >> 1); ; kk = ((v50 + v52) >> 1) - (v25 >> 1) + v34 )
        {
          sub_8024F25C(kk);
          if ( ++v34 == 4 )
            break;
        ...
        v36 = 0;
        for ( ll = ((v50 + v52) >> 1) - (v25 >> 1); ; ll = ((v50 + v52) >> 1) - (v25 >> 1) + v36 )
        {
