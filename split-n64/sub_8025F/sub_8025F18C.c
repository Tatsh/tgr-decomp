  ...
  if ( v15 )
  {
    ...
    if ( v16 )
    {
      for ( i = MEMORY[0x80025C0C]; ; i = MEMORY[0x80025C0C] )
      {
        ...
        v14[5] = MEMORY[0x80025C14] + 12 * *(unsigned __int16 *)(v18 + MEMORY[0x80025C0C] + 2);
        v14[6] = MEMORY[0x80025C14] + 12 * *(unsigned __int16 *)(v18 + MEMORY[0x80025C0C] + 4);
        v19 = (float *)v14[4];
        v20 = (float *)v14[5];
        ...
        *((float *)v14 + 2) = (float)(v29 * v27) - (float)(v26 * v30);
        ...
        v24 = *(float *)v14 * *v22;
        v14 += 8;
        *((float *)v14 - 5) = -(float)((float)(v22[2] * *((float *)v14 - 6)) + (float)(v24 + (float)(v23 * v22[1])));
        v16 = sub_8021EA90(v32);
        if ( !v16 )
          break;
      }
