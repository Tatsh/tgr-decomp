...
unsigned int __fastcall sub_8021D32C(unsigned int *a1)
{
  ...
  do
  {
    ...
    do
    {
      ...
      sub_8021D098((_DWORD *)v5[6], (unsigned int)dword_803C8000, (unsigned int)dword_803D5F88, (int)v1);
      v4 += 4;
      ++v5;
      ++v6;
    }
    ...
    do
    {
      if ( v8[47] )
      {
        sub_8021D070(v8 + 47, (unsigned int)dword_803C8000, (unsigned int)dword_803D5F88, (int)v1);
        sub_8021D098((_DWORD *)v8[47], (unsigned int)dword_803C8000, (unsigned int)dword_803D5F88, (int)v1);
      }
      v7 += 4;
      ++v8;
    }
  ...
  if ( (int)v1[4] > 0 )
  {
    for ( i = v1[5]; ; i = v1[5] )
    {
      sub_8021D070((unsigned int *)(i + v10), (unsigned int)dword_803C8000, (unsigned int)dword_803D5F88, (int)v1);
      sub_8021D070(
        (unsigned int *)(v1[5] + v10 + 4),
