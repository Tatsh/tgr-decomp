                    ...
                    if ( v10 < v36 && v36 < v9 )
                    {
                      ...
                      if ( v38 >= -47 && v38 < 224 )
                      {
                        if ( (((_BYTE)v35 + (_BYTE)v21) & 0x80) != 0 )
                          *(_WORD *)result = v32 + ((v27 * (4 - (v37 & 0xF))) >> 5);
                        else
                          *(_WORD *)result = v32 + ((v27 * ((v37 & 0xF) - 12)) >> 5);
                        if ( (v34 & 0x80) != 0 )
                          *(_WORD *)(result + 2) += (v24 * (4 - (v34 & 0xF))) >> 5;
                        else
                          *(_WORD *)(result + 2) += (v24 * ((v34 & 0xF) - 12)) >> 5;
                        v39 = v34 + v37;
                        if ( (v39 & 0x80) != 0 )
                          *(_WORD *)(result + 4) += (v20 * (8 - (v39 & 0xF))) >> 6;
                        else
                          *(_WORD *)(result + 4) += (v20 * ((v39 & 0xF) - 8)) >> 6;
                      }
                    }
                  }
                  result += 16;
