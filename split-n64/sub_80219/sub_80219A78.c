...
int __fastcall sub_80219A78(int a1, int a2, int a3, int a4)
{
  ...
  if ( a4 < 0 )
    a4 = 0;
  dword_8028A858 = 8;
  MEMORY[0] = (((int)(float)((float)a1 * 4.0) & 0xFFF) << 12) | 0xED000000 | (int)(float)((float)a2 * 4.0) & 0xFFF;
  MEMORY[4] = (((int)(float)((float)(a1 + a3) * 4.0) & 0xFFF) << 12) | (int)(float)((float)(a2 + a4) * 4.0) & 0xFFF;
  return result;
}
