...
LABEL_139:
  ...
  *a5 = 0;
  ...
  if ( v56 < v54 )
    ...
    v58 = v54 / v56;
  v57 = *(float *)(v45 - 2144731136 + 19000) - 0.002 * (double)(*(unsigned __int8 *)(a1 + 509) - 1);
...
LABEL_141:
  ...
  if ( *(_DWORD *)(v81 + 436) || *(_DWORD *)(*(_DWORD *)(a1 + 8) + 436) )
  {
    ...
    v115 = v118 - v136;
    v116 = v86 - v137;
    v87 = sub_80261140((float)(v116 * v116) + (float)((float)(v114 * v114) + (float)(v115 * v115)));
    v79 = a1;
    v88 = *a4;
    if ( *a4 < 0.0 )
      v89 = -v88;
...
LABEL_178:
  if ( v82 )
  {
    ...
    v131 = (float)(v134 - v136)
         / (float)(*(float *)(*(_DWORD *)(v79 + 4) + 120) - *(float *)(*(_DWORD *)(v79 + 12) + 120));
    v113 = (float *)(v79 + 160);
