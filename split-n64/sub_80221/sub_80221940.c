...
int __fastcall sub_80221940(int a1)
{
  ...
  *(float *)(*(_DWORD *)(*(_DWORD *)(a1 + 344) + 24) + 16) = 0.0;
  ...
  if ( !*(_DWORD *)(a1 + 3668) )
  {
    ...
    *(float *)(a1 + 3660) = 0.0;
    *(_BYTE *)(a1 + 3664) = 0;
    sub_8025AC9C((int)v21, *(_DWORD *)(a1 + 332), (float *)(a1 + 3660), (_BYTE *)(a1 + 3664), 0.033333335);
    sub_8025AC9C((int)v21, *(_DWORD *)(a1 + 336), (float *)(a1 + 3660), (_BYTE *)(a1 + 3664), 0.033333335);
    sub_8025AC9C((int)v21, *(_DWORD *)(a1 + 340), (float *)(a1 + 3652), (_BYTE *)(a1 + 3656), 0.033333335);
    sub_8025AC9C((int)v21, *(_DWORD *)(a1 + 344), (float *)(a1 + 3652), (_BYTE *)(a1 + 3656), 0.033333335);
  }
  *(_DWORD *)(a1 + 3668) = 0;
  *(float *)(a1 + 580) = 0.0;
  *(float *)(a1 + 584) = 0.0;
