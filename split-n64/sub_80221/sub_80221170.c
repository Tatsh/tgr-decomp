...
LABEL_19:
  ...
  else
  {
    v18 = *(_DWORD *)(a1 + 8312);
    v19 = *(float *)(a1 + 36);
    *(float *)(a1 + 7712) = (float)(*(float *)(v18 + 184) * *(float *)(a1 + 32))
                          + (float)(*(float *)(a1 + 48) + (float)(*(float *)a1 * *(float *)(v18 + 176)));
    v20 = *(float *)(a1 + 40);
    *(float *)(a1 + 7716) = (float)(*(float *)(v18 + 184) * v19)
                          + (float)(*(float *)(a1 + 52) + (float)(*(float *)(a1 + 4) * *(float *)(v18 + 176)));
    *(float *)(a1 + 7720) = (float)(*(float *)(v18 + 184) * v20)
  ...
  *(float *)(a1 + 7908) = 1.0;
  ...
  v26 = *(float *)(a1 + 32);
  *(float *)(a1 + 7932) = (float)((float)((float)(v24 * 0.1) + 0.69999999) + (float)((float)(51.0 - v43) * 0.0040000002))
                        * 0.52359879;
  ...
  *(float *)(a1 + 8068) = 0.52359879;
  v28 = *(float *)(a1 + 36);
  *(float *)(a1 + 8052) = (float)(*(float *)(result + 184) * v26)
                        + (float)(*(float *)(a1 + 48)
                                + (float)((float)(v27 * *(float *)(result + 180))
  ...
  *(float *)(a1 + 8056) = v29
                        + (float)(*(float *)(a1 + 52)
                                + (float)((float)(v39 * *(float *)(result + 180))
                                        + (float)(v39 * *(float *)(result + 180))));
  v37 = v30;
  v36 = *(float *)(a1 + 8);
  v31 = *(_DWORD *)(a1 + 7656);
  *(float *)(a1 + 8060) = (float)(*(float *)(result + 184) * v30)
                        + (float)(*(float *)(a1 + 56)
                                + (float)((float)(v36 * *(float *)(result + 180))
