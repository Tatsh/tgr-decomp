...
LABEL_43:
        ...
        if ( *(_BYTE *)(a1 + 100) )
        {
          while ( 1 )
          {
            ...
            {
              v4 = &v16[2 * i + 516];
              if ( (unsigned __int8)*v4 == v14 && *(unsigned __int16 *)v4 >= (int)*(unsigned __int16 *)(a1 + 98) )
              {
                do
                {
                  v10 = v6[i + 286];
                ...
                while ( (unsigned __int8)*v5 == v14 && *(unsigned __int16 *)v5 >= (int)*(unsigned __int16 *)(a1 + 98) );
              }
            }
...
LABEL_61:
      ...
      else
      {
        while ( 1 )
        {
          result = sub_8026A3F0(*(_DWORD *)(a1 + 4), *(_DWORD *)(a1 + 8), *(_DWORD *)(a1 + 92) + i, &v17);
          v25 = result;
          if ( result )
            break;
