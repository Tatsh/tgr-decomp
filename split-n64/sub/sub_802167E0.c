...
void __fastcall sub_802167E0(int a1)
{
  ...
  switch ( a1 )
  {
    case 0:
      ...
      sub_8023DF9C((int)dword_80272590, 111, 85, 104, 48, 0, 0, 0, 255, 0, 0, 0, 255, 1);
      sub_8023DF9C((int)dword_80272590, 111, 85, 104, 48, 255, 255, 255, 255, 255, 255, 255, 255, 1);
      sub_8022F514();
    ...
    case 1:
      ...
      sub_8023DF9C((int)dword_802725A4, 111, 85, 104, 48, 0, 0, 0, 255, 0, 0, 0, 255, 1);
      sub_8023DF9C((int)dword_802725A4, 111, 85, 104, 48, 255, 255, 255, 255, 255, 255, 255, 255, 1);
      sub_8022F514();
    ...
    case 2:
      ...
      sub_8023DF9C((int)dword_802725B8, 111, 85, 104, 48, 0, 0, 0, 255, 0, 0, 0, 255, 1);
      sub_8023DF9C((int)dword_802725B8, 111, 85, 104, 48, 255, 255, 255, 255, 255, 255, 255, 255, 1);
      sub_8022F514();
      formatter("%wwACCELERATE", 201, 127);
      formatter("%wwPLUS BRAKE = E-BRAKE", 193, 135);
      formatter("%wwCHANGE VIEW", 215, 104);
    ...
    case 3:
      ...
      sub_8023DF9C((int)dword_802725CC, 111, 85, 104, 48, 0, 0, 0, 255, 0, 0, 0, 255, 1);
      sub_8023DF9C((int)dword_802725CC, 111, 85, 104, 48, 255, 255, 255, 255, 255, 255, 255, 255, 1);
      sub_8022F514();
    ...
    case 4:
      ...
      sub_8023DF9C((int)dword_802725E0, 110, 81, 104, 48, 0, 0, 0, 255, 0, 0, 0, 255, 1);
      sub_8023DF9C((int)dword_802725E0, 110, 81, 104, 48, 255, 255, 255, 255, 255, 255, 255, 255, 1);
      sub_8022F514();
