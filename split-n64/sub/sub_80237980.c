...
char **sub_80237980()
{
  ...
  else
  {
    ...
    v34 = v0;
    v37 = MEMORY[0x205C];
    sub_8021C748((unsigned int)dword_8035D530, (int)((&gCarData)[24 * MEMORY[0x205C] + 8] + 1024), v2 << 6);
    sub_8021C748((unsigned int)dword_80361530, *(_DWORD *)(96 * MEMORY[0x205C] - 2144817620), 512);
    v0 = v34;
  ...
  v35 = v0;
  sub_8021C748((unsigned int)dword_8035F530, (int)&(&gCarData)[24 * v1 + 8][4096 * v0 + 5120], 4096);
  dword_8028C798 = v35;
LABEL_7:
  dword_8028A858 = 8;
  MEMORY[4] = 0;
  ...
  if ( *((_BYTE *)result + 46) )
  {
    if ( v5 == 1 || v5 == 2 )
    {
      ...
      v33 = v6;
      sub_8021C748((unsigned int)dword_80361930 + 2 * v13, (int)&result[8][2 * v13], 2 * (256 - v13));
      result = &(&gCarData)[24 * MEMORY[0x205C]];
  ...
  else
  {
    ...
    v32 = (float)v38;
    HIWORD(dword_80361B30[4]) = (int)(float)((float)(sub_802617D0(v36 + 0.050000001) * 20.0) + v30);
    v10 = sub_80261610(v36 + 0.050000001);
    HIWORD(dword_80361B30[5]) = 0;
    LOWORD(dword_80361B30[4]) = (int)(float)((float)(v10 * 20.0) + v32);
    HIWORD(dword_80361B30[8]) = (int)(float)((float)(sub_802617D0(v36 + 0.30000001) * 7.0) + v30);
    v11 = sub_80261610(v36 + 0.30000001);
    HIWORD(dword_80361B30[9]) = 0;
    LOWORD(dword_80361B30[8]) = (int)(float)((float)(v11 * 7.0) + v32);
    HIWORD(dword_80361B30[12]) = (int)(float)((float)(sub_802617D0(v36 - 0.30000001) * 7.0) + v30);
